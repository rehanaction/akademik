	...
	class mPendaftar extends mModel{
		...
		function dataQuery($key) {
			$sql = "select m.*, up.namaunit, upf.namaunit as fakultas, s.namasistem||' '||s.tipeprogram as namasistem,
					...
					pr5.namapropinsi as kodepropinsi_text,
					pr6.namapropinsi as kodepropinsiayah_text,
					pr7.namapropinsi as kodepropinsiibu_text
					...
					left join akademik.ms_propinsi pr5 on pr5.kodepropinsi=m.kodepropinsi
					left join akademik.ms_propinsi pr6 on pr6.kodepropinsi=k5.kodepropinsi
					left join akademik.ms_propinsi pr7 on pr7.kodepropinsi=k6.kodepropinsi
