<?php
	...
	// struktur view
	$a_kolom = array();
	$a_kolom[] = array('kolom' => 'kodejenisprestasi', 'label' => 'ID', 'size' => 2, 'maxlength' => 4, 'notnull' => true);
	$a_kolom[] = array('kolom' => 'namajenisprestasi', 'label' => 'Nama Jenis Prestasi', 'size' => 50, 'maxlength' => 50, 'notnull' => true);
	
	// properti halaman
	$p_title = 'Daftar Jenis Prestasi';
	$p_tbwidth = 500;
	$p_aktivitas = 'BIODATA';
	
	$p_model = mJenisprestasi;
	$p_key = $p_model::key;
