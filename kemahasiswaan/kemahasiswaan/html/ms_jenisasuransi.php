<?php
	...
	// struktur view
	$a_kolom = array();
	$a_kolom[] = array('kolom' => 'idjenisasuransi', 'label' => 'ID', 'size' => 2, 'maxlength' => 4, 'notnull' => true);
	$a_kolom[] = array('kolom' => 'namajenisasuransi', 'label' => 'Nama Jenis Asuransi', 'size' => 50, 'maxlength' => 50, 'notnull' => true);
	
	// properti halaman
	$p_title = 'Daftar Jenis Asuransi';
	$p_tbwidth = 500;
	$p_aktivitas = 'BIODATA';
	
	$p_model = mJenisasuransi;
	$p_key = $p_model::key;
