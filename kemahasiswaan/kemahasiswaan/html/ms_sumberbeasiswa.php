...
//	$conn -> debug = true ;
	...
	// jneis beasiswa
	$a_jenisbeasiswa = array('1' => 'Internal' , '2' => 'External' );

	// struktur view
	$a_kolom = array();
	$a_kolom[] = array('kolom' => 'kodesumberbeasiswa', 'label' => 'ID', 'size' => 0, 'maxlength' => 4, 'notnull' => true);
	$a_kolom[] = array('kolom' => 'namasumberbeasiswa', 'label' => 'Nama Sumber Beasiswa', 'size' => 20, 'maxlength' => 20, 'notnull' => true);
	$a_kolom[] = array('kolom' => 'jenisbeasiswa', 'label' => 'Jenis', 'type' => 'S', 'option' => $a_jenisbeasiswa);
	
	// properti halaman
	$p_title = 'Daftar Sumber Beasiswa';
	$p_tbwidth = 500;
	$p_aktivitas = 'BIODATA';
