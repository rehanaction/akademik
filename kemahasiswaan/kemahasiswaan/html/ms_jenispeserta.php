<?php
	...
	// struktur view
	$a_kolom = array();
	$a_kolom[] = array('kolom' => 'kodejenispeserta', 'label' => 'ID', 'size' => 2, 'maxlength' => 4, 'notnull' => true);
	$a_kolom[] = array('kolom' => 'namajenispeserta', 'label' => 'Nama Jenis Peserta', 'size' => 50, 'maxlength' => 50, 'notnull' => true);
	
	// properti halaman
	$p_title = 'Daftar Jenis Peserta';
	$p_tbwidth = 500;
	$p_aktivitas = 'BIODATA';
	
	$p_model = mJenispeserta;
	$p_key = $p_model::key;
