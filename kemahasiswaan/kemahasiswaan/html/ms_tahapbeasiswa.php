<?php
	...
	// struktur view
	$a_kolom = array();
	$a_kolom[] = array('kolom' => 'idtahapbeasiswa', 'label' => 'ID Tahap Beasiswa', 'size' => 2, 'maxlength' => 4,'readonly'=>true);
	$a_kolom[] = array('kolom' => 'namatahap', 'label' => 'Nama Tahap', 'size' => 50, 'maxlength' => 255, 'notnull' => true);
	
	// properti halaman
	$p_title = 'Daftar Tahap Beasiswa';
	$p_tbwidth = 500;
	$p_aktivitas = 'BIODATA';
	
	$p_model = mTahapbeasiswa;
	$p_key = $p_model::key;
