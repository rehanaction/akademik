<?php
	...
	// properti halaman
	$p_title = 'Data Polis Asuransi Mahasiswa';
	$p_tbwidth = 800;
	$p_aktivitas = 'SPP';
	...
	$a_kolom[] = array('kolom' => 'namajenisasuransi', 'label' => 'Jenis Asuransi');
	$a_kolom[] = array('kolom' => 'namaprsasuransi', 'label' => 'Perusahaan Asuransi');
	$a_kolom[] = array('kolom' => 'waktudaftar', 'label' => 'Tgl Daftar', 'type' => 'D');
	$a_kolom[] = array('kolom' => 'nopolis', 'label' => 'Nomor Polis');
	$a_kolom[] = array('kolom' => 'isaktif', 'label' => 'Aktif', 'type' => 'C');
