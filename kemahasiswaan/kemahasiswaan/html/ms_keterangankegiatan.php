<?php
	...
	// struktur view
	$a_kolom = array();
	$a_kolom[] = array('kolom' => 'idketerangan', 'label' => 'ID', 'size' => 2, 'maxlength' => 4, 'readonly' => true);
	$a_kolom[] = array('kolom' => 'namaketerangan', 'label' => 'Nama Keterangan', 'size' => 50, 'maxlength' => 50, 'notnull' => true);
	
	// properti halaman
	$p_title = 'Daftar Keterangan Kegiatan';
	$p_tbwidth = 600;
	$p_aktivitas = 'BIODATA';
	
	$p_model = mKetkegiatan;
	$p_key = $p_model::key;
