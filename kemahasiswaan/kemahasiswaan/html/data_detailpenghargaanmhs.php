...
<table width="100%" cellspacing="2" cellpadding="4" align="center" class="GridStyle">
	...
	<tr>
		...
		<th width="115" align="center" class="HeaderBG">Tanggal</th>
		<th align="center" class="HeaderBG">Nama</th>
		<th align="center" class="HeaderBG">Nama (eng)</th>
		<th align="center" class="HeaderBG">Kategori</th>
		<th align="center" class="HeaderBG">Valid?</th>
		<th align="center" class="HeaderBG">Sertifikat</th>
		<? // if($c_update) { ?>
		<th align="center" class="HeaderBG" colspan="2" width="30" id="edit">Aksi</th>
		<? // } ?>
	</tr>
	<?php
	$i = 1;
