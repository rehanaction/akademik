<?php
	...
	// struktur view
	$a_kolom = array();
	$a_kolom[] = array('kolom' => 'idtahap', 'label' => 'ID', 'size' => 2, 'maxlength' => 4, 'notnull' => true);
	$a_kolom[] = array('kolom' => 'namatahap', 'label' => 'Nama Jenis Asuransi', 'size' => 50, 'maxlength' => 50, 'notnull' => true);
	
	// properti halaman
	$p_title = 'Daftar Tahap Kegiatan';
	$p_tbwidth = 500;
	$p_aktivitas = 'BIODATA';
