<?php
	...
	// struktur view
	$a_input = array();
	$a_input[] = array('kolom' => 'kodejenjang', 'label' => 'Program Pendidikan','type'=>'S', 'option' => $a_program);
	$a_input[] = array('kolom' => 'idtahap', 'label' => 'Tahap Kegiatan','type'=>'S', 'option' => $a_tahap);
	$a_input[] = array('kolom' => 'semsbawah', 'label' => 'Semester Bawah');
	$a_input[] = array('kolom' => 'semsatas', 'label' => 'Semester Atas');
				...
				<center>
					...
					<div class="box-content" style="width:<?= $p_tbwidth-22 ?>px">
						<table width="<?= $p_tbwidth-22 ?>" cellpadding="4" cellspacing="2" align="center">
							<?= Page::getDataTR($row,'kodejenjang') ?>
							<?= Page::getDataTR($row,'idtahap') ?>
							<?= Page::getDataTR($row,'semsbawah') ?>
							<?= Page::getDataTR($row,'semsatas') ?>
