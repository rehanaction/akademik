<?php
	...
	// struktur view
	$a_kolom = array();
	$a_kolom[] = array('kolom' => 'nokegiatan', 'label' => 'Kode');
	$a_kolom[] = array('kolom' => 'namakegiatan', 'label' => 'Nama Kegiatan');

	// properti halaman
	$p_title = 'Daftar Struktur Kegiatan';
	$p_tbwidth = 640;
			...
			<form name="pageform" id="pageform" method="post">
				...
				<table width="<?= $p_tbwidth ?>" cellpadding="4" cellspacing="0" class="GridStyle" align="center">
					...
					<tr valign="top" class="<?= $rowstyle ?>">
						...
						<td align="center">
						<?		if($c_edit) { ?>
							<img class="ImgAct" src="images/child.png" id="<?= $t_key ?>" onclick="goAddChild(this)" style="cursor:pointer">
...
function goAddChild(elem){
		location.href = detailpage + "&parent=" + elem.id;
}
</script>
</body>
</html>
