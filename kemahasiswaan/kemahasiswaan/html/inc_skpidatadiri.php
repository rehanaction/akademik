	...
	<table width="100%">
		...
		<tr>
		  ...
		  <td>&nbsp;</td>
		  <td><div class="border"><?= CStr::FormatDateInd($a_data['tgllulus'])?></div></td>
		</tr>
		<tr>
		  <td><b>&nbsp;</b></td>
		...
		<tr>
		  <td>&nbsp;</td>
		  <td>
			  <div class="border"><?= CStr::formatDateInd($a_data['tglmasuk'])?></div>
		  </td>
		  <td>&nbsp;</td>
		  <td>&nbsp;
	...
	<table width="100%">
		...
		<tr>
          ...
          MINISTRY DECREE/SK MENDIKBUD 107/D/O/1993
