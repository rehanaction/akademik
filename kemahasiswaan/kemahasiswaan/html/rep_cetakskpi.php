<?php
	...
	$a_pengalaman = mLaporan::getPengalaman($conn,$r_nim);
	$a_kkn = mLaporan::getKKN($conn,$r_nim);
	$a_skripsi = mLaporan::getSKRIPSI($conn,$r_nim);
	$a_prestasi = mLaporan::getPrestasi($conn,$r_nim);
...
<div id="main_wrap">
	...
	<?php require_once('inc_skpicapaian.php'); ?>
	<?php require_once('inc_skpiaktivitas.php'); ?>
