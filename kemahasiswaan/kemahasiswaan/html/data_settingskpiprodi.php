		...
		<div class="SideItem" id="SideItem">
			<form name="pageform" id="pageform" method="post" enctype="multipart/form-data">
				...
				<div class="tabs" style="width:<?= $p_tbwidth ?>px">
					...
					<div id="items">
					<table cellpadding="4" cellspacing="2" align="center">
						<?= htmlspecialchars_decode(stripslashes(Page::getDataTR($row,'kemampuankerja'))) ?>
						<?= htmlspecialchars_decode(stripslashes(Page::getDataTR($row,'kemampuankerjaen'))) ?> 
						
					</table>
					</div>
					<div id="items">
					<table cellpadding="4" cellspacing="2" align="center">
						<?= htmlspecialchars_decode(stripslashes(Page::getDataTR($row,'penguasaanpengetahuan'))) ?>
						<?= htmlspecialchars_decode(stripslashes(Page::getDataTR($row,'penguasaanpengetahuanen'))) ?> 
						
					</table>
					</div>
					<div id="items">
					<table cellpadding="4" cellspacing="2" align="center">
						<?= htmlspecialchars_decode(stripslashes(Page::getDataTR($row,'sikapkhusus'))) ?>
						<?= htmlspecialchars_decode(stripslashes(Page::getDataTR($row,'sikapkhususen'))) ?> 
