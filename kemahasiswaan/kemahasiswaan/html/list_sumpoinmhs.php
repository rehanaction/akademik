<?php
	...
	$a_kolom[] = array('kolom' => 'poinprestasi', 'label' => 'Poin Prestasi');
	$a_kolom[] = array('kolom' => 'poinpengalaman', 'label' => 'Poin Aktivitas');
	$a_kolom[] = array('kolom' => 'poinpelanggaran', 'label' => 'Poin Pelanggaran');
	$a_kolom[] = array('kolom' => 'totalpoin', 'label' => 'Total Poin <br>(Prestasi + Aktivitas)');
