<?php
	...
	$sistemkuliah= array('kolom' => 'sistemkuliah', 'label' => 'Basis', 'type' => 'S', 'option'=>mCombo::sistemKuliah($conn), 'empty'=>'--Pilih sistem kuliah--');
	$unit= array('kolom' => 'kodeunit', 'label' => 'Prodi', 'type' => 'S', 'option'=>mCombo::Unit($conn), 'empty'=>false);
