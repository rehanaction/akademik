<?php
	...
	*/
	...
	// struktur view
	$a_kolom = array();
	$a_kolom[] = array('kolom' => 'idgelombang', 'label' => 'ID Gelombang', 'size' => 2, 'maxlength' => 4, 'notnull' => true);
        $a_kolom[] = array('kolom' => 'namagelombang', 'label' => 'Nama Gelombang', 'size' => 15, 'maxlength' => 20, 'notnull' => true);
        
	// properti halaman
	$p_title = 'Daftar Gelombang';
	$p_tbwidth = 350;
	$p_aktivitas = 'SPMB';
