<div class="tab-pane" id="items">
	<table class="table table-bordered table-striped" cellpadding="5">
		...
		<?php // Page::getDataTR($row,'propinsismu') ?>
		<?php // Page::getDataTR($row,'kodekotasmu') ?>
		<?php // Page::getDataTR($row,'kodesekolah') ?>
		<tr>
		...
		<?php //Page::getDataTR($row,'jenissekolah') ?>
		<?php //Page::getDataTR($row,'kodeagamasekolah') ?>
		<?= Page::getDataTR($row,'jurusansmaasal') ?>
		<?= Page::getDataTR($row,'thnlulussmaasal') ?>
		<?php //Page::getDataTR($row,'negarasekolah') ?>
		<?php // Page::getDataTR($row,'alamatsmu') ?>
		<?php //Page::getDataTR($row,'kodepossekolah') ?>
		<?php // Page::getDataTR($row,'telpsmu') ?>
		...
		<?= Page::getDataTR($row,'ketpindahan') ?>	
