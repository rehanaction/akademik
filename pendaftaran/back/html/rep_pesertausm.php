...
// cek akses halaman
   ...
   require_once(Route::getModelPath('unit'));
	...
	$p_model=mLaporan;
	$p_tbwidth = 950;
	$p_namafile = 'LAPORAN PESERTA USM';
...
<body style="font-size:12pt" onLoad="window.print()">
	...
	<table style="width:<?= $p_tbwidth?>px; border-collapse:collapse; text-align:left" border="1" cellpadding="3">
		...
		<tbody>
			...
			<tr>
				<td width="10"><?= $no?></td>
				<td width="100"><?= $val['nopendaftar']?></td>
				<td width="300"><?= $val['nama']?></td>
				<td width="10" align="center"><?= $val['idgelombang']?></td>
			</tr>
			<? }?>
		</tbody>
	</table>
