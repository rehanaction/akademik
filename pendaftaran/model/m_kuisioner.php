<?php
	...
	defined( '__VALID_ENTRANCE' ) or die( 'Akses terbatas' );
		...
		function arrPertanyaan1(){
			$data = array('1'=>'Internet',
							'2'=>'Website inaba.ac.id', 
							'3'=>'Media Sosial',
							'4'=>'Poster/Brosur di Sekolah',
							'5'=>'Tim Kunjungan Promosi/Presentasi STIE INABA',
							'6'=>'Teman/Saudara',
							'7'=>'Radio',
							'8'=>'Media Cetak',
							'9'=>'Lain-lain');
		...
		function getcolumn($conn){
			$a_input = array();
			//alasan tau ueu
			$a_input[] = array('kolom' => 'jawab_1',	'label' => 'Darimana anda mendapat info STIE INABA?','type'=>'S', 'option'=>self::arrPertanyaan1());
			...
			$a_input[] = array('kolom'=>'jawabketerangan_1','label'=>'Referensi (Nama Lengkap/NIM)','maxlength' => 100, 'size' => 30);
