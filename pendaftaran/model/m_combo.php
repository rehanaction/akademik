<?php
	...
	class mCombo {
		...
		function isdaftarulang($conn) {
			$arr = array('-1' => 'Daftar Ulang', '0' => 'Belum Daftar Ulang');
		...
		function sistemKuliah($conn) {
			...
			$sql = "select sistemkuliah,namasistem from akademik.ak_sistem order by sistemkuliah";
		...
		function getKampus($conn) {
			$sql = "select kodekampus,namakampus from akademik.lv_kampus ";
