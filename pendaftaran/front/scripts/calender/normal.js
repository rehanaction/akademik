...
// ---- Common Options ----
var gMonths=["Jan","Feb","Mar","Apr","Mei","Jun","Jul","Agu","Sep","Okt","Nov","Des"];
var gWeekDay=["Ahd","Sen","Sel","Rab","Kam","Jum","Sab"];	// weekday caption from Sunday to Saturday
...
var gcCalBG="#abd130";	// the background color of the outer calendar panel.
var guCalBG=null;	//  the background image url for the inner table.
var gcCalFrame="#000";	// the background color of the inner table, showing as a frame.
...
var gsBottom="<A href='javascript:void(0)' class='BottomAnchor' onclick='if(this.blur)this.blur();if(!fSetDate(gToday[0],gToday[1],gToday[2]))alert(\"You cannot select today!\");return false;' onmouseover='return true;' >Hari ini : "+gMonths[gToday[1]-1]+" "+gToday[2]+", "+gToday[0]+"</A>";	// the content of the bottom section.
...
var gcSun="#ca0404";	// Sunday font color
var gcSunBG="#f8b7b7";	// Sunday background color
