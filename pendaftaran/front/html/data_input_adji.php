<?php
	...
	if (empty ($r_periode) || empty($r_jalur) || empty($r_gel)){
		...
		$arrKampus = array(''=>'--- Pilih Kampus Dahulu ---')+mCombo::getKampus($conn);
	...
	if($r_act == 'save' and $c_edit) {
		...
		if (!empty ($r_key)){
			...
			$r_kodekampus = mKampus::getIdBySistemKuliah($conn,$r_sistemkuliah);
		}
                ...
                <?php
					...
					?>						  
                        ...
                        <table width="100%" cellpadding="4" cellspacing="2" class="table table-bordered table-striped">
                        	<tr>
								<td align="center" valign="top" rowspan="<?= $r_key ? '12' : '7'?>">
									<? if (!empty($r_key)) {?>
                            ...
                            <? if (empty($r_key)){ ?>
                            <tr>
                                <td><?= Page::getDataLabel($row,'kodekampus')?></td>
                                <td>:</td>
                                <td><?= Page::getDataInput($row,'kodekampus')?></td>
                            </tr>
                            <tr>
                    ...
                    <ul class="nav nav-tabs" id="myTab">
						...
						<li><a href="#informasi">Keluarga</a></li>
						<li><a href="#akademik">Pendidikan</a></li>
						<li><a href="#informasilain">Info Lain</a></li>
						<li><a href="#kuisioner">Kuesioner</a></li>
...
<?php require_once('xinc_script.php') ?>
