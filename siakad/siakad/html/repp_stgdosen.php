<?php
	...
	$a_input[] = array('label' => 'Fakultas', 'nameid' => 'unit', 'type' => 'S', 'option' => mCombo::fakultas($conn,false,false,false), 'default' => $r_unit);
	$a_input[] = array('label' => 'Nomor', 'nameid' => 'nomor', 'type' => 'A', 'rows' => 1, 'default' => '');	
	...
	$a_input[] = array('nameid' => 'nipdosen', 'label' => 'Dosen Pengajar', 'type' => 'X', 'text' => 'nip','param'=>'acdosen','notnull'=>true);
 	...
 	$a_laporan = array();
 	$a_laporan['rep_stgdosen_kesediaan'] = 'SURAT KESEDIAAN';
 	$a_laporan['rep_stgdosen_kesepakatan'] = 'SURAT KESEPAKATAN';
	$a_laporan['rep_stgdosen'] = 'SURAT TUGAS';
