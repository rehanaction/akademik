<?php
	...
	$a_input[] = array('label' => 'Mahasiswa', 'nameid' => 'mahasiswa', 'size' => 45);
	
	$a_laporan = array();
	$a_laporan['rep_ktm_pdf'] = 'KTM';
	$a_laporan['rep_khs'] = 'KHS';
	$a_laporan['rep_transkripsmt'] = 'Transkrip Sementara';
	$a_laporan['rep_transkrip'] = 'Transkrip';
	$a_laporan['rep_rekapkrs'] = 'Rekap KRS';
	$a_laporan['rep_ijazah'] = 'Cetak Ijazah';
