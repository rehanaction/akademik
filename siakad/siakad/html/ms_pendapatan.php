<?php
	...
	// struktur view
	$a_kolom = array();
	$a_kolom[] = array('kolom' => 'kodependapatan', 'label' => 'Kode Pendapatan', 'size' => 2, 'maxlength' => 4, 'notnull' => true);
	$a_kolom[] = array('kolom' => 'namapendapatan', 'label' => 'Nama Pendapatan', 'size' => 30,'maxlength' => 30, 'notnull' => true);
	
	// properti halaman
	$p_title = 'Daftar Pendapatan';
	$p_tbwidth = 400;
	$p_aktivitas = 'BIODATA';
