<?php
	...
	$p_tbwidth = 900;
	$p_namafile = 'kuliah_per_prodi'.$r_kodeunit;
		
	 $rs = mLaporan::getRekapKuliahProdi($conn,$r_jurusan,$r_semester,$r_tahun);
	// header
...
?>
<div class="div_head">LAPORAN PELAKSANAAN PERKULIAHAN PER PRODI</div>
</br>
...
<tr bgcolor= 'green'>
	<th style="color:#FFFFFF">KODE DOSEN</th>
	<th style="color:#FFFFFF">NAMA DOSEN</th>
	<th style="color:#FFFFFF">JUMLAH MENGAJAR</th>
	...
	<td><?=$row['nipdosen']?></td>
	<td><?=$row['nama']?></td>
	<td><?=$row['jmlmengajar']?></td>
	<td><?= $row['sksmengajar']?></td>
