<?php
	...
	// properti halaman
	$p_title = 'Laporan Rasio Dosen Per-Institut';
	$p_tbwidth = 800;
	$p_namafile = 'rasio_dosen_Institut';
	
	$rs = mLaporan::getRasiodosenins($conn,$r_semester,$r_tahun);
	// header
...
?>
<div class="div_head">LAPORAN RASIO DOSEN PER INSTITUT</div>
</br>
 <table  border ="0" width="<?= $p_tbwidth ?>">
  <tr valign ="top">
	 <td width ="150">Periode Semester</td>
