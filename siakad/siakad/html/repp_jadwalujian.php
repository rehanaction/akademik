<?php
	...
	$a_tglawalujian= array('kolom' => 'tglawalujian', 'type' => 'D');
	$a_tglakhirujian= array('kolom' => 'tglakhirujian', 'type' => 'D');
	$a_input[] = array('label' => 'Tgl Ujian', 'input' => uForm::getInput($a_tglawalujian,$r_tglujian).' - '.uForm::getInput($a_tglakhirujian,$r_tglujian));
