<?php
	...
	// struktur view
	$a_kolom = array();
	$a_kolom[] = array('kolom' => 'idtipepeg', 'label' => 'Kode Tipe Pegawai');
	$a_kolom[] = array('kolom' => 'tipepeg', 'label' => 'Nama Tipe','notnull' => true);
	$a_kolom[] = array('kolom' => 'umurpensiun', 'label' => 'Umur Pensiun','notnull' => true);

	// properti halaman
	$p_title = 'Daftar Tipe Pegawai';
	$p_tbwidth = "100%";
	$p_aktivitas = 'Data Pegawai';
