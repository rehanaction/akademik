<?php
	...
	// properti halaman
	$p_title = 'Laporan Detail Honor Penguji';
	$p_tbwidth = 650;
	$p_namafile = 'rekap_ajar'.$r_kodeunit;
	
	
	$a_rate=mRateHonor::getJenisRate($conn,'PPM');
	$a_jenispenguji=mHonorPenguji::getJenisSidang();
	$a_data = mLaporanHonor::getHonorPenguji($conn,$r_kodeunit,$r_periode,$r_periodegaji,$r_nopengajuan,$r_jenispenguji,$r_nip);
