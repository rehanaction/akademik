<?php
	...
	// properti halaman
	$p_title = 'Laporan Slip Honor Pengawas Ujian';
	$p_tbwidth = 450;
	$p_aktivitas = 'LAPORAN';
	...
	if(!Akademik::isDosen())
	$a_input[] = array('nameid' => 'nipdosen', 'label' => 'pengawas', 'type' => 'X', 'text' => 'nip','param'=>'acpengawas','notnull'=>true);
	
	$a_laporan = array();
	$a_laporan['rep_rekapsliphonorpengawas'] = 'Rekap';
	$a_laporan['rep_sliphonorpengawas'] = 'Detail';
