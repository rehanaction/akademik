<?php
	...
	// properti halaman
	$p_title = 'Presensi Kegiatan Tutorial ';
	$p_tbwidth = 700;
	$p_maxrow = 46;
...
<?php 
	...
	for($x=1;$x<=$a_kelompok['keltutorial'];$x++){ ?>	
	<div align="center">
		<?php
			$m = count($a_data);
			for($c=0;$c<$m;$c++) {
		...
		<thead>
			<tr>
				...
				<td valign="middle" align="center">
					<div class="div_header">DAFTAR HADIR KEGIATAN TUTORIAL <?= strtoupper($row['namaunit'])?> KELAS <?= strtoupper($row['kelasmk']) ?></div>
		...
		<table class="tb_head" width="<?= $p_tbwidth ?>" >
			...
			<tr valign="top">
				<td width="120"><strong>Kelompok Tutorial</strong></td>
				<td align="center" width="10">:</td>
