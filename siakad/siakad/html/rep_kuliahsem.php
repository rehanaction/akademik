<?php
	...
	$p_tbwidth = 1100;
	$p_namafile = 'kuliah_per_semester';
		
	 //$rs = mLaporan::getRekapKuliahSem($conn,$r_fakultas,$r_semester,$r_tahun);
		$rs = mLaporan::getRekapAjarDosen($conn,$r_tahun."".$r_semester);
	 // header
...
?>
<div class="div_head">LAPORAN PELAKSANAAN PERKULIAHAN PER SEMESTER</div>
</br>
 ...
 <tr valign ="top">
	 <td width ="50">Periode Semester</td>
     <td align="center" width="10">:</td>	
     <td width ="310">  
	 <? 
	if ($r_semester == "1")
...
<tr bgcolor= 'green'>
	...
	<th style="color:#FFFFFF">Jml Mengajar</th>
	<th style="color:#FFFFFF">SKS Mengajar</th>
</tr>
