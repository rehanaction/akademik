<?php
	...
	$a_input[] = array('kolom' => 'batasawal', 'label' => 'Mulai', 'type' => 'D');
	$a_input[] = array('kolom' => 'batasakhir', 'label' => 'Batas Akhir', 'type' => 'D');
	$a_input[] = array('kolom' => 'isi', 'label' => 'Keterangan', 'type' => 'A', 'rows' => 4, 'cols' => 40);
	$a_input[] = array('kolom' => 'filetugas', 'label' => 'File Referensi', 'type' => 'U', 'uptype' => $p_uptype, 'size' => 40);
