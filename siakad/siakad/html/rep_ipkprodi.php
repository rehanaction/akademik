<?php
	...
	// properti halaman
	$p_title = 'IPK Mahasiswa per Prodi';
	$p_tbwidth = 800;
	$p_namafile = 'ipk_prodi_'.$r_kodeunit;
	
	$rs = mLaporan::getIPKProdi($conn,$r_jurusan,$r_semester,$r_tahun);
	// header
...
?>
<div class="div_head">IPK MAHASISWA PER PRODI</div>
</br>
...
<tr bgcolor = "green">
	...
	<th rowspan="2" style = "color:#FFFFFF">Jumlah Mahasiswa</th>
