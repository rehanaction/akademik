					...
					<header style="width:<?= $p_tbwidth ?>px;display:table">
						<div class="inner">
							...
							<?	}
								if($p_printpage) { ?>
							<div class="right">
								<img title="Cetak Kehadiran" id=<?=$r_semester."|".$r_tahun?> width="24px" src="images/print.png" style="cursor:pointer" onclick="goPrint(this)">
							</div>
							<?	} ?>
...
<!--    <tr class="menu-button" onMouseMove="this.className = 'hover'" onMouseOut="this.className = ''">
    ...
    <tr class="menu-button" onMouseMove="this.className = 'hover'" onMouseOut="this.className = ''">
        <td onClick="showPage('key','<?= Route::navAddress('list_jurnaldppu') // set_kuliah') ?>')">Jurnal (Riwayat)</td>
    </tr>
	<tr class="menu-button" onMouseMove="this.className = 'hover'" onMouseOut="this.className = ''">
		<td onClick="showPage('key','<?= Route::navAddress('list_jurnaldppu2') // set_kuliah') ?>')">Dev Jurnal (Riwayat)</td>
	</tr>
<!--	<tr class="menu-button" onMouseMove="this.className = 'hover'" onMouseOut="this.className = ''">
...
<table width="130" class="menu-body">
    ...
    <tr class="menu-button" onMouseMove="this.className = 'hover'" onMouseOut="this.className = ''">
        <td onClick="showPage('key','<?= Route::navAddress('list_jurnalp') // set_kuliah') ?>')">Jurnal Prakt (Riwayat)</td>
    </tr>
	<tr class="menu-button" onMouseMove="this.className = 'hover'" onMouseOut="this.className = ''">
        <td onClick="showPage('key','<?= Route::navAddress('set_absensi') ?>')">Isi Absen</td>
    </tr>
...
function goPrint(elem) {
	goOpen('<?= $p_printpage ?>&key=' + elem.id);
}
