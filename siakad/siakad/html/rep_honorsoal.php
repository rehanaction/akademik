<?php
	...
	// properti halaman
	$p_title = 'Laporan Detail Honor Soal/Naskah Ujian';
	$p_tbwidth = 800;
	...
	$a_data = mLaporanHonor::getHonorSoal($conn,$r_kodeunit,$r_periode,$r_periodegaji,$r_jenisujian,$r_nopengajuan,$r_sistemkuliah,$r_nip);
...
<table width="<?= $p_tbwidth ?>" class="tb_head" >
	<tr>
		...
		<td width="310" rowspan="2" align="right">
			Rate Honor Naskah Ujian <?=$a_ratetransport['NU|R']?>
