<?php
	...
	// properti halaman
	$p_title = 'Laporan Rekapitulasi Honor Pembimbing Akademik';
	$p_tbwidth = 700;
	$p_namafile = 'rekap_ajar'.$r_periode;
	
	$a_sistemkuliah=mSistemkuliah::getArray($conn);
	
	$a_data = mLaporanHonor::getRekapHonorAsisten($conn,$r_kodeunit,$r_periode,$r_periodegaji,$r_nopengajuan,$r_sistemkuliah);
...
<tbody>	
	...
	<td><?=$row_honor['nipasisten']?></td>
	<td><?=$row_honor['namaasisten']?></td>
