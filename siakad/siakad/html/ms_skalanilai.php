<?php
	...
	$a_kolom[] = array('kolom' => 'nangkasn', 'label' => 'Nilai Angka', 'size' => 4, 'maxlength' => 6, 'notnull' => true);
	$a_kolom[] = array('kolom' => 'batasbawah', 'label' => 'Batas Bawah', 'size' => 5, 'maxlength' => 6, 'notnull' => true);
	$a_kolom[] = array('kolom' => 'batasatas', 'label' => 'Batas Atas', 'size' => 5, 'maxlength' => 6, 'notnull' => true);
	
	// properti halaman
	$p_title = 'Skala Penilaian';
	$p_tbwidth = 420;
	$p_aktivitas = 'NILAI';
	...
	if($r_act == 'insert' and $c_insert) {
		...
		$a_kolom[] = array('kolom' => 'istoefl', 'value' => 0);
	...
	// mendapatkan data
	$a_filter[] = $p_model::getListFilter('toefl',0);
