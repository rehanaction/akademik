<?php
	...
	// struktur view
	$a_kolom = array();
	$a_kolom[] = array('kolom' => 'nhuruf', 'label' => 'Nilai Huruf', 'size' => 2, 'maxlength' => 2, 'notnull' => true);
	$a_kolom[] = array('kolom' => 'nangkasn', 'label' => 'Nilai Angka', 'size' => 4, 'maxlength' => 4, 'notnull' => true);
	$a_kolom[] = array('kolom' => 'batasbawah', 'label' => 'Batas Bawah', 'size' => 6, 'maxlength' => 6, 'notnull' => true);
	$a_kolom[] = array('kolom' => 'batasatas', 'label' => 'Batas Atas', 'size' => 6, 'maxlength' => 6, 'notnull' => true);
	
	// properti halaman
	$p_title = 'Skala Penilaian Husus Toefl 2';
	$p_tbwidth = 420;
	$p_aktivitas = 'NILAI';
	...
	if($r_act == 'insert' and $c_insert) {
		...
		$a_kolom[] = array('kolom' => 'istoefl', 'value' => 2);
	...
	// mendapatkan data
	$a_filter[] = $p_model::getListFilter('toefl',2);
