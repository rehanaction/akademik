<?php
	...
	$a_kolom[] = array('kolom' => 'kelasmk', 'label' => 'Kelas MK');
	// $a_kolom[] = array('kolom' => 'jmlkelas', 'label' => 'Jumlah Ruang');
	...
	// properti halaman
	$p_title = 'Data Jumlah Peserta Kelas Praktikum';
	$p_tbwidth = 900;
	$p_aktivitas = 'ABSENSI';
				...
				<table width="<?= $p_tbwidth ?>" cellpadding="4" cellspacing="0" class="GridStyle" align="center">
					...
					<tr valign="top" class="<?= $rowstyle ?>">
						...
						<?	}
							if($c_ratakan) { ?>
						<td align="center">
							<img id="<?= $t_key ?>" title="Ratakan Ruang" src="images/copy.png" onclick="goRatakan(this)" style="cursor:pointer">
						</td>
						<?	} ?>
					</tr>
					<?	}
