		...
		<table width="<?= $p_tbwidth-10 ?>" cellpadding="0" cellspacing="0" align="center">
			<tr>
				...
				<td valign="top" width="50%">
					<table width="100%" cellspacing="0" cellpadding="4">
						<tr>
							<td width="40" style="white-space:nowrap;padding-right:10px"><strong>Cari <?= ucwords($p_model::label) ?>:</strong></td>
							<td width="50"><?= uCombo::listColumn($a_kolom) ?></td>
							<td width="270"><input name="tfilter" id="tfilter" class="ControlStyle" size="40" onkeydown="etrFilterCombo(event)" type="text"></td>
							<td><input type="button" value="Cari" class="ControlStyle" onClick="goFilterCombo()"></td>
						</tr>
					</table>
					<?	/********************/
						/* INFORMASI FILTER */
