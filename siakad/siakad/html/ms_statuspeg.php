<?php
	...
	// struktur view
	$a_kolom = array();
	$a_kolom[] = array('kolom' => 'statuspeg', 'label' => 'Kode', 'size' => 10, 'maxlength' => 10, 'notnull' => true);
	$a_kolom[] = array('kolom' => 'namastatus', 'label' => 'Status Pegawai', 'size' => 30, 'maxlength' => 50, 'notnull' => true);
	
	// properti halaman
	$p_title = 'Daftar Status Pegawai';
	$p_tbwidth = 400;
	$p_aktivitas = 'BIODATA';
