<?php
	...
	$a_kolom[] = array('kolom' => 'm.tmplahir', 'label' => 'Tempat Lahir');
	$a_kolom[] = array('kolom' => 'm.tgllahir', 'label' => 'Tanggal Lahir', 'type'=>'S');
	...
	// properti halaman
	$p_title = 'Daftar Seluruh Mahasiswa';
	$p_tbwidth = 750;
	$p_aktivitas = 'BIODATA';
		...
		<div class="SideItem" id="SideItem">
            ...
            -->
					...
					<tr valign="top" class="<?= $rowstyle ?>">
						...
						<td><?= $row['sex'] ?></td>
						<td><?= $row['tmplahir'] ?></td>
						<td><?= cstr::formatDateInd($row['tgllahir']) ?></td>
						<td><?= $row['namaunit'] ?></td>
						<? /* <td><?= $rowc[$j++] ?></td> */ ?>
