<?php
	...
	$a_data = mLaporanHonor::getRekapHonorPengawas($conn,$r_kodeunit,$r_periode,$r_periodegaji,$r_jenisujian,$r_nopengajuan);
...
<tbody>	
	...
	if(empty($pros_pajak)) //kalo tidak ketemu, ambil dr data pegawai penunjang
		$pros_pajak=$arr_pegawaipenunjang[$nip]['pph'];
