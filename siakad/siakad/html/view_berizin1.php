...
<table width="130" class="menu-body">
    ...
    <tr class="menu-button" onMouseMove="this.className = 'hover'" onMouseOut="this.className = ''">
        <td onClick="showPage('key','<?= Route::navAddress('set_absensi1') ?>')">Presensi</td>
    </tr>

	<tr class="menu-button" onMouseMove="this.className = 'hover'" onMouseOut="this.className = ''">
        <td onClick="showPage('key','<?= Route::navAddress('set_absensibarcodedppu') ?>')">Absensi RFID (DPPU)</td>
    </tr>
...
<table width="130" class="menu-body">
    ...
    <tr class="menu-button" onMouseMove="this.className = 'hover'" onMouseOut="this.className = ''">
        <td onClick="showPage('key','<?= Route::navAddress('set_absensiprakt') ?>')">AbsensiPrakt</td>
    </tr>
	<tr class="menu-button" onMouseMove="this.className = 'hover'" onMouseOut="this.className = ''">
        <td onClick="showPage('key','<?= Route::navAddress('set_absensibarcodeprakt') ?>')">Abs. RFID(Prakt)</td>
    </tr>
</table>
</div>
