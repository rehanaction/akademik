<?php
	...
	// include
	require_once(Route::getModelPath('predikat'));
	...
	// struktur view
	$a_kolom = array();
	$a_kolom[] = array('kolom' => 'kodepredikat', 'label' => 'Kode Predikat', 'size' => 2, 'maxlength' => 4, 'notnull' => true);
	$a_kolom[] = array('kolom' => 'namapredikat', 'label' => 'Nama Predikat', 'size' => 30, 'maxlength' => 30, 'notnull' => true);
	$a_kolom[] = array('kolom' => 'namapredikaten', 'label' => 'Nama Predikat (English)', 'size' => 30, 'maxlength' => 30);
	$a_kolom[] = array('kolom' => 'ipkatas', 'label' => 'IPK Atas', 'size' => 3, 'maxlength' => 4, 'notnull' => true);
	$a_kolom[] = array('kolom' => 'ipkbawah', 'label' => 'IPK Bawah', 'size' => 3, 'maxlength' => 4, 'notnull' => true);
	$a_kolom[] = array('kolom' => 'bataswaktu', 'label' => 'Batas Waktu', 'size' => 2, 'maxlength' => 4);
	
	// properti halaman
	$p_title = 'Predikat Kelulusan';
	$p_tbwidth = 800;
	$p_aktivitas = 'WISUDA';
	
	$p_model = mPredikatkelulusan;
	$p_key = $p_model::key;
...
$(document).ready(function() {
	...
	$(function() {
		$("#i_ipkatas").mask("9.99");
		$("#i_ipkbawah").mask("9.99"); 
		$("#u_ipkatas").mask("9.99");
		$("#u_ipkbawah").mask("9.99"); 
