...
<br>
<div class="div_head">SURAT KESEDIAAN DOSEN MENGAJAR</div>
...
<table class="tb_data" width="720px">
	<tr height="14">
		<td colspan="2">Menyatakan bersedia:</td>
	</tr>
	<tr height="14">
		<td valign="top">1.</td><td align="left">Mengajar pada <?= Akademik::getNamaPeriode($periode); ?> (periode tanggal <?= CStr::formatDateInd($arr_periode['tglawal'])?> sampai dengan <?= CStr::formatDateInd($arr_periode['tglakhir'])?>) di Universitas Esa Unggul untuk mata kuliah berikut :
		<br/>
		...
		<?php
		$i=1;
		$fakultas=$nipdekan=$namadekan="";
		foreach ($mtkuliah as $mt)
		{
		$fakultas=$mt['fakultas'];
		$nipdekan=$mt['nipdekan'];
		$namadekan=$mt['namadekan'];
		?>
			<tr>
	...
	<tr height="14">
		<td valign="top">2.</td><td align="left">Menerima kompensasi sebagai imbal jasa atas pengajaran tersebut no.1 (kecuali mata kuliah kewajiban) yang telah dilakukan berupa:
		<br/>
		<table class="tb_data" width="720px">
			<tr height="14">
...
<table class="tb_foot" width="720px">
	...
	<tr>
		<td align="left"><u><?= $arr_pegawai["namalengkap"] ?></u></td>
	</tr>
	<tr>
		<td align="left" class="mark"><?= $arr_pegawai["nodosen"]." / ".$arr_pegawai["nip"] ?></td>
	</tr>
</table>
<br/>
<table class="tb_foot" width="720px">
