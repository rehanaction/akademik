<?php
	...
	// properti halaman
	$p_title = 'Generate Honor Transport Penguji Sidang';
	$p_tbwidth = 800;
	$p_aktivitas = 'ABSENSI';
	
	
	
	$p_model = mHonorTransportPenguji;
	...
	$a_kolom[] = array('kolom' => 'jenispenguji', 'label' => 'Jenis Ujian','type'=>'S','option'=>mHonorPenguji::getJenisSidang());
	...
	if($r_act == 'delete' and $c_delete) {
		...
		list($p_posterr,$p_postmsg) = $p_model::genGaji($conn,$r_periode,$r_periodegaji,$r_jenispenguji,$r_sistemkuliah);
	}
	...
	if(!empty($r_jenispenguji)) $a_filter[] = $p_model::getListFilter('jenispenguji',$r_jenispenguji);
			...
			<form name="pageform" id="pageform" method="post" enctype="multipart/form-data">
				...
				<table width="<?= $p_tbwidth-200 ?>" cellpadding="6" cellspacing="0" class="GridStyle">
					...
					<tr>		
						...
						<td>
							<?php
							$a_jenispenguji= array('kolom' => 'jenispenguji', 'type' => 'S','option'=>mHonorPenguji::getJenisSidang());
							echo uForm::getInput($a_jenispenguji,$r_jenispenguji);
