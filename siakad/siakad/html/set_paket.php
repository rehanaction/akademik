<?php
	...
	$l_sistemkuliah=uCombo::kelas($conn,$r_sistemkuliah,'sistemkuliah','',false);
	...
	if(!empty($r_act)) {
		...
		if($r_act == 'ambilpaket' and $c_edit) {
			...
			list($p_posterr,$p_postmsg) = $p_model::setPaketAturan($conn,$r_kurikulum,$r_periode,$r_unit,$r_semmk,$r_angkatan,$r_jmlkelas,$r_sistemkuliah);
		}
			...
			list($p_posterr,$p_postmsg) = $p_model::setPaket($conn,$r_kurikulum,$r_periode,$r_unit,$r_semmk,$r_angkatan,$r_nim,$r_kelas,$r_sistemkuliah);
		}
	}
	
	// mendapatkan data
	$a_data = $p_model::getListUnitPaket($conn,$r_periode,$r_kurikulum,$r_angkatan);
						...
						<div class="filterTable" style="width:638px;">
							<table width="638" cellpadding="2" cellspacing="0" align="center">
								<tr>
									...
									<td width="60"><strong>Basis</strong></td>
									<td width="20" align="center"><strong>:</strong></td>
									<td><?=$l_sistemkuliah?></td>
								</tr>
								<tr>
								...
								<tr>
									<td>
										<input type="radio" name="pilih" value="1" id="pilih_1" checked>
											Distribusikan Mata Kuliah ke setiap Mahasiswa
											<!--input type="radio" name="aturan" id="aturan_urut" value="URUT" checked> <label for="aturan_urut">Urut NIM</label-->
											<!--input type="radio" name="aturan" id="aturan_zz" value="ZIGZAG" checked-->
									</td>
								</tr>
								<tr>
									<td>
										<input type="radio" name="pilih" value="2" id="pilih_2">
											Atau Masukkan Sebuah NIM Mahasiswa
											
											<?= UI::createTextBox('nim','','ControlStyle',9,9) ?>
