<?php
	...
	// struktur view
	$a_kolom = array();
	$a_kolom[] = array('kolom' => 'kodepekerjaan', 'label' => 'Kode Pekerjaan', 'size' => 2, 'maxlength' => 2, 'notnull' => true);
	$a_kolom[] = array('kolom' => 'namapekerjaan', 'label' => 'Nama Pekerjaan', 'size' => 30, 'maxlength' => 50, 'notnull' => true);
	
	// properti halaman
	$p_title = 'Daftar Pekerjaan';
	$p_tbwidth = 400;
	$p_aktivitas = 'BIODATA';
