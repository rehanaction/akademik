<?php
	...
	// struktur view
	$a_kolom = array();
	$a_kolom[] = array('kolom' => 'statusnikah', 'label' => 'Kode', 'size' => 2, 'maxlength' => 2, 'notnull' => true);
	$a_kolom[] = array('kolom' => 'namastatus', 'label' => 'Status Nikah', 'size' => 30, 'maxlength' => 50, 'notnull' => true);
	
	// properti halaman
	$p_title = 'Daftar Status Nikah';
	$p_tbwidth = 400;
	$p_aktivitas = 'BIODATA';
	
	$p_model = mStatusNikah;
	$p_key = $p_model::key;
