<?php
	...
	$p_namafile = 'jumlah_mahasiswa_skripsi'.$r_kodeunit;
	 ...
	 $rs = mLaporan::getBlmkrs($conn,$r_jurusan,$r_semester,$r_tahun,$r_angkatan);
	// header
...
?>
<div class="div_head">LAPORAN JUMLAH MAHASISWA BELUM KRS</div>
</br>
