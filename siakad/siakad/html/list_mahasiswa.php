			...
			<form name="pageform" id="pageform" method="post">
				...
				<table width="<?= $p_tbwidth ?>" cellpadding="4" cellspacing="0" class="GridStyle" align="center">
					...
					<tr valign="top" class="<?= $rowstyle ?>">
						...
						<?	if($c_edit) { ?>
						<td align="center"><img id="<?= $t_key ?>" title="Tampilkan Detail" src="images/edit.png" onclick="goDetail(this)" target="_BLANK" style="cursor:pointer"></td>
						<?	}
							if($c_delete) { ?>
...
<table class="menu-body">
	...
	<?php 
		if (Akademik::isAdmin() || Akademik::isWk2() || Akademik::isMagister() || Akademik::isKemahasiswaan() || Akademik::isBAA()) { ?>
