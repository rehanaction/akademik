<?php
	...
	// properti halaman
	$p_title = 'Laporan Rekapitulasi Honor Pembimbing Terstruktur Magang';
	$p_tbwidth = 700;
	$p_namafile = 'rekap_ajar'.$r_periode;
	
	$a_data = mLaporanHonor::getRekapHonorBimbinganMagang($conn,$r_kodeunit,$r_periode,$r_periodegaji,$r_nopengajuan);
