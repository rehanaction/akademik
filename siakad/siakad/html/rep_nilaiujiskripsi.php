<?php
	...
	// properti halaman
	$p_title = 'Laporan Nilai Ujian Skripsi';
	$p_tbwidth = 900;
	$p_namafile = 'nilaiuji_skripsi_'.$r_kodeunit;
	
	$rs = mLaporan::getNilaiUjiSkripsi($conn,$r_jurusan,$tglawal,$tglakhir);
	// header
...
?>
<div class="div_head">LAPORAN NILAI UJIAN SKRIPSI</div>
</br>
...
<tr bgcolor = "green">
	...
	<th style="color:#FFFFFF">Nilai Ujian</th>
</tr>
