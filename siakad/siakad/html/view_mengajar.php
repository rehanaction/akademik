<?php
	...
	$a_kolom[] = array('kolom' => 'isonline', 'alias' => 'isonline', 'label' => 'status', 'width' =>'10px');
			...
			<form name="pageform" id="pageform" method="post">
				...
				<table width="<?= $p_tbwidth ?>" cellpadding="4" cellspacing="0" class="GridStyle" align="center">
					...
					<tr valign="top" class="<?= $rowstyle ?>">
						...
						<?	} ?>
						<td><img id="<?= Akademik::base64url_encode($t_key) ?>" title="Halaman Kuliah" src="images/link.png" onclick="goPop('<?=$row['jeniskul']=='Kuliah'?"popMenu":"popMenuPrak"?>',this,event)" style="cursor:pointer"></td>
					</tr>
					<?	}
						if($i == 0) {
					?>
...
<table width="200" class="menu-body">
    ...
    <?php 
    	if (Akademik::isAdmin() || Akademik::isDosen()) { ?>
			...
			<tr class="menu-button" onMouseMove="this.className = 'hover'" onMouseOut="this.className = ''">
		        <td onClick="showPage('key','<?= Route::navAddress('set_absensionline') ?>')">Absensi Online</td>
		    </tr>
		    <tr class="menu-button" onMouseMove="this.className = 'hover'" onMouseOut="this.className = ''">
		        <td onClick="showPage('key','<?= Route::navAddress('set_absensibarcode') ?>')">Absensi RFID</td>
		    </tr>
		    <tr class="menu-button" onMouseMove="this.className = 'hover'" onMouseOut="this.className = ''">
		        <td onClick="showPage('key','<?= Route::navAddress('set_nilai') ?>')">Isi Nilai</td>
		    </tr>
			<tr class="menu-button" onMouseMove="this.className = 'hover'" onMouseOut="this.className = ''">
		        <td onClick="showPage('key','<?= Route::navAddress('list_quiz') ?>')">Aktivitas Quiz</td>
		    </tr>
			<tr class="menu-button" onMouseMove="this.className = 'hover'" onMouseOut="this.className = ''">
		        <td onClick="showPage('key','<?= Route::navAddress('list_bahanajar') ?>')">Modul & Video</td>
		    </tr>
    <?php } ?>
