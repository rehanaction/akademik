<?php
	...
	// struktur view
	$a_kolom = array();
	$a_kolom[] = array('kolom' => 'idjenissoal', 'label' => 'Id jenis Soal', 'readonly' => true);
	$a_kolom[] = array('kolom' => 'namajenissoal', 'label' => 'jenis Soal','type' => 'A','rows' => 2, 'cols' => 40, 'maxlength' => 255);
	
	// properti halaman
	$p_title = 'Data Jenis Soal Quisioner';
	$p_tbwidth = 500;
	$p_aktivitas = 'KULIAH';
