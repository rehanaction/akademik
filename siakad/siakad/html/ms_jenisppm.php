<?php
	...
	// struktur view
	$a_kolom = array();
	$a_kolom[] = array('kolom' => 'idtipeppm', 'label' => 'Kode', 'size' => 10, 'maxlength' => 20, 'notnull' => true);
	$a_kolom[] = array('kolom' => 'keterangan', 'label' => 'Jenis PPM', 'size' => 40, 'maxlength' => 50, 'notnull' => true);
	
	// properti halaman
	$p_title = 'Daftar Jenis PPM';
	$p_tbwidth = 420;
	$p_aktivitas = 'BIODATA';
