<?php
	...
	// struktur view
	$a_kolom = array();
	$a_kolom[] = array('kolom' => 'kodewn', 'label' => 'Kode', 'size' => 10, 'maxlength' => 10, 'notnull' => true);
	$a_kolom[] = array('kolom' => 'namawn', 'label' => 'Kewarganegaraan', 'size' => 30, 'maxlength' => 50, 'notnull' => true);
	
	// properti halaman
	$p_title = 'Daftar Kewarganegaraan';
	$p_tbwidth = 400;
	$p_aktivitas = 'BIODATA';
	
	$p_model = mWargaNegara;
	$p_key = $p_model::key;
