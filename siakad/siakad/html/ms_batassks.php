<?php
	...
	// include
	require_once(Route::getModelPath('batassks'));
	...
	// struktur view
	$a_kolom = array();
	$a_kolom[] = array('kolom' => 'sksmax', 'label' => 'SKS Max', 'size' => 3, 'maxlength' => 4, 'notnull' => true);
	$a_kolom[] = array('kolom' => 'ipatas', 'label' => 'IPS Atas', 'size' => 3, 'maxlength' => 4, 'notnull' => true);
	$a_kolom[] = array('kolom' => 'ipbawah', 'label' => 'IPS Bawah', 'size' => 3, 'maxlength' => 4, 'notnull' => true);
	//$a_kolom[] = array('kolom' => 'sksatas', 'label' => 'SKS Atas', 'size' => 3, 'maxlength' => 4, 'notnull' => true);
	//$a_kolom[] = array('kolom' => 'sksbawah', 'label' => 'SKS Bawah', 'size' => 3, 'maxlength' => 4, 'notnull' => true);
