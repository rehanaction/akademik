<?php
	...
	// properti halaman
	$p_title = 'Setting Honor Asisten';
	$p_tbwidth = 900;
	$p_aktivitas = 'ABSENSI';
	$p_model = mHonorAsisten;
	$a_addcolfilter=array('namapegawai','namamk');
	...
	// struktur view
	$a_kolom = array();
	$a_kolom[] = array('kolom' => 'h.nipasisten', 'label' => 'Nama Asisten');
	...
	$a_kolom[] = array('kolom' => 'isonline', 'label' => 'Jenis','type' => 'S', 'option' => $status_kuliah);
	...
	if($r_act == 'delete' and $c_delete) {
		...
		list($p_posterr,$p_postmsg) = $p_model::genGaji($conn,$r_unit,$r_periode,$r_periodegaji);
				...
				<table width="<?= $p_tbwidth-200 ?>" cellpadding="6" cellspacing="0" class="GridStyle">
					...
					<tr>		
						...
						<td>
							...
							<input type="button" value="Generate Honor Asisten" onclick="goGenGaji()">
						</td>
					</tr>
				</table><br>
