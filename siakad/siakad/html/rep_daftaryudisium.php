<?php
	...
	// properti halaman
	$p_title = 'Laporan Daftar Peserta Yudisium';
	$p_tbwidth = 800;
	$p_namafile = 'daftar_yudisium_'.$r_kodeunit;
	
	$rs = mLaporan::getDaftarYudisium($conn,$r_jurusan,$r_semester,$r_tahun);
	// header
...
?>
<div class="div_head">LAPORAN DAFTAR PESERTA YUDISIUM</div>
</br>
...
<tr bgcolor = "green">
	...
	<th style="color:#FFFFFF">Kode Yudisium</th>
	<th style="color:#FFFFFF">Tanggal Yudisium </th>
...
<? 
	...
	<tr>
	<td><?=$i;?></td>
	<td><?=$row['idyudisium']?></td>
	<td><?=CStr::formatDateInd ($row['tglyudisium'])?></td>
	<td><?=$row['nim']?></td>
	<td><?=$row['nama']?></td>
