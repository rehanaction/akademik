<?php
	...
	// properti halaman
	$p_title = 'Input Honor Pembimbing Magang';
	$p_tbwidth = 800;
	$p_aktivitas = 'ABSENSI';
	
	
	
	$p_model = mHonorPembimbingMagang;
	...
	$a_tgl= array('kolom' => 'tglujianmagang', 'type' => 'D');
	$i_tglujian=uForm::getInput($a_tgl,$r_tglujian);	
	$a_judulmagang= array('kolom' => 'judulmagang', 'type' => 'A','cols'=>'50','rows'=>'3');
	$i_judulmagang=uForm::getInput($a_judulmagang,$r_judlmagang);
	...
	$a_kolom[] = array('kolom' => 'tglujianmagang','type'=>'D','label' => 'Tanggal Ujian');
	...
	if($r_act == 'delete' and $c_delete) {
		...
		$record['judulmagang']=CStr::cStrNull($_POST['judulmagang']);
		$record['tglujianmagang']=CStr::formatDate($_POST['tglujianmagang']);
		...
		<div class="SideItem" id="SideItem">
			...
			<form name="pageform" id="pageform" method="post" enctype="multipart/form-data">
				...
				<table width="<?= $p_tbwidth-200 ?>" cellpadding="6" cellspacing="0" class="GridStyle">
					...
					<tr>		
						<td width="100" valign="top"> &nbsp; <strong>Judul Magang </strong></td>
						<td><?=$i_judulmagang;?></td>
					</tr>
					<tr>		
