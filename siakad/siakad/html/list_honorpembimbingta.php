<?php
	...
	// properti halaman
	$p_title = 'Generate Honor Dosen Pembimbing Tugas Akhir';
	$p_tbwidth = 800;
	$p_aktivitas = 'ABSENSI';
	
	$p_model = mHonorPembimbingTa;
	...
	$a_kolom[] = array('kolom' => 'topikta', 'label' => 'Topik TA/Skripsi');
	...
	if($r_act == 'delete' and $c_delete) {
		...
		list($p_posterr,$p_postmsg) = $p_model::genGaji($conn,$r_unit,$r_periode,$r_periodegaji,$r_sistemkuliah);
	}
	...
	$a_nopengajuan=$p_model::listNopengajuan($conn,$r_unit,$r_periodegaji);
	$l_nopengajuan = uCombo::combo($a_nopengajuan,$r_nopengajuan,'nopengajuan','onchange="goSubmit()"',true,'Nomor Pengajuan');
	$a_filtercombo = array();
			...
			<form name="pageform" id="pageform" method="post" enctype="multipart/form-data">
				...
				<table width="<?= $p_tbwidth-200 ?>" cellpadding="6" cellspacing="0" class="GridStyle">
					<tr>		
						...
						<td>
							<?=uCombo::semester($r_semester,false,'semester','',false).' '.uCombo::tahun($r_tahun,true,'tahun','',false);?>
