<?php
	...
	// properti halaman
	$p_title = 'Laporan Detail Honor Pembimbing Terstruktur Magang';
	$p_tbwidth = 650;
	$p_namafile = 'rekap_ajar'.$r_kodeunit;
	
	
	$a_rate=mRateHonor::getJenisRate($conn,'TM');
	
	$a_data = mLaporanHonor::getHonorBimbinganMagang($conn,$r_kodeunit,$r_periode,$r_periodegaji,$r_nopengajuan,$r_nip);
...
<tbody>	
	...
	<tr>	
		...
		<td align="left"><?=$row['jumlahbimbingan']?></td>
