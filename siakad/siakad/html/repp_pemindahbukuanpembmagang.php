<?php
	...
	// properti halaman
	$p_title = 'Laporan Pemindah Bukuan Honor Pembimbing Magang';
	$p_tbwidth = 500;
	$p_aktivitas = 'LAPORAN';
	...
	$a_input[] = array('label' => 'Nomor Pembayaran', 'nameid' => 'nopembayaran', 'type' => 'S','option' => mHonorPembimbingMagang::listNoPembayaran($conn,$r_periode,$r_periodegaji));
