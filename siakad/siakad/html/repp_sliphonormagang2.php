<?php
	...
	// properti halaman
	$p_title = 'Laporan Slip Honor Dosen Pembimbing Terstruktur Magang';
	$p_tbwidth = 450;
	$p_aktivitas = 'LAPORAN';
	...
	$a_laporan = array();
	$a_laporan['rep_rekapsliphonormagang2'] = 'Rekap';
	$a_laporan['rep_sliphonormagang2'] = 'Detail';
