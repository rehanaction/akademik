<?php
	...
	// struktur view
	$a_kolom = array();
	$a_kolom[] = array('kolom' => 'kodejumping', 'label' => 'Kode', 'size' => 2, 'maxlength' => 2, 'notnull' => true);
	$a_kolom[] = array('kolom' => 'namajumping', 'label' => 'Nama Propinsi', 'size' => 40, 'maxlength' => 50, 'notnull' => true);
	
	// properti halaman
	$p_title = 'Daftar Kriteria Jumping Class';
	$p_tbwidth = 500;
	$p_aktivitas = 'WILAYAH';
	
	$p_model = mJumpingClass;
	$p_key = $p_model::key;
