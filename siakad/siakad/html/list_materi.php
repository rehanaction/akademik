<?php
	...
	// properti halaman
	$p_title = 'Forum Materi';
	$p_tbwidth = 640;
	$p_aktivitas = 'KULIAH';
	$p_detailpage = 'list_materikelas';
	...
	<div id="wrapper">
		<div class="SideItem" id="SideItem">
			<form name="pageform" id="pageform" method="post">
				...
				<table width="<?= $p_tbwidth ?>" cellpadding="4" cellspacing="0" class="GridStyle" align="center" style="cursor:pointer;">
					<tr>
						<th>Mata Kuliah</th>
					...
					<tr class="<?= $rowstyle ?>">
						...
						<td align="center"><?= empty($t_id) ? '' : CStr::formatDateDiff($t_waktu) ?></td>
					</tr>
					<?	}
						if($i == 0) {
					?>
