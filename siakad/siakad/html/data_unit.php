<?php
	...
	if ($r_key == '20000000') {
		$a_input[] = array('kolom' => 'birokmhs', 'label' => 'KA Biro Kemahasiswaan', 'type' => 'S', 'option' => $a_dosen, 'empty' => true, 'readonly' => true);
	}
	...
	$a_input[] = array('kolom' => 'kodenim', 'label' => 'Kode NIM (Untuk NIM Mhs)', 'maxlength' => 4, 'size' => 4);
	$a_input[] = array('kolom' => 'jmlminimalpoin', 'label' => 'Jumlah Point Minimal', 'maxlength' => 3, 'size' =>3);
