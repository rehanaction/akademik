<?php
	...
	// struktur view
	$a_kolom = array();
	$a_kolom[] = array('kolom' => 'pelaksanaankurikulum', 'label' => 'pelaksanaan kurikulum', 'size' => 1, 'maxlength' => 1, 'notnull' => true);
	$a_kolom[] = array('kolom' => 'keterangan', 'label' => 'Keterangan', 'size' => 50, 'maxlength' => 4000);
	
	// properti halaman
	$p_title = 'Pelaksanaan Kurikulum';
	$p_tbwidth = 600;
	$p_aktivitas = '';
	
	$p_model = mPelaksanaankurikulum;
	$p_key = $p_model::key;
