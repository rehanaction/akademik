<?php
	...
	// properti halaman
	$p_title = 'Laporan Rasio Dosen Per-Fakultas';
	$p_tbwidth = 800;
	$p_namafile = 'rasio_dosen_fakultas';
	
	$rs = mLaporan::getRasiodosfakultas($conn,$r_fakultas,$r_semester,$r_tahun);
	// header
...
?>
<div class="div_head">LAPORAN RASIO DOSEN PER FAKULTAS</div>
</br>
