<?php  
	...
	$a_input[] = array('kolom' => 'jeniskuliah', 'label' => 'Jenis Pertemuan', 'type' => 'S', 'option' => $p_model::jenisKuliah(),'add'=>'onChange="setKelompok()"');
	$a_input[] = array('kolom' => 'kelompok', 'label'=>'Kelompok','type' => 'S', 'option' =>mCombo::kelompokKelas($conn), 'empty' => true);
	$a_input[] = array('kolom' => 'topikkuliah', 'label' => 'Rencana Materi', 'type' => 'A', 'rows' => 5, 'cols' => 50, 'maxlength' => 100,'notnull'=>true);
	...
	$a_input[] = array('kolom' => 'statusperkuliahan', 'label' => 'Status', 'type' => 'S', 'option' => $p_model::statusKuliah());
