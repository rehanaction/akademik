<?php
	...
	$a_data = mLaporanHonor::getRekapHonorKoreksi($conn,$r_kodeunit,$r_periode,$r_periodegaji,$r_jenisujian,$r_jeniskuliah,$r_nopengajuan,$r_sistemkuliah);
...
<table width="<?= $p_tbwidth ?>" class="tb_head">
	...
	<tr>
		<td>Jenis Kuliah</td>
		<td>:</td>
		<td><?=$a_jeniskuliah[$r_jeniskuliah]?></td>
	</tr>
	<tr>
		<td>Jenis Ujian</td>
		<td>:</td>
