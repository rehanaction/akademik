<?php
	...
	$a_kolom[] = array('kolom' => 'notest', 'label' => 'No. Tes');
	$a_kolom[] = array('kolom' => 'nama', 'label' => 'Nama Pendaftar');
	$a_kolom[] = array('kolom' => 'jalur', 'label' => 'Jalur');
	...
	// mendapatkan data
	$a_data = $p_model::getPagerDataReg($connh,$a_kolom,$r_row,$r_page,$r_sort,$a_filter);
