<?php
	...
	// properti halaman
	$p_title = 'Rekapitulasi Slip Honor Dosen Pembimbing Terstruktur Magang';
	$p_tbwidth = 700;
	$p_namafile = 'rekap_ajar'.$r_periode;
	
	$a_jenisujian=mCombo::getJenisUjian();
	$a_data = mLaporanHonor::getRekapHonorBimbinganMagang($conn,'',$r_periode,$r_periodegaji,'',$r_nip);
