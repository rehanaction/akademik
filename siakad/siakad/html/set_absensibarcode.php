<?php
	...
	// properti halaman
	$p_title = 'Pengisian Absensi Kuliah Menggunakan RFID, tanggal : '. date('Y-m-d');
	$p_tbwidth = 700;
	$p_aktivitas = 'ABSENSI';
			...
			<form name="pageform" id="pageform" method="post">
				...
				<table width="<?= $p_tbwidth ?>" cellpadding="4" cellspacing="0" class="GridStyle" align="center">
					<tr>
						...
						<br>
						<?	if($c_edit) { ?>
							<input type="text" name="input" id="input" placeholder="RFID" autocomplete="off" style="opacity: 0;">
						<?	} ?>
					</tr>
