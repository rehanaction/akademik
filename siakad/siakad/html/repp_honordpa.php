<?php
	...
	// properti halaman
	$p_title = 'Laporan Detail Honor Dosen Pembimbing Akademik';
	$p_tbwidth = 500;
	$p_aktivitas = 'LAPORAN';
	...
	$a_input[] = array('label' => 'Nomor Pengajuan', 'nameid' => 'nopengajuan', 'type' => 'S', 'option' => mHonorDpa::listNopengajuan($conn,$r_periode,$r_unit,$r_periodegaji));
	$a_input[] = array('label' => 'Basis', 'input' => uCombo::kelas($conn,$r_sistemkuliah,'sistemkuliah','',false));
	$a_input[] = array('nameid' => 'nipdosen', 'label' => 'Dosen Pembimbing', 'type' => 'X', 'text' => 'nip','param'=>'acdosen');
