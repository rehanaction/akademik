<?php  
	...
	// variabel request
	$r_pkey = CStr::removeSpecial(Akademik::base64url_decode($_REQUEST['pkey']));
	...
	$p_listpage .= '&key='.Akademik::base64url_encode($r_pkey);
	...
	$a_input[] = array('kolom' => 'topikkuliah', 'label' => 'Rencana Materi', 'type' => 'A', 'rows' => 5, 'cols' => 50, 'maxlength' => 1000, 'notnull'=>true);
	...
	$a_input[] = array('kolom' => 'koderuangrealisasi', 'label' => '(Realisasi) <b>Ruang Kuliah</b>', 'type' => 'S', 'option' => mCombo::ruang($conn),'readonly'=>$p_dosen);
		...
		$a_input[] = array('kolom' => 'keterangan', 'label' => '(Realisasi) Materi/Kegiatan', 'type' => 'A', 'rows' => 5, 'cols' => 50, 'maxlength' => 1000, 'notnull'=> false);
	...
	<div id="wrapper">
		<div class="SideItem" id="SideItem">
			<form name="pageform" id="pageform" method="post" enctype="multipart/form-data">
				<?	/*****************/
					...
					<table border="0" cellspacing="10" align="center">
						<tr>
							...
							<?	} if(!$p_posterr) { ?>
						   <td id="be_edit" class="TDButton" onclick="goEdit()" style="display:none">
					...
					?>
						<tr id="tr_<?= str_replace(" ", "", $t_row['label']) ?>">
							...
							<td class="RightColumnBG">
								...
								<? if ($t_row['label']=="Rencana Materi"){ ?>
									<span id="show" style="display:none"><?= $t_row['value'] ?></span>
								<? }elseif ($t_row['label']=="(Realisasi) Materi/Kegiatan"){ ?>
									<span id="show" style="display:none"><?= $t_row['value'] ?></span>
				...
				<input type="hidden" name="pkey" id="pkey" value="<?= Akademik::base64url_encode($r_pkey) ?>">
					<?php if($p_dosen){?>
