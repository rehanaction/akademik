<?php
	$t_tbwidth = $p_tbwidth;
	if(is_numeric($t_tbwidth))
		$t_tbwidth .= 'px';
	
	if(!(empty($a_filtercombo) and empty($r_page))) {
?>
<center>
	<div class="filterTable" style="width:<?= $t_tbwidth ?>;box-sizing:border-box">
				...
				<td valign="top" width="50%">
					<table width="100%" cellspacing="0" cellpadding="4">
						<tr>
							...
							<td width="30"><input type="button" value="Cari" class="ControlStyle" onClick="goFilterAll()"></td>
							<td><input type="button" value="Batal Cari" class="ControlStyle" onClick="goRemoveFilterAll()"></td>
	...
	<?	if(!empty($r_page)) { ?>
	<div class="Break"></div>
	<table style="width:<?= $t_tbwidth ?>" class="infotime">
		<tr>
