<?php
	...
	// properti halaman
	$p_title = 'Laporan Slip Gaji Dosen';
	$p_tbwidth = 450;
	$p_aktivitas = 'LAPORAN';
	...
	$a_input[] = array('label' => 'Prodi', 'nameid' => 'unit', 'type' => 'S', 'option' => mCombo::unit($conn,false,false,false), 'default' => $r_unit);
	...
	$a_laporan = array();
	$a_laporan['rep_rekapslipgaji'] = 'Rekap';
	$a_laporan['rep_slipgaji'] = 'Detail';
