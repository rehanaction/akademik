<?php 
	...
	// struktur view
	$a_kolom = array();
	$a_kolom[] = array('kolom' => 'bidangilmu', 'label' => 'Kode', 'size' => 2, 'maxlength' => 5, 'notnull' => true);
	$a_kolom[] = array('kolom' => 'namabidang', 'label' => 'Nama Bidang Ilmu', 'size' => 30, 'maxlength' => 50, 'notnull' => true);
	
	
	// properti halaman
	$p_title = 'Daftar Bidang Ilmu';
	$p_tbwidth = 400;
	$p_aktivitas = 'KULIAH';
