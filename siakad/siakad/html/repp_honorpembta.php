<?php
	...
	// properti halaman
	$p_title = 'Laporan Detail Honor Dosen Pembimbing Tugas Akhir';
	$p_tbwidth = 500;
	$p_aktivitas = 'LAPORAN';
	...
	$a_input[] = array('label' => 'Nomor Pengajuan', 'nameid' => 'nopengajuan', 'type' => 'S', 'option' => mHonorPembimbingTa::listNopengajuan($conn,$r_unit,$r_periodegaji));
