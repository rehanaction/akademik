<?php
	...
	// struktur view
	$a_kolom = array();
	$a_kolom[] = array('kolom' => 'evaluasike', 'label' => 'Eval-Ke', 'size' => 1, 'maxlength' => 4, 'notnull' => true);
	$a_kolom[] = array('kolom' => 'semesterevaluasi', 'label' => 'Sem-Evaluasi', 'size' => 2, 'maxlength' => 4, 'notnull' => true);
	$a_kolom[] = array('kolom' => 'batassks', 'label' => 'Batas SKS', 'size' => 3, 'maxlength' => 4, 'notnull' => true);
	$a_kolom[] = array('kolom' => 'batasip', 'label' => 'Batas IP', 'size' => 3, 'maxlength' => 4, 'notnull' => true);
