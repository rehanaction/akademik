<?php
	...
	// struktur view
	$a_kolom = array();
	$a_kolom[] = array('kolom' => 'kodependidikan', 'label' => 'Kode Pendidikan', 'size' => 2, 'maxlength' => 2, 'notnull' => true);
	$a_kolom[] = array('kolom' => 'namapendidikan', 'label' => 'Nama Pendidikan', 'size' => 10, 'maxlength' => 10, 'notnull' => true);
	
	// properti halaman
	$p_title = 'Daftar Pendidikan';
	$p_tbwidth = 300;
	$p_aktivitas = 'BIODATA';
