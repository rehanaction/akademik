<?php
	...
	// properti halaman
	$p_title = 'Laporan Aktivitas E-Learning';
	$p_tbwidth = 450;
	$p_aktivitas = 'LAPORAN';
	...
	$a_input[] = array('label' => 'Tgl Awal', 'input' => uForm::getInput($a_starttgl,$r_tglujian));
	$a_endtgl= array('kolom' => 'endtgl', 'type' => 'D');
	$a_input[] = array('label' => 'Tgl Akhir', 'input' => uForm::getInput($a_endtgl,$r_tglujian));
	
	$a_laporan = array();
	$a_laporan['rep_aktivitaselearning'] = 'Tampilkan';
