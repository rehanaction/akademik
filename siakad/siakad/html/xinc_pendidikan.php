<?php
	...
	$t_field[] = array('kolom' => 'idpendidikan', 'label' => 'Tingkat', 'type' => 'S', 'option' => $p_model::jenjangPend($conn), 'empty'=>true);
	$t_field[] = array('kolom' => 'namainstitusi', 'label' => 'Nama Instansi', 'size' => 30, 'maxlength' => 50);
	//$t_field[] = array('kolom' => 'kodeuniversitas', 'label' => 'Perguruan Tinggi', 'type' => 'S', 'option' =>$p_model::universitas($conn), 'empty' => true, 'list' => false);
...
<table width="100%" cellpadding="4" cellspacing="2" class="GridStyle" align="center">
	...
	<?	/********/
		...
		foreach($a_data[$p_label] as $row) {
			...
			$t_key1 = $p_model::getKeyRow($row,$p_colkey);
	?>
	<tr valign="top" class="<?= $rowstyle ?>">
		...
		<?	} ?>
		<td align="center"><img id="<?= $t_key1 ?>" title="Hapus Data" src="images/delete.png" onclick="goDelete(this)" style="cursor:pointer"></td>
	</tr>
	<?	}
		if($i == 0) {
	?>
