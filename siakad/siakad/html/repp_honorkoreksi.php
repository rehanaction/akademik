<?php
	...
	// properti halaman
	$p_title = 'Laporan Detail Honor Koreksi Hasil Ujian';
	$p_tbwidth = 500;
	$p_aktivitas = 'LAPORAN';
	...
	$a_input[] = array('label' => 'Nomor Pengajuan', 'nameid' => 'nopengajuan', 'type' => 'S', 'option' => mHonorKoreksiUjian::listNopengajuan($conn,$r_periode,$r_unit,$r_periodegaji));
	$a_input[] = array('label' => 'Jenis Kuliah', 'nameid' => 'jeniskuliah', 'type' => 'S', 'option' => mKuliah::jenisKuliah($conn));
	$a_input[] = array('label' => 'Jenis Ujian', 'input' => uCombo::jenisujian($conn,$r_jenisujian,'jenisujian','',false));
	$a_input[] = array('label' => 'Basis', 'input' => uCombo::kelas($conn,$r_sistemkuliah,'sistemkuliah','',false));
	$a_input[] = array('nameid' => 'nipdosen', 'label' => 'Petugas Koreksi', 'type' => 'X', 'text' => 'nip','param'=>'acdosen');
