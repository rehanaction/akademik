<?php
	...
	// struktur view
	$a_kolom = array();
	$a_kolom[] = array('kolom' => 'kodeakreditasi', 'label' => 'Kode', 'size' => 1, 'maxlength' => 1, 'notnull' => true);
	$a_kolom[] = array('kolom' => 'keterangan', 'label' => 'Akreditasi', 'size' => 50, 'maxlength' => 300);
	
	// properti halaman
	$p_title = 'Akreditasi Universitas';
	$p_tbwidth = 450;
	$p_aktivitas = '';
