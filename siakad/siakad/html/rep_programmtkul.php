<?php
	...
	// properti halaman
	$p_title = 'Laporan Program Mengulang Mahasiswa';
	$p_tbwidth = 900;
	$p_namafile = 'program_mengulang_mhs'.$r_kodeunit;
	
	$rs = mLaporan::getProgrammtkul($conn,$r_jurusan,$r_semester,$r_tahun);
	// header
...
?>
<div class="div_head">LAPORAN PROGRAM MENGULANG MAHASISWA</div>
</br>
...
<tr bgcolor= "green">
	...
	<th style="color:#FFFFFF">Jml Mengulang</th>
