<?php
	...
	$tableTitle = ".: Data Kuliah Mahasiswa :.";
	$columnCount = 11;
	
	
	$strSQL = "select * from tran_kuliah_mhs where 1=1 
...
<html>
<head>
<title>SIAKAD : Data Kuliah Mahasiswa</title>
<style>
.GridStyle 
{
...
<body onLoad="window.print()">
				<table width="720" border=1 cellpadding="4" cellspacing=0 class="GridStyle">
				  ...
				  <tr bgcolor="#33CCFF" height=20>
						<td align="center" class="SubHeaderBG">Kode_kuliah_mhs</td> 
						...
						<td align="center" class="SubHeaderBG">IPS</td>
						<td align="center" class="SubHeaderBG">Sks_semester</td>
						<td align="center" class="SubHeaderBG">IPK</td>		
						<td align="center" class="SubHeaderBG">Sks_total</td>	
				  </tr>					
				  <?			
						while (!$rs->EOF) 
						{							
				...
				?>
				  ...
				  <tr valign=center> 
				    <td  class="HeaderBG" align="right" colspan="11">&nbsp;</td>
				  </tr>
				</table>
