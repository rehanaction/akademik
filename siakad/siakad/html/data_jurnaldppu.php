<?php  
	...
	$a_input[] = array('kolom' => 'topikkuliah', 'label' => 'Rencana Materi', 'type' => 'A', 'rows' => 5, 'cols' => 50, 'maxlength' => 100,'notnull'=>$p_dosen,'readonly'=>$read);
	...
	$a_input[] = array('kolom' => 'koderuangrealisasi', 'label' => '(Realisasi) <b>Ruang Kuliah</b>', 'type' => 'S', 'option' => mCombo::ruang($conn),'readonly'=>$p_dosen);
		...
		$a_input[] = array('kolom' => 'tglkuliahrealisasi', 'label' => '(Realisasi) <b>Tanggal</b>', 'type' => 'D','readonly'=>$p_dosen);
		$a_input[] = array('kolom' => 'waktumulairealisasi', 'label' => '(Realisasi) <b>Jam Mulai</b>', 'maxlength' => 4, 'size' => 3, 'format' => 'CStr::formatJam','readonly'=>$p_dosen);
		$a_input[] = array('kolom' => 'waktuselesairealisasi', 'label' => '(Realisasi) <b>Jam Selesai</b>', 'maxlength' => 4, 'size' => 3, 'format' => 'CStr::formatJam','readonly'=>$p_dosen);
		...
		$a_input[] = array('kolom' => 'keterangan', 'label' => '(Realisasi) Materi/Kegiatan', 'type' => 'A', 'rows' => 5, 'cols' => 50, 'maxlength' => 255,'notnull'=>$p_dosen);
		$a_input[] = array('kolom' => 'kesandosen', 'label' => '(Realisasi) Catatan Dosen', 'type' => 'A', 'rows' => 5, 'cols' => 50, 'maxlength' => 100);
		...
		if(empty($r_key)) {
			...
			if($p_dosen){
				if(Akademik::detIp() and !empty($r_open) and ($_POST['isonline']==0 or empty($_POST['isonline'])))
					list($p_posterr,$p_postmsg) = $p_model::cekIp($conn,$r_key);
