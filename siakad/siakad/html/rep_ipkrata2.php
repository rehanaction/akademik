<?php
	...
	$p_title = '.:Laporan Daftar Mahasiswa Berdasarkan IPK Lebih Besar 3.00:.';
	
	$p_tbwidth = 900;
	$p_namafile = 'ipk_tertinggi_'.$r_kodeunit;
	
	 $rs = mLaporan::getIPKRatarata($conn,$r_jurusan,$r_angkatan,$r_semester,$r_tahun);
    // header
...
?>
<div class="div_head">LAPORAN DAFTAR MAHASISWA BERDASARKAN IPK LEBIH BESAR 3.00</div>
</br>
