<?php
	...
	// properti halaman
	$p_title = 'Laporan Detail Honor Pembimbing Tugas Akhir';
	$p_tbwidth = 650;
	$p_namafile = 'rekap_ajar'.$r_kodeunit;
	
	$a_sistemkuliah=mSistemkuliah::getArray($conn);
	$a_rate=mRateHonor::getJenisRate($conn,'PS');
	
	$a_data = mLaporanHonor::getHonorPembTa($conn,$r_kodeunit,$r_periodegaji,$r_nopengajuan,$r_sistemkuliah,$r_nip);
