<?php
	...
	// properti halaman
	$p_title = 'Laporan Detail Honor Naskah Ujian';
	$p_tbwidth = 500;
	$p_aktivitas = 'LAPORAN';
	...
	$a_input[] = array('label' => 'Nomor Pengajuan', 'nameid' => 'nopengajuan', 'type' => 'S', 'option' => mHonorSoal::listNopengajuan($conn,$r_periode,$r_unit,$r_periodegaji));
	...
	$a_input[] = array('nameid' => 'nipdosen', 'label' => 'Dosen PJMK', 'type' => 'X', 'text' => 'nip','param'=>'acdosen');
