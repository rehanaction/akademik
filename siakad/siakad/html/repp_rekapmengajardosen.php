<?php
	...
	// properti halaman
	$p_title = 'Laporan Rekapitulasi Jam Mengajar Dosen';
	$p_tbwidth = 450;
	$p_aktivitas = 'LAPORAN';
	...
	//$a_input[] = array('label' => 'Periode Gaji', 'nameid' => 'periodegaji', 'type' => 'S', 'option' => mHonorDOsen::listPeriodeGaji($conn,$r_periode,$r_unit),'default' => $r_periodegaji, 'add'=>'onchange="goSubmit()"','empty'=>'pilih periode');
	...
	$a_input[] = array('label' => 'Nomor Pengajuan', 'nameid' => 'nopengajuan', 'type' => 'S', 'option' => mHonorDOsen::listNopengajuan($conn,$r_periode,$r_unit,$r_periodegaji));
