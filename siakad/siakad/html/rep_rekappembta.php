<?php
	...
	// properti halaman
	$p_title = 'Laporan Rekapitulasi Honor Pembimbing Tugas Akhir';
	$p_tbwidth = 700;
	$p_namafile = 'rekap_ajar'.$r_periode;
	
	$a_sistemkuliah=mSistemkuliah::getArray($conn);
	
	$a_data = mLaporanHonor::getRekapHonorPembTa($conn,$r_kodeunit,$r_periodegaji,$r_nopengajuan,$r_sistemkuliah);
