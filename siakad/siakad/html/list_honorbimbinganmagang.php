<?php
	...
	// properti halaman
	$p_title = 'Input Honor Pembimbing Terstruktur Magang';
	$p_tbwidth = 800;
	$p_aktivitas = 'ABSENSI';
	
	
	
	$p_model = mHonorBimbinganMagang;
	...
	$a_jumlahbimbingan= array('kolom' => 'jumlahbimbingan', 'size' => 2,'maxlength'=>2,'type'=>'N');
	$i_jumlahbimbingan=uForm::getInput($a_jumlahbimbingan,$r_jumlahbimbingan);
	...
	$a_kolom[] = array('kolom' => 'jumlahbimbingan','label' => 'Jumlah Bimbingan');
	...
	if($r_act == 'delete' and $c_delete) {
		...
		$record['jumlahbimbingan']=CStr::cStrNull($_POST['jumlahbimbingan']);
		...
		<div class="SideItem" id="SideItem">
			...
			<form name="pageform" id="pageform" method="post" enctype="multipart/form-data">
				...
				<table width="<?= $p_tbwidth-200 ?>" cellpadding="6" cellspacing="0" class="GridStyle">
					...
					<tr>		
						<td width="100"> &nbsp; <strong>Jumlah Bimbingan </strong></td>
						<td><?=$i_jumlahbimbingan;?></td>
					</tr>
					<tr>		
