<?php
	...
	// properti halaman
	$p_title = 'Detil Slip Honor Dosen Pembimbing Terstruktur Terstruktur Magang';
	$p_tbwidth = 700;
	...
	$a_data = mLaporanHonor::getHonorBimbinganMagang($conn,'',$r_periode,$r_periodegaji,'',$r_nip);
	$a_gaji=array();
...
<tbody>	
	...
	<tr>	
		...
		<td class="marger"><?=$row['jumlahbimbingan']?></td>
