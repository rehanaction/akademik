<?php
	...
	// properti halaman
	$p_title = 'Detil Slip Honor Dosen Pembimbing Magang';
	$p_tbwidth = 800;
	...
	$a_data = mLaporanHonor::getHonorPembMagang($conn,'',$r_periode,$r_periodegaji,'',$r_nip);
	$a_gaji=array();
...
<tbody>	
	...
	<tr>	
		...
		<td class="marger"><?=CStr::formatDateInd($row['tglujianmagang'])?></td>
