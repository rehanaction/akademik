<?php
	...
	// properti halaman
	$p_title = 'Hasil Ekivalensi Mata Kuliah dan Nilai Lulus di K-2017';
	$p_tbwidth = 900;
	$p_aktivitas = 'KULIAH';
	...
	// sisi kiri
	$rows = mEkivAturan::getListKiriN($conn,$c_nim,$mhs['kodeunit']);
	...
	// sisi kanan
	$rows = mEkivAturan::getListKananN($conn,$c_nim,$mhs['kodeunit'],$r_kurikulumbaru);
    ...
    if ($rowkanan['nhuruf'] == ''){
		...
		$wajibA[$rowkanan['semmk']][] = $rowkanan['wajibpilihan'];  /*wajibpilihan*/  
		$nhurufA[$rowkanan['semmk']][] = $rowkanan['nhuruf'];  
	}
	...
	<div id="wrapper">
		<div class="SideItem" id="SideItem">
			<form name="pageform" id="pageform" method="post">
								...
								<table width="100%" border="1" cellspacing="0" cellpadding="4" class="GridStyle" bgcolor="#e2f1fa">
									...
									<? for($i=0;$i<count($kodemkA[$rowsem['sem']]);$i++){?>
										<tr>
											...
											<td align="center"><?=$wajibA[$rowsem['sem']][$i]?></td>   
				...
				<table width="<?= $p_tbwidth ?>" cellpadding="4" cellspacing="0" class="GridStyle" align="center">
        <td>                         
        SKS LULUS (K-2012):  <?= $skskiri; ?> 
        </td>
        <td>     
        SKS LULUS (K-2017): <?= $skskanan; ?>
        </td>
				</table>
