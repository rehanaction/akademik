<?php
	...
	// include
	require_once(Route::getModelPath('bidangkerja'));
	require_once(Route::getUIPath('combo'));
	
	// struktur view
	$a_kolom = array();
	$a_kolom[] = array('kolom' => 'bidangkerja', 'label' => 'Bidang Pekerjaan', 'size' => 50, 'maxlength' => 50, 'notnull' => true);
	
	// properti halaman
	$p_title = 'Daftar Bidang Pekerjaan';
	$p_tbwidth = 400;
	$p_aktivitas = 'BIODATA';
	
	$p_model = mBidangKerja;
	$p_key = $p_model::key;
