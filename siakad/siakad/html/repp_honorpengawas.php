<?php
	...
	$a_input[] = array('label' => 'Nomor Pengajuan', 'nameid' => 'nopengajuan', 'type' => 'S', 'option' => mHonorPengawas::listNopengajuan($conn,$r_periode,$r_unit,$r_periodegaji));
	$a_input[] = array('label' => 'Jenis Ujian', 'input' => uCombo::jenisujian($conn,$r_jenisujian,'jenisujian','',false));
	$a_input[] = array('nameid' => 'nipdosen', 'label' => 'Pengawas', 'type' => 'X', 'text' => 'nip','param'=>'acpengawas');
