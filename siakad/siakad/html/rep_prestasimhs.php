<?php
	...
	$p_tbwidth = 900;
	$p_namafile = 'prestasi_mhs_'.$r_kodeunit;
	
	$rs = mLaporan::getPrestasiMhs($conn,$r_jurusan);
	// header
...
?>
<div class="div_head">LAPORAN DAFTAR PRESTASI MAHASISWA</div>
</br>
...
<tr bgcolor = "green">
	...
	<th style="color:#FFFFFF">Tanggal Penghargaan</th>
	<th style="color:#FFFFFF">Nama Penghargaan</th>
</tr>
...
<? 
	...
	<td><?=$row['nim']?></td>
	<td><?=$row['nama']?></td>
	<td><?=CStr::formatDateInd ($row['tglpenghargaan'])?></td>
	<td><?=$row['namapenghargaan']?></td>
	</tr>
	<? }?>
	</table>
	<table>
