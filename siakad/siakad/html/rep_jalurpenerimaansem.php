<?php
	...
	// properti halaman
	$p_title = 'Laporan IPK Mahasiswa Sesuai Jalur Penerimaan Per- Fakultas';
	$p_tbwidth = 900;
	$p_namafile = 'jalur_penerimaan_semester'.$r_kodeunit;
	
	$rs = mLaporan::getIPKjalurPenerimaansem($conn,$r_fakultas,$r_semester,$r_tahun);
     // header
...
?>
<div class="div_head">LAPORAN IPK MAHASISWA SESUAI JALUR PENERIMAAN</div>
</br>
...
<tr bgcolor ="green">
	...
	<th rowspan="2" style ="color:#FFFFFF">Jmlh MHS</th>
