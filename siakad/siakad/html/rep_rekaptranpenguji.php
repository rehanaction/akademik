<?php
	...
	// properti halaman
	$p_title = 'Laporan Rekapitulasi Honor Transport Penguji';
	$p_tbwidth = 700;
	$p_namafile = 'rekap_ajar'.$r_periode;
	
	$a_jenispenguji=mHonorPenguji::getJenisSidang();
	$a_sistemkuliah=mSistemkuliah::getArray($conn);
	$a_data = mLaporanHonor::getRekapHonorTransportPenguji($conn,$r_kodeunit,$r_periode,$r_periodegaji,$r_nopengajuan,$r_jenispenguji,$r_sistemkuliah);
