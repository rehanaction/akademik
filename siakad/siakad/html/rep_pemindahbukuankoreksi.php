<?php
	...
	$a_data = mLaporanHonor::getPemindahBukuanKoreksi($conn,$r_periode,$r_periodegaji,$r_nopembayaran);
...
<table width="<?= $p_tbwidth-200 ?>" class="tb_data no_border">
	...
	<td><?=$a_sistemkuliah[$invoice['sistemkuliah']]?></td>
	</tr>
	<? }?>
</table>
<br>
<table width="<?= $p_tbwidth?>" class="tb_data">
	...
	<tr>
		...
		<td align="left">HONOR KOREKSI</td>
