<?php
	...
	$a_input[] = array('label' => 'Nomor Pengajuan', 'nameid' => 'nopengajuan', 'type' => 'S', 'option' => mHonorAsisten::listNopengajuan($conn,$r_periode,$r_unit,$r_periodegaji));
	$a_input[] = array('label' => 'Basis', 'input' => uCombo::kelas($conn,$r_sistemkuliah,'sistemkuliah','',false));
	$a_input[] = array('kolom' => 'nipasisten', 'label' => 'Asisten', 'type' => 'X', 'text' => 'asisten','param'=>'strpost:"f=acpegawaipenunjang"');
	
	$a_laporan = array();
	$a_laporan['rep_honorasisten'] = 'Detail';
	$a_laporan['rep_rekaphonorasisten'] = 'Rekap';
