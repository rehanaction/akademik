<?php
		...
		$r_keydetail=empty($r_keydetail)?$r_key:$r_keydetail;
		$detail_kelas = mDetailKelas::getArray($conn,$r_keydetail);
...
function delDetailKelas(elem) {
	if (confirm("yakin akan menghapus data ?")){
		...
		var posted = "f=delDetailKelas&q[]="+elem.id+"&q[]=<?=$r_keydetail?>&q[]=<?=$c_insert?>&q[]=<?=$c_edit?>&q[]=<?=$c_delete?>";
