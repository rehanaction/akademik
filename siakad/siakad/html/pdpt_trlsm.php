<?php
	...
	$tableTitle = ".: Data Riwayat Status Mahasiswa :.";
	$columnCount = 8;
	
	
	$strSQL = "select * from tran_riwayat_status_mhs where 1=1 
...
<html>
<head>
<title>SIAKAD : Data Riwayat Status Mahasiswa</title>
<style>
.GridStyle 
{
...
<body onLoad="window.print()">
				...
				?>
				  ...
				  <tr valign=center> 
				    <td  class="HeaderBG" align="right" colspan="8">&nbsp;</td>
				  </tr>
				</table>
