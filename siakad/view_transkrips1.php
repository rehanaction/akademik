			...
			<center>
				<div class="ViewTitle" style="width:<?= $p_tbwidth+50 ?>px;">
					<span>
						...
						&nbsp;<?= $p_title ?>
						<div class="right"><img title="Cetak Transkrip S1" width="24px" src="images/print.png" style="cursor:pointer" onclick="goPrint()"></div>
					</span>
				</div>
...
<?	} else { ?>
	showPage('null','<?= Route::navAddress('rep_transkrips1') ?>');
<?	} ?>
}
