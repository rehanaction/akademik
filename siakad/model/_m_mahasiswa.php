...
//$conn->debug=true;
			$sql = "select m.periodemasuk,m.nim,m.nimlama, m.nama,m.sistemkuliah,st.namasistem||'-'||st.tipeprogram as namasistemkuliah, m.periodemasuk,m.thnkurikulum, m.sex, m.semestermhs, m.ipk, m.skslulus, m.ipslalu, m.statusmhs,p.nidn,
...
//$conn->debug=false;
		...
		function getPenghargaan($conn,$key,$label='',$post='') {
			$sql = "select idpenghargaan, tglpenghargaan, namapenghargaan, namapenghargaanenglish, isvalid
