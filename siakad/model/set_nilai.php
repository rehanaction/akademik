...
<div id="main_content">
	...
	<div id="wrapper">
		<div class="SideItem" id="SideItem">
			...
			<form name="pageform" id="pageform" method="post" enctype="multipart/form-data" style="width:150%">
				<center>
				...
				<table width="250" cellpadding="4" cellspacing="0" class="GridStyle">
					...
					<?}?>
					<?  if(($ispjmk and !$c_kunci) and !$r_defaultunsur){?>
					<tr class="NoHover NoGrid">
				    ...
				    <td>
				<b>Petunjuk Penulisan Parameter Penilaian</b>
				 <ul>
					<li>Jika ada tugas 1 sampai 3 Gunakan subjek => "tugas1", "tugas2", dan "tugas3"</li>
					<li>Absensi Gunakan subjek => absensi (menggunakan huruf kecil)</li>
					<li>Ujian Tengah Semester gunakan subjek= > UTS,<br> Ujian Akhir Semester gunakan subjek=> UAS</li>
					<li>Setiap kali ada perubahan Parameter Penilaian mohon lakukan simpan ulang </li>
				 </ul>
				 <?= $r_defaultunsur ? '<span style="color:orange">* Berdasarkan kebijakan Kampus anda tidak berhak mengubah unsur penilaian</span>' : '';?>
				    </td>
				</tr>
				</table>
				...
				<table width="<?= $p_tbwidth ?>" cellpadding="4" cellspacing="0" class="GridStyle" align="center">
					...
					<?	} ?>
						...
						<th rowspan="2" width="40">N. Remidi</th>
						<th rowspan="2" width="30">NH</th>
						<th rowspan="2" width="30">Lulus</th>
						<th rowspan="2" width="30">Dipakai<br><input type="checkbox" onclick="toggleDipakai()" title="Check/Uncheck All"></th>
						<?	if($c_edit) { ?>
					...
					<?	} ?>
						...
						<td align="center"> <?= $row['nhuruf']; ?>
						</td>
						<td align="center"><?= empty($row['lulus']) ? '' : '<img src="images/check.png">' ?></td>
						<td align="center">
						<?	if($c_edit) { ?>
							<input type="checkbox" name="dipakai_<?= $t_key ?>" value="1"<?= empty($row['dipakai']) ? '' : ' checked' ?> onclick="setSimpan(this)" id="checklist">
						<?	} else { ?>
