<?php
	...
	class Modul {
		...
		function getFileAuthAJAX() {
			return self::getFileAuth('',true);
		}
		...
		function getSessionData($data) {
			...
			$modul['IDPEGAWAI'] = $data[$idx['IDPEGAWAI'][0]]['value'];
			...
			$modul['NAMABASIS'] = $data[$idx['NAMABASIS'][0]]['value'];
			$modul['NAMAKAMPUS'] = $data[$idx['NAMAKAMPUS'][0]]['value'];
			...
			foreach($idx['ROLEAKSES'] as $t_idx => $t_idxdata) {
				...
				$t_akses['kodebasis'] = $data[$idx['KODEBASISAKSES'][$t_idx]]['value'];
				$t_akses['kodekampus'] = $data[$idx['KODEKAMPUSAKSES'][$t_idx]]['value'];
				$t_akses['namabasis'] = $data[$idx['NAMABASISAKSES'][$t_idx]]['value'];
				$t_akses['namakampus'] = $data[$idx['NAMAKAMPUSAKSES'][$t_idx]]['value'];
