<?php
	...
	class uCombo {
		...
		function listRowNum($value='',$add='') {
			$data = array('10'=>'10','15'=>'15','20'=>'20','25'=>'25','30'=>'30','-1'=>'All');
		...
		function periodebobot($conn,&$valvar,$nameid='periodebobot',$add='',$empty=true,$where='') {
			$data = mCombo::periodebobot($conn,$where);
			
			return self::combo($data,$valvar,$nameid,$add,$empty,'periodebobot');
		}
	}
?>
