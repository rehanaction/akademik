<?php
	...
	// tampilkan doctype
	if(!in_array($_GET['page'],array('ajax','label','ajax_saldoawal','set_label'))){ // != 'ajax' or $_GET['page'] != 'label')
	...
	require_once($conf['helpers_dir'].'aset.class.php');
	...
	// set debug
	//if($_SERVER['REMOTE_ADDR'] == '192.168.1.145' or $_SERVER['REMOTE_ADDR'] == '192.168.1.175')
		$conn->debug = false;
