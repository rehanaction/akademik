<?php
	...
	$l_supplier = uCombo::supplier($conn,$r_supplier,'supplier','style="width:100px"',true);

	// properti halaman
	$p_title = 'Laporan Rekap Perolehan Barang (Biro Pengadaan)';
	$p_tbwidth = 450;
	$p_aktivitas = 'LAPORAN';
	...
	$a_input[] = array('label' => 'Sumber Dana', 'input' => uCombo::sumberdana($conn,$r_sumber,'sumber','style="width:175px"'));
	$a_input[] = array('label' => 'Supplier', 'input' => uCombo::supplier($conn,$r_supplier,'supplier','style="width:175px"'));
