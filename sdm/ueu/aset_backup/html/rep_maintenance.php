...
//	$a_supplier = mCombo::supplier($conn);
	...
	$sql ="select s.idlokasi, u.namaunit, p.nip+' - '+p.namalengkap as pemakai, s.noseri, s.idbarang+' - '+b.namabarang as barang,
					...
					and substring(s.idbarang,0,1) != '1' ";
