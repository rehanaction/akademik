<?php
	...
	$r_barang = CStr::removeSpecial($_REQUEST['idbarang']);
	...
	$sql="select s.idbarang,s.idbarang+' - '+b.namabarang as namabarang, l.namalokasi as namalokasi, 
    ...
    if(!empty($r_barang)) 
        $sql .= "and s.idbarang = '$r_barang' ";

    $sql .= " group by s.idbarang,b.namabarang,l.namalokasi,s.noseri, s.idkondisi, s.idstatus, s.merk,
             s.spesifikasi, s.tglperolehan, s.idlokasi, s.idunit, u.namaunit, p.namalengkap, k.kondisi, st.status
             order by s.idlokasi";
