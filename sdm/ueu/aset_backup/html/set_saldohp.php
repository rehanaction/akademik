<?php
	...
	//$rs = $conn->Execute("select * from aset.as_stockhp order by idbarang");
	//while($row = $rs->FetchRow()){
    //    $p_modeldet::setSaldoAvg($conn,$row['idbarang'],'2013-09-01');
    //}
    $row = array('1010301010000009','1010301001000008','1010304004000332','1010304004000333','1010304004000334','1010304004000335');
    
    foreach($row as $idbarang){
        //echo $idbarang.'<br>';
        $p_modeldet::setSaldoAvg($conn,$idbarang,'2013-09-01');
    }
