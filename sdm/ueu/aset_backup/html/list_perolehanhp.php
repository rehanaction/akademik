<?php
	...
	$a_kolom[] = array('kolom' => 'tgltransaksi', 'label' => 'Tgl. Perolehan', 'width' => 80, 'type' => 'D');
	$a_kolom[] = array('kolom' => 'unit', 'label' => 'Unit', 'nosearch' => true);
	$a_kolom[] = array('kolom' => 'namasupplier', 'label' => 'Supplier', 'width' => 150);
	$a_kolom[] = array('kolom' => 'nopo', 'label' => 'No. PO', 'width' => 120);
	...
	if(!empty($r_tahun) or !empty($r_bulan)) $a_filter[] = $p_model::getListFilter('periode_perolehan','',$r_tahun,$r_bulan);
