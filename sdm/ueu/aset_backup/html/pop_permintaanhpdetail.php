<?php
	...
	// properti halaman
	$p_title = 'Data Detail Permintaan Habis Pakai';
	$p_tbwidth = 500;
	$p_aktivitas = 'Detail Permintaan Habis Pakai';
...
<table border="0" width="<?= $p_tbwidth ?>" cellpadding="4" cellspacing="2" class="GridStyle" align="center">
	...
	<tr>
		<td class="LeftColumnBG"><?= Page::getDataLabel($row,'qtyaju') ?></td>
		<td class="RightColumnBG">
		    <?= Page::getDataInput($row,'qtyaju') ?>&nbsp;&nbsp;
    ...
    $('#barang').autocomplete(
	    ...
	    .result(
		    function(event,data,formated){
                $('#barang').val(data.idbarang+' - '+data.namabarang).focus();
