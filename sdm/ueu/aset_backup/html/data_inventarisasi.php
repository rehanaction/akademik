<?php
    ...
    $a_input[] = array('kolom' => 'idbarang', 'type' => 'H', 'notnull' => true);
	...
	<div id="wrapper">
		<div class="SideItem" id="SideItem">
			<form name="pageform" id="pageform" method="post">
				...
				<center>
					...
					<div class="box-content" style="width:<?= $p_tbwidth-22 ?>px">					
					    ...
					    <table width="<?= $p_tbwidth-22 ?>" cellpadding="4" cellspacing="2" align="center" class="GridStyle">
					        <tr>
					            <td colspan="<?= $r_isverify ? '6' : '5' ?>" class="DataBG">Set Lokasi Barang</td>
				            </tr>
					        <tr>
					            <th width="30">No.</th>
					            <th>Lokasi</th>
					        ...
					        <tr valign="top">
								...
								<?	if($r_isverify) { ?>
								<td align="center">
									<img title="Cetak BASTB" src="images/print-bastb.png" onclick="goCetakBASTB('<?= $val['iddetperolehan'] ?>')" style="cursor:pointer">
								</td>
								<?	} ?>
					            <?  if($c_change){ ?>
						        <td align="center">
					        ...
					        ?>
					        <tr><td colspan="<?= $r_isverify ? '6' : '5' ?>" align="center"><b>-- Data tidak ditemukan --</b></td></tr>
					        <?
					        }
					        ?>
					        <tr>
				...
				<input type="hidden" name="iddetail" id="iddetail" value="<?= $r_keydet ?>">
...
function goCetakBASTB(iddetail) {
