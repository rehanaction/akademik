<?php
	...
	$sql ="select p.nopo, p.idunit, u.namaunit, b.namabarang, sp.namasupplier, p.tglperolehan, count(se.idseri) as qty, sum(p.qty) as qtyb, p.harga, p.qty * p.harga as total
	...
	$sql .= " group by p.nopo, b.namabarang, p.tglperolehan, sp.namasupplier, p.idunit, u.namaunit, p.harga, p.qty
