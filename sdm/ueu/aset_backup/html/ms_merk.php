<?php
	...
	// include
	require_once(Route::getModelPath('merk'));
	
	// struktur view
	$a_kolom = array();
	$a_kolom[] = array('kolom' => 'merk', 'label' => 'Merk', 'size' => 30, 'maxlength' => 45, 'notnull' => true);
	
	// properti halaman
	$p_title = 'Daftar Merk Barang';
	$p_tbwidth = 400;
	$p_aktivitas = 'Merk Barang';
