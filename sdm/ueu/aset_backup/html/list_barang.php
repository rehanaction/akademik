<?php
	...
	// struktur view
	$a_kolom = array();
	$a_kolom[] = array('kolom' => 'idbarang', 'label' => 'ID. Barang', 'width' => 120);
			...
			<form name="pageform" id="pageform" method="post">
				...
				<table width="<?= $p_tbwidth ?>" cellpadding="4" cellspacing="0" class="GridStyle" align="center">
					...
					<tr valign="top" class="<?= $rowstyle ?>">
						...
						<?		if(($c_insert and substr($row['idbarang'],0,1) == 1 and $row['level'] < 6) or ($c_insert and substr($row['idbarang'],0,1) != 1 and $row['level'] < 5)) { ?>
