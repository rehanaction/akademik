<?php
	...
	$sql = "select right('000000' + cast(s.noseri as varchar(6)), 6) noseri, p.idbarang+' - '+b.namabarang as barang, p.merk, 
	          p.spesifikasi, pd.idlokasi+' - '+l.namalokasi as lokasi, pg.nip+' - '+pg.namalengkap as pemakai, p.tglperolehan, k.kondisi
			  from aset.as_perolehan p
...
?>
<div class="div_head">
    Berita Acara Serah Terima (BASTB) Barang<br/>
</div>
...
<table class="tb_data" width="<?= $p_tbwidth ?>">
	<tr>
		...
		<th width="175">Merk</th>
		<th>Spesifikasi</th>
		<th width="175">Lokasi</th>
		<th width="175">Pemakai</th>
