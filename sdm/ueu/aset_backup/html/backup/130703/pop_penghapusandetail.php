...
<table border="0" width="<?= $p_tbwidth ?>" cellpadding="4" cellspacing="2" class="GridStyle" align="center">
	...
	<? if($s_nilaihapus) { ?>
	<tr>
		<td class="LeftColumnBG"><?= Page::getDataLabel($row,'nilaipenghapusan') ?></td>
		<td class="RightColumnBG"><?= Page::getDataInput($row,'nilaipenghapusan') ?></td>
	</tr>
	<? } ?>
	<tr>
