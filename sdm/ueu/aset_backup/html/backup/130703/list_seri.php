<?php
	...
	$l_lokasi = uCombo::lokasi($conn,$r_lokasi,'unit','onchange="goSubmit()" style="width:270px;"',false);
	...
	$a_kolom[] = array('kolom' => 'lokasi', 'label' => 'Lokasi', 'width' => 150, 'nosearch' => true);
	$a_kolom[] = array('kolom' => 'tglperolehan', 'label' => 'Tgl. Perolehan', 'width' => 100, 'align' => 'center', 'type' => 'D');
	$a_kolom[] = array('kolom' => 'idkondisi', 'label' => 'Kondisi', 'width' => 50, 'align' => 'center');
	$a_kolom[] = array('kolom' => 'idstatus', 'label' => 'Status', 'width' => 50, 'align' => 'center');
