				...
				<center>
					...
					<div class="box-content" style="width:<?= $p_tbwidth-22 ?>px">					
					    ...
					    <table width="<?= $p_tbwidth-22 ?>" cellpadding="4" cellspacing="2" align="center" class="GridStyle">
					        <tr>
					            <td colspan="4" class="DataBG">Set Lokasi Barang</td>
				            </tr>
					        <tr>
					            <th width="30">No.</th>
					            <th>Lokasi</th>
					        ...
					        <tr valign="top">
					            ...
					            <?  /*if($r_isverify){ ?>
						        <td align="center">
							        <img title="Cetak BASTB" src="images/print.png" onclick="goCetakBASTB('<?= $val['iddetperolehan'] ?>')" style="cursor:pointer">
						        </td>
						        <?  }else{ ?>
						        <td align="center">
					        ...
					        ?>
					        <tr><td colspan="4" align="center"><b>-- Data tidak ditemukan --</b></td></tr>
					        <?
					        }
					        ?>
					        <tr>
