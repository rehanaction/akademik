...
function ayoHapus(pidbarang,plevel){
    $.post('ajax.php?f=ayohapus', { idbarang: pidbarang, level: plevel }, function(res){
	    if(res.err == '0') {
	...
	function doEdit(idbarang,namabarang,idbaru){
        getForm(idbarang,namabarang,idbaru);
	}
	
    function getForm(idbarang,namabarang,idbaru){
	    TINY.box.show({
	        url:'ajax.php',
