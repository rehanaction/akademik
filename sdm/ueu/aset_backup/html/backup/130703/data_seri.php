<?php
	...
	$a_input[] = array('kolom' => 'merk', 'label' => 'Merk', 'type' => 'T', 'maxlength' => 45, 'size' => 20);	
	...
	$a_input[] = array('kolom' => 'idstatus', 'label' => 'Status', 'type' => 'S', 'option' => mCombo::status($conn), 'add' => 'style="width:125px;"');
