<?php
	...
	// combo
	$l_unit = uCombo::unit($conn,$r_unit,'unit','onchange="goSubmit()" style="width:175px;"',false);
	...
	$a_kolom[] = array('kolom' => 'idbarang', 'label' => 'ID Barang', 'width' => 100, 'align' => 'center', 'nosearch' => true);
	$a_kolom[] = array('kolom' => 'kodeunit', 'label' => 'Kode Unit', 'width' => 60, 'align' => 'center', 'nosearch' => true);
	...
	// mendapatkan data
	//if(!empty($r_unit)) $a_filter[] = $p_model::getListFilter('unit',$r_unit,false);
