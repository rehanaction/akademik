<?php
	...
	class mMastDinas extends mModel {
		...
		function listQueryRate() {
			$sql = "select t.idrate,t.idtarifrate,rateperjalanan,namajabatan,jnsrate,tarifrate from ".static::table('ms_tarifperjalanan')." t 
					left join ".static::schema()."lv_rateperjalanan j on j.idrate=t.idrate
					left join ".static::schema()."ms_jabatan s on s.idjabatan=t.idjabatan";
