	...
	class mKIBTanah extends mModel {
		...
		function listQuery(){
			$sql = "select t.idseri, right('000000' + cast(s.noseri as varchar(6)), 6) noseri, t.nosertifikat, t.luas, t.alamat, 
						t.noakte, t.noskpt, t.statushukum, b.idbarang, b.namabarang
						from ".self::table()." t left join ".static::schema.".as_seri s on s.idseri = t.idseri left join ".static::schema.".ms_barang b on b.idbarang=s.idbarang";
