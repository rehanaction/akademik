	...
	class mKIBAlatTeknis extends mModel {
		...
		function listQuery(){
			$sql = "select k.idseri, right('000000' + cast(s.noseri as varchar(6)), 6) noseri, k.norangka, k.nomesin,
						k.tahunbuat, k.negaraasal, k.namapabrik, b.idbarang, b.namabarang
						from ".self::table()." k left join ".static::schema.".as_seri s on s.idseri=k.idseri left join ".static::schema.".ms_barang b on b.idbarang=s.idbarang";
