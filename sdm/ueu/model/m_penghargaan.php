<?php
	...
	class mPenghargaan extends mModel {
		...
		function listQueryPenghargaan($r_key) {
			$sql = "select r.*, c.namapenghargaan
					from ".self::table('pe_penghargaan')." r
					left join ".self::table('lv_penghargaan')." c on c.idpenghargaan=r.idpenghargaan
		...
		function jenisPenghargaan($conn) {
			$sql = "select idpenghargaan, namapenghargaan from ".static::schema()."lv_penghargaan order by idpenghargaan";
