	...
	class mKIBBangunan extends mModel {
		...
		function listQuery(){
			$sql = "select a.idseri, right('000000' + cast(s.noseri as varchar(6)), 6) noseri, a.noimb, a.tglimb, 
						a.nopersil, a.luas, a.jmllantai, a.alamat, b.idbarang1, b.namabarang
						from ".self::table()." a left join ".static::schema.".as_seri s on s.idseri=a.idseri left join ".static::schema.".ms_barang1 b on b.idbarang1=s.idbarang1";
