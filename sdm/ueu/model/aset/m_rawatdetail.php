<?php
	...
	class mRawatDetail extends mModel {
        ...
        function getRowByIDP($conn, $idparent){
		    $sql = "select d.iddetrawat,noseri,d.idseri,d.keluhan,d.biaya,s.idbarang1,s.merk,s.spesifikasi,
		        b.namabarang, s.idbarang1+' - '+b.namabarang as barang,p.namalengkap as pegawai,s.tglperolehan,s.tglgaransi,j.jenisrawat
		        from ".static::table()." d 
		...
		function dataQuery($key){
		    $sql = "select d.iddetrawat,d.idrawat,d.idseri,d.keluhan,d.biaya,d.idjenisrawat,j.jenisrawat,d.keluhan,
		        s.idbarang1,b.namabarang,s.merk,s.spesifikasi,s.tglperolehan,s.tglgaransi, 
