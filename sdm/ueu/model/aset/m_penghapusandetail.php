	...
	class mPenghapusanDetail extends mModel {
        ...
        function getRowByIDP($conn, $idparent){
		    $sql = "select d.iddetpenghapusan,s.noseri,d.idseri,d.nilaipenghapusan,
		        case when h.inserttime < '2016-06-01' then s.idbarang+' - '+b.namabarang else s.idbarang1+' - '+bb.namabarang END AS barang,
		        s.merk,s.spesifikasi,s.tglperolehan,
		        s.idlokasi,d.nilaipenghapusan,p.namalengkap as pemakai
		        from ".static::table()." d 
		        left join ".static::schema.".as_penghapusan h on h.idpenghapusan = d.idpenghapusan 
		...
		function dataQuery($key){
		    $sql = "select d.iddetpenghapusan,d.idpenghapusan,d.idseri,d.nilaipenghapusan,d.catatan,
		        s.idbarang1,b.namabarang,s.merk,s.spesifikasi,s.tglperolehan,s.idlokasi,l.namalokasi,
		...
		function getSeri($conn,$mdata,$pkey){
		    $sql = "select s.idseri,s.noseri,s.merk,s.spesifikasi,s.tglperolehan,
		        s.idlokasi,s.idbarang1+' - '+b.namabarang as barang, pd.nilaipenghapusan
