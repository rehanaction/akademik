<?php
	...
	class mOpnameDetail extends mModel {
		...
		function getRowByIDP($conn, $idparent){
		    $sql = "select d.iddetopname,s.noseri,s.idbarang1+' - '+b.namabarang as barang,d.idseri,s.merk,s.spesifikasi,
		...
		function dataQuery($key){
		    $sql = "select d.iddetopname,s.idbarang1,b.namabarang,d.idseri,s.merk,s.spesifikasi,
		        d.idkondisi,k.kondisi,d.idstatus,t.status,s.idbarang1+' - '+b.namabarang as barang 
		        from ".static::table()." d 
		        left join ".static::schema.".as_seri s on s.idseri = d.idseri 
		        left join ".static::schema.".ms_barang1 b on b.idbarang1 = s.idbarang1 
		        left join ".static::schema.".ms_kondisi k on k.idkondisi = d.idkondisi 
