<?php
	...
	$a_kolom[] = array('kolom' => 'namalengkap', 'label' => 'Nama', 'filter' => 'sdm.f_namalengkap(p.gelardepan,p.namatengah,p.namadepan,p.namabelakang,p.gelarbelakang)');
	...
	$sql = $p_model::listPersetujuanBerobat();
