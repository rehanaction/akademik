<?php
	...
	$p_window = 'Daftar Angka Kredit Bidang IB';
	...
	$a_data = $p_model::getListBidang1B($conn,$r_kode,($r_tahun.$r_semester));
	$rs = $a_data['list'];
	$a_det = $a_data['detail'];
	...
	?>
		...
		<table width="<?= $p_tbwidth ?>" border="1" cellpadding="4" cellspacing="0">
			<tr bgcolor = "gray">
				...
				<th align="center" width="10%"><b  style = "color:#FFFFFF">SKS</b></td>
				<th align="center" width="15%%"><b  style = "color:#FFFFFF">Tempat/Instansi</b></td>
				<th align="center" width="10%%"><b  style = "color:#FFFFFF">Tanggal</b></td>
				<th align="center" width="10%"><b  style = "color:#FFFFFF">Jumlah Angka Kredit</b></td>
