<?php
	...
	$p_dbtable = 'ms_ceklist';
	$p_key = 'noceklist';
	
	// struktur view
	$a_kolom = array();
	$a_kolom[] = array('kolom' => 'ceklist', 'label' => 'Isi Cek List', 'type' => 'A', 'rows' => 2, 'cols' => 70, 'maxlength' => 500, 'notnull' => true);
	$a_kolom[] = array('kolom' => 'isaktif', 'label' => 'Status Aktif', 'type' => 'S', 'option' => mCombo::isAktif());
	
	// properti halaman
	$p_title = 'Daftar Ceklist';
	$p_tbwidth = 600;
	$p_aktivitas = 'BIODATA';
	...
	if(empty($r_sort)) $r_sort = 'ceklist';
