<?php
	...
	$a_kolom[] = array('kolom' => 'tglawal', 'label' => 'Tgl. Mulai', 'type' => 'D', 'align' => 'center', 'width' => '150px');
	...
	if($r_act == 'delete' and $c_delete) {
		...
		if(!$p_posterr){		
			...
			$where = 'idpegawai,idpkm';
			
			list($p_posterr,$p_postmsg) = $p_model::delete($conn,$a_key,$p_dbtable,$where,'','filepkm');
		}
	...
	$sql = $p_model::listQueryPKM($r_key);
	...
	//list tim penelitian
	$a_tim = $p_model::listTimPKM($conn,$r_key);
