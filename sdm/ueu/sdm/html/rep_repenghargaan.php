<?php
	...
	$p_tbwidth = 1000;
	$p_col = 10;
	$p_file = 'penghargaanpegawai_'.$r_kodeunit;
	$p_model = 'mPenghargaan';
	$p_window = 'Daftar Penghargaan Pegawai';
    ...
    $a_data = $p_model::repPenghargaan($conn,$r_kodeunit,$r_tglmulai,$r_tglselesai);
	
	$rs = $a_data['list'];
	
	$p_title = 'Daftar Penghargaan Pegawai <br />
...
<div align="center">
		...
		<table width="<?= $p_tbwidth ?>" border="1" cellpadding="4" cellspacing="0">
			<tr bgcolor = "gray">
				...
				<th><b style = "color:#FFFFFF">Tgl. Penghargaan</b></th>
				<th><b style = "color:#FFFFFF">Nama Penghargaan</b></th>
			...
			<tr>
				...
				<td><?= $row['namaunit']; ?></td>
				<td><?= $row['tipepeg']; ?></td>
				<td align="center"><?= CStr::formatDateInd($row['tglpenghargaan']); ?></td>	
				<td><?= $row['bentukreward']; ?></td>	
				<td><?= $row['nosk']; ?></td>	
