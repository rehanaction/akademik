<?php
	...
	$a_kolom[] = array('kolom' => 'tglsertifikasi', 'label' => 'Tgl. Sertifikasi', 'type' => 'D', 'align' => 'center');
	$a_kolom[] = array('kolom' => 'jenissertifikasi', 'label' => 'Jenis Sertifikasi', 'filter' => 'j.jenissertifikasi');
	$a_kolom[] = array('kolom' => 'nosertifikasi', 'label' => 'No. Sertifikasi');
	$a_kolom[] = array('kolom' => 'filesertifikasi', 'label' => 'File Sertifikasi');
	...
	if(empty($r_sort)) $r_sort = 'nik,tglsertifikasi desc';
	...
	$sql = $p_model::listQueryValidasiSertifikasi();
					...
					<tr valign="top" class="<?= $rowstyle ?>">
						<?	foreach($rowc as $j => $rowcc) {
								...
								if($a_kolom[$j]['kolom'] == $p_key)
									continue;
								if($a_kolom[$j]['kolom'] == 'filesertifikasi'){
