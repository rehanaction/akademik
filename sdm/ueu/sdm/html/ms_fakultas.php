<?php
	...
	// struktur view
	$a_kolom = array();
	$a_kolom[] = array('kolom' => 'kodefakultas', 'label' => 'Kode Fakultas', 'size' => 2, 'maxlength' => 3, 'align' => 'center', 'notnull' => true);
	$a_kolom[] = array('kolom' => 'namafakultas', 'label' => 'Nama Fakultas', 'size' => 40, 'maxlength' => 255, 'notnull' => true);
	
	// properti halaman
	$p_title = 'Daftar Nama Fakultas';
	$p_tbwidth = 400;
	$p_aktivitas = 'BIODATA';
