<?php
	...
	$a_kolom[] = array('kolom' => 'idpangkat', 'label' => 'Golongan', 'type' => 'S', 'option' => $p_model::getCPangkat($conn), 'notnull' => true);
	...
	$p_dbtable = 'ga_tarifmengajar';
	$p_key = 'idpendidikan,idpangkat';
