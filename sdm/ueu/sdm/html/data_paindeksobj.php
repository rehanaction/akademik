<?php
	...
	// properti halaman
	$p_title = 'Data Indeks Nilai Objektif';
	$p_tbwidth = 800;
	$p_aktivitas = 'NILAI';
	...
	$p_key = "kodeperiodebobot,indeksnilai";
	
	//struktur view
	$a_input = array();
	$a_input[] = array('kolom' => 'indeksnilai', 'label' => 'Indeks', 'maxlength' => 3, 'size' => 2, 'notnull' => true);
	...
	$a_input[] = array('kolom' => 'keterangan', 'label' => 'Keterangan', 'maxlength' => 255, 'size' => 60, 'notnull' => true);
	...
	if($r_act == 'save' and $c_edit) {
		...
		if(!$p_posterr){
			$r_subkey  = $r_key.'|'.$record['indeksnilai'];
			unset($post);
		}
	}
