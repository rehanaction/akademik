<?php
	...
	// properti halaman
	$p_title = 'Daftar Pengalaman Organisasi';
	$p_tbwidth = 800;
	$p_aktivitas = 'HISTORY';
	...
	$a_kolom[] = array('kolom' => 'lingkup', 'label' => 'Lingkup', 'align' => 'center', 'filter' => "case when r.lingkuporganisasi = 'L' then 'Lokal' when r.lingkuporganisasi = 'N' then 'Nasional' when r.lingkuporganisasi = 'I' then 'Internasional' end");
	...
	if($r_act == 'delete' and $c_delete) {
		...
		$where = 'idpegawai,nourutpo';
		
		list($p_posterr,$p_postmsg) = $p_model::delete($conn,$a_key,$p_dbtable,$where,'','fileorganisasi');
	}
	...
	$sql = $p_model::listQueryOrganisasi($r_key);
