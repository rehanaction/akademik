<?php
	...
	$p_dbtable = 'ms_jenissk';
	$p_key = 'jenissk';
	
	// struktur view
	$a_kolom = array();
	$a_kolom[] = array('kolom' => 'jenissk', 'label' => 'Kode Jenis SK', 'size' => 2, 'maxlength' => 5, 'align' => 'center', 'notnull' => true);
	$a_kolom[] = array('kolom' => 'namajenissk', 'label' => 'Jenis SK', 'size' => 40, 'maxlength' => 70, 'notnull' => true);
	
	// properti halaman
	$p_title = 'Daftar Jenis SK';
	$p_tbwidth = 450;
	$p_aktivitas = 'BIODATA';
	...
	if(empty($r_sort)) $r_sort = 'namajenissk';
