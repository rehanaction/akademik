<? 
	...
	$p_tbwidth = "700";
	$p_title = "Data Tarif Lembur Khusus";
	...
	$a_input[] = array('kolom' => 'tarifumr', 'label' => 'Tarif UMR', 'maxlength' => 12, 'size' => 15, 'notnull' => true, 'type' => 'N');
	...
	$sql = $p_model::getDataEditTarifUMR($r_key);
					...
					<td>
						<form name="pageform" id="pageform" method="post">
							...
							<table width="100%" cellspacing="0" cellpadding="4" class="bottomline">
								<tbody>
									<tr>
										<td class="LeftColumnBG" width="200px"><?= Page::getDataLabel($row,'namalengkap') ?></td>
									...
									<tr>
										<td class="LeftColumnBG"><?= Page::getDataLabel($row,'tglberlaku') ?></td>
										<td class="RightColumnBG"><?= Page::getDataInput($row,'tglberlaku') ?></td>
									</tr>
									<tr>
										<td class="LeftColumnBG"><?= Page::getDataLabel($row,'tarifumr') ?></td>
										<td class="RightColumnBG"><?= Page::getDataInput($row,'tarifumr') ?></td>
									</tr>
									<tr>
