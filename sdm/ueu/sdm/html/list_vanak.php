<?php
	...
	$a_kolom[] = array('kolom' => 'namaanak', 'label' => 'Nama Anak');
	...
	$a_kolom[] = array('kolom' => 'tgllahir', 'label' => 'Tgl Lahir', 'type' => 'D', 'align' => 'center');
	$a_kolom[] = array('kolom' => 'anakke', 'label' => 'Anak ke');
	...
	$sql = $p_model::listQueryValidasiAnak();
