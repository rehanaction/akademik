<?php
	...
	$a_inputman = array();
	$a_inputman[] = array('kolom' => 'tahun1', 'size' => 4, 'maxlength' => 4, 'type' => 'N');
	$a_inputman[] = array('kolom' => 'tahun2', 'size' => 4, 'maxlength' => 4, 'type' => 'N');
		...
		<div class="SideItem" id="SideItem">
			<form name="pageform" id="pageform" method="post">
				...
				<center>
					...
					<?	} ?>
						<tr>
							<td class="LeftColumnBG">Periode Tahun</td>
