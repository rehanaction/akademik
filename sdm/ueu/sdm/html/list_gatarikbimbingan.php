<?php
	...
	$a_kolom[] = array('kolom' => 'jmlbimbingan', 'label' => 'Jumlah Bimbingan', 'width' => '150px');
	
	// properti halaman
	$p_title = 'Penarikan Data Bimbingan untuk Perhitungan Gaji';
	$p_tbwidth = 1000;
	$p_aktivitas = 'ANGGARAN';
	$p_detailpage = Route::getDetailPage();
	$p_dbtable = "ga_bimbinganlog";
	...
	if($r_act == 'tarik' and $c_insert) {			
		...
		list($p_posterr,$p_postmsg) = $p_model::tarikDataBimbingan($conn,$r_periode);
	...
	$sql = $p_model::listQueryHistoryBimbingan();
