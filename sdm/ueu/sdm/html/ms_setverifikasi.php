<?php
	...
	$p_dbtable = 're_setverifikasi';
	$p_key = 'expiredday';
	
	// struktur view
	$a_kolom = array();
	$a_kolom[] = array('kolom' => 'expiredday', 'label' => 'Jumlah Expired (Hari)', 'size' => 10, 'maxlength' => 3, 'notnull' => true);
	$a_kolom[] = array('kolom' => 'isaktif', 'label' => 'Status Aktif', 'type' => 'S', 'option' => mCombo::isAktif());
	
	// properti halaman
	$p_title = 'Daftar Expired Verifikasi Email Portal';
	$p_tbwidth = 400;
	$p_aktivitas = 'BIODATA';
	...
	if(empty($r_sort)) $r_sort = 'expiredday';
