<?php
	...
	$p_tbwidth = 900;
	$p_col = 9;
	$p_file = 'pensiunpegawai_'.$r_kodeunit;
	$p_model = 'mPekerjaan';
	$p_window = 'Daftar Pensiun Pegawai';
    ...
    $a_data = $p_model::repPensiun($conn,$r_kodeunit,$r_tglmulai,$r_tglselesai,$r_jenis);
	
	$rs = $a_data['list'];
	
	$p_title = 'Daftar Pensiun Pegawai <br />
...
<div align="center">
		...
		<table width="<?= $p_tbwidth ?>" border="1" cellpadding="4" cellspacing="0">
			<tr bgcolor = "gray">
				...
				<th><b style = "color:#FFFFFF">Tgl Pensiun</b></th>
				<th><b style = "color:#FFFFFF">Jenis Pensiun</b></th>
				<th><b style = "color:#FFFFFF">Masa Kerja</b></th>
				<th><b style = "color:#FFFFFF">SK. Pensiun</b></th>
			</tr>
			...
			<tr>
				...
				<td><?= $row['namaunit']; ?></td>
				<td><?= CStr::formatDateInd($row['tmtpensiun']); ?></td>	
				<td><?= $row['namastatusaktif']; ?></td>
				<td><?= $row['masakerjathn'].' tahun '.$row['masakerjabln'].' bulan'; ?></td>
				<td><?= $row['skpensiun']; ?></td>		
			</tr>
