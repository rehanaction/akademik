<? 
	...
	//print_r(mCombo::jenispegawaibaru($conn));
	...
	//$tipepeg = mPegawai::getTipePegawai($conn,$r_key);
	$r_act = $_POST['act'];
	if($r_act == 'save' and $c_edit) {
		...
		if(($record['idtipepeg'] == 'D' or $record['idtipepeg'] == 'AD' or $record['idtipepegbaru'] == 'D' or $record['idkelompok'] == 'A1') and $record['nodosen'] == 'null')
