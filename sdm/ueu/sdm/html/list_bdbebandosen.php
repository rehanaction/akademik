<?php
	...
	// properti halaman
	$p_title = 'Daftar Bidang Pendidikan';
	$p_tbwidth = 800;
	$p_aktivitas = 'NILAI';
	...
	$a_kolom[] = array('kolom' => 'periodekuliah', 'label' => 'Periode', 'filter' => "substring(thnakademik,1,4)+'/'+substring(thnakademik,5,4)+' '+case when semester = '01' then 'Ganjil' when semester = '02' then 'Genap' end");
			...
			<form name="pageform" id="pageform" method="post">
				...
				<table width="<?= $p_tbwidth ?>" cellpadding="4" cellspacing="0" class="GridStyle" align="center">
					...
					<tr valign="top" class="<?= $rowstyle ?>">
						...
						<?		
								if($c_delete and empty($row['refnobidangib']) and (Modul::getRole() == 'A' or Modul::getRole() == 'AP' or $t_valid != 'Y')) { ?>
