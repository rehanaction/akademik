<?php
	...
	$p_window = 'Daftar Angka Kredit Bidang IV';
	...
	$a_data = $p_model::getListBidang4($conn,$r_kode,($r_tahun.$r_semester));
	$rs = $a_data['list'];
	$a_det = $a_data['detail'];
	$a_col = $a_data['colspan'];
	
	$p_title = 'DAFTAR PERNYATAAN<br>MELAKSANAKAN KEGIATAN PENUNJANG TRIDHARMA P.T.';
?>
<html>
<head>
	...
	?>
		...
		<table width="<?= $p_tbwidth ?>" border="1" cellpadding="4" cellspacing="0">
			<tr bgcolor = "gray">
				...
				<th align="center" width="30%"><b  style = "color:#FFFFFF">Kegiatan Penunjang Tri Dharma P.T</b></th>
				<th align="center" width="15%"><b  style = "color:#FFFFFF">Kedudukan/ Tingkat</b></th>
			...
			<tr>
				...
				<td valign="<?= $valign;?>" align="center"><?= $val['kedudukan']; ?></td>
				<td valign="<?= $valign;?>" align="center"><?= $val['lokasi']; ?></td>
