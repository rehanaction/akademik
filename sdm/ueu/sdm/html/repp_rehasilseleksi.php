<?php
	...
	// properti halaman
	$p_title = 'Rekapitulasi Hasil Seleksi Penerimaan Pegawai';
	$p_tbwidth = 600;
	$p_aktivitas = 'LAPORAN';
	
	$p_model = 'mRekrutmen';
	$p_reportpage = 'rep_rehasilseleksi';
		
	$a_input = array();
	$a_input[] = array('kolom' => 'unit', 'label' => 'Unit', 'input' => uCombo::unit($conn,$r_kodeunit,'unit','',false));
	$a_input[] = array('label' => 'Jenis', 'input' => UI::createRadio('jenis',$p_model::jenisRekrutmen(),$r_jenis,true));
		...
		<div class="SideItem" id="SideItem">
			<form name="pageform" id="pageform" method="post">
				...
				<center>
					...
					<?	} ?>
						<tr>
							<td class="LeftColumnBG">Tgl. Proses</td>
