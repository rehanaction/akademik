<?php
	...
	// struktur view
	$a_kolom = array();
	$a_kolom[] = array('kolom' => 'kodepajenis', 'label' => 'Kode', 'size' => 3, 'maxlength' => 3, 'align' => 'center', 'notnull' => true);
	$a_kolom[] = array('kolom' => 'namapajenis', 'label' => 'Nama', 'size' => 30, 'maxlength' => 100, 'notnull' => true);
	
	// properti halaman
	$p_title = 'Daftar Jenis Penilai';
	$p_tbwidth = 400;
	$p_aktivitas = 'NILAI';
	$p_dbtable = 'pa_jenispenilai';
	$p_key = 'kodepajenis';
