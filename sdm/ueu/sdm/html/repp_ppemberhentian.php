<?php
	...
	$l_jenis = UI::createCheckBox('jenis[]',$p_model::jenisPensiun($conn),'',true,true,'checked');
		
	$a_input = array();
	$a_input[] = array('label' => 'Unit', 'input' => uCombo::unit($conn,$r_kodeunit,'unit','',false));
	$a_input[] = array('label' => 'Jenis Pensiun', 'input' => $l_jenis);
		...
		<div class="SideItem" id="SideItem">
			<form name="pageform" id="pageform" method="post">
				...
				<center>
					...
					<?	} ?>
						<tr>
							<td class="LeftColumnBG">Tgl. Pemberhentian</td>
