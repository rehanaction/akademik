<?php
	...
	$a_kolom[] = array('kolom' => 'tglpergi', 'label' => 'Tgl Mulai', 'type' => 'D');
	$a_kolom[] = array('kolom' => 'tglpulang', 'label' => 'Tgl Selesai', 'type' => 'D');
	$a_kolom[] = array('kolom' => 'dalamrangka', 'label' => 'Keterangan Dinas');
	
	// properti halaman
	$p_title = 'Daftar Usulan Tugas Kedinasan Unit';
	$p_tbwidth = 900;
	...
	if (empty($r_sort))	$r_sort = 'tglpergi desc';
	...
	$sql = $p_model::listQueryUsulanDinas();
				...
				<table width="<?= $p_tbwidth ?>" cellpadding="4" cellspacing="0" class="GridStyle" align="center">
					...
					<?	/********/
						...
						foreach($a_data as $row) {
							...
							$t_key = $p_model::getKeyRow($row,'refid');
...
<table width="130" class="menu-body">
    <tr class="menu-button" onMouseMove="this.className = 'hover'" onMouseOut="this.className = ''">
        <td onClick="showPage('key','<?= Route::navAddress('list_validasidinas') ?>')">Persetujuan Dinas</td>
    </tr>
</table>
</div>
