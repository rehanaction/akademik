<? 
	...
	$p_tbwidth = "680";
	$p_title = "Data Tarif Potongan Pegawai";
	...
	$a_input[] = array('kolom' => 'kodepotongan', 'label' => 'Jenis Potongan', 'type' => 'S', 'option' => $p_model::getCPotOtomatis($conn), 'notnull' => true);
	...
	$sql = $p_model::getDataTarifPotonganPeg($r_key);
