<?php
	...
	$p_tbwidth = 1200;
	$p_col = 14;
	$p_file = 'kenaikan_gajiberkala_'.$r_kodeunit;
	$p_model = 'mKenaikan';
	$p_window = 'Daftar Kenaikan Gaji Berkala';
    ...
    $a_data = $p_model::repNaikGaji($conn,$r_kodeunit,$r_tglmulai,$r_tglselesai);
	
	$rs = $a_data['list'];
	
	$p_title = 'Daftar Kenaikan Gaji Berkala <br />
...
<div align="center">
		...
		<table width="<?= $p_tbwidth ?>" border="1" cellpadding="4" cellspacing="0">
			...
			<tr>
				<td><?= $i; ?></td>
				<td align="center"><?= CStr::formatDateInd($row['tglkgb']); ?></td>
				<td align="center"><?= $row['nik']; ?></td>
				<td><?= $row['namalengkap']; ?></td>
				<td><?= $row['namaunit']; ?></td>
				<td align="center"><?= $row['golonganlama']; ?></td>
				<td align="center"><?= CStr::formatDateInd($row['tmtpangkatlama']); ?></td>
				<td><?= $row['mklama']; ?></td>
				<td align="center"><?= $row['golonganbaru']; ?></td>
