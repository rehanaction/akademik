<?php
	...
	$a_kolom[] = array('kolom' => 'nosurat', 'label' => 'No. Urut Cuti', 'filter' => 'r.nosurat');
	...
	$a_kolom[] = array('kolom' => 'statususulan', 'label' => 'Status', 'align' => 'center');
	
	// properti halaman
	$p_title = 'Daftar Pengajuan Cuti';
	$p_tbwidth = 900;
	$p_aktivitas = 'DAFTAR';
	$p_key = 'nourutcuti';
	...
	$a_statuscuti = $p_model::statusSetujuiCuti();
	$sql = $p_model::listPersetujuanCuti();
		...
		<div class="SideItem" id="SideItem">
			...
			<div class="filterTable" style="width:<?= $p_tbwidth-12 ?>px;">
				<table cellspacing="0" cellpadding="0" align="center" width="890">
					<tr>
						<td colspan="2"><strong>Keterangan Jenis Cuti :</strong></td>
					</tr>
					<? foreach ($a_statuscuti as $kode => $label){?>
					<tr>
						<td width="20"><?= $kode; ?></td>
						<td>: <?= $label; ?></td>
					</tr>
