<?php
	...
	$a_kolom[] = array('kolom' => 'kategorinilai', 'label' => 'Kategori');
	...
	if($r_act == 'delete' and $c_delete) {
		...
		$where = 'kodeperiodebobot,kategorinilai';
	...
	$sql = $p_model::listQueryKategoriNilai($r_key);
			...
			<form name="pageform" id="pageform" method="post">
				...
				<table width="<?= $p_tbwidth ?>" cellpadding="4" cellspacing="0" class="GridStyle" align="center">
					...
					<tr valign="top" class="<?= $rowstyle ?>">
						...
						<td align="center">
						<?		if($c_edit) { ?>
							<img id="<?= $row['kodeperiodebobot'].'|'.$row['kategorinilai'] ?>" title="Tampilkan Detail" src="images/edit.png" onclick="goDetail(this)" style="cursor:pointer">
						<?		}
								if($c_delete and (Modul::getRole() == 'A' or $t_valid != 'Y')) { ?>
							<img id="<?= $row['kodeperiodebobot'].'|'.$row['kategorinilai'] ?>" title="Hapus Data" src="images/delete.png" onclick="goDelete(this)" style="cursor:pointer">
						<?		} ?>
						</td>
						<?	} ?>
					</tr>
