<?php
	...
	// struktur view
	$a_kolom = array();
	$a_kolom[] = array('kolom' => 'idbank', 'label' => 'Kode Bank', 'size' => 5, 'maxlength' => 5, 'align' => 'center', 'notnull' => true);
	$a_kolom[] = array('kolom' => 'namabank', 'label' => 'Nama Bank', 'size' => 30, 'maxlength' => 255, 'notnull' => true);
	...
	if(empty($r_sort)) $r_sort = 'namabank';
