<?php
	...
	$a_kolom[] = array('kolom' => 'namapendidikan', 'label' => 'Pendidikan','align' => 'center');
	$a_kolom[] = array('kolom' => 'masakerja', 'label' => 'Masa Kerja Pend.','align' => 'center','filter' => "substring(g.masakerjapend,1,2)||' tahun '");
	$a_kolom[] = array('kolom' => 'totjam', 'label' => 'Total Jam','align' => 'center');
	$a_kolom[] = array('kolom' => 'tothonor', 'label' => 'Honor','type' => 'N','align' => 'right');
	
	// properti halaman
	$p_title = 'Daftar Honor Dosen';
	$p_tbwidth = 1000;
	...
	$sql = $p_model::listQueryHonor($r_periode);
	...
	if($r_act == 'hitung' and $c_insert) {		
		...
		list($p_posterr,$p_postmsg) = $p_model::hitHonor($conn,$r_periode,$a_sql);
			...
			<form name="pageform" id="pageform" method="post">
				...
				<table width="<?= $p_tbwidth ?>" cellpadding="4" cellspacing="0" class="GridStyle" align="center">
					...
					<tr valign="top" class="<?= $rowstyle ?>">
						...
						<?	} ?>
						<td align="center">
							<img id="<?= $t_key.'::list_gagajipokok' ?>" title="Tampilkan Slip Gaji" src="images/edit.png" onclick="goDetail(this)" style="cursor:pointer">
						</td>
					</tr>
					<?	}
						if($i == 0) {
