<?php
	...
	$p_model = mGaji;
	$p_dbtable = 'ms_potonganhadir';
	$p_key = 'kodepotonganhadir';
	
	// struktur view
	$a_kolom = array();
	$a_kolom[] = array('kolom' => 'kodepotonganhadir', 'label' => 'Kode', 'size' => 3, 'maxlength' => 3, 'align' => 'center', 'notnull' => true, 'readonly' => true);
	...
	// properti halaman
	$p_title = 'Daftar Potongan Kehadiran';
	$p_tbwidth = 700;
	...
	if(empty($r_sort)) $r_sort = 'kodepotonganhadir';
