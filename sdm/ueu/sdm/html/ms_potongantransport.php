<?php
	...
	$p_model = mGaji;
	$p_dbtable = 'ms_potongantransport';
	$p_key = 'kodepotongantransport';
	
	// struktur view
	$a_kolom = array();
	$a_kolom[] = array('kolom' => 'kodepotongantransport', 'label' => 'Kode', 'size' => 3, 'maxlength' => 3, 'align' => 'center', 'notnull' => true, 'readonly' => true);
	$a_kolom[] = array('kolom' => 'kodeabsensi', 'label' => 'Jenis Absensi', 'type' => 'S', 'option' => $p_model::aKodeabsensiPot($conn));
	$a_kolom[] = array('kolom' => 'rangebawah', 'label' => 'Range Bawah (Jam)', 'size' => 10, 'maxlength' => 30, 'align' => 'center', 'notnull' => true);
	$a_kolom[] = array('kolom' => 'rangeatas', 'label' => 'Range Atas (Jam)', 'size' => 10, 'maxlength' => 30, 'align' => 'center');
	$a_kolom[] = array('kolom' => 'prosentase', 'label' => 'Prosentase Potongan (%)', 'size' => 10, 'maxlength' => 30, 'type' => 'N', 'align' => 'center');
	
	// properti halaman
	$p_title = 'Daftar Potongan Transport';
	$p_tbwidth = 700;
	...
	if(empty($r_sort)) $r_sort = 'kodepotongantransport';
			...
			<form name="pageform" id="pageform" method="post">
				...
				<table width="<?= $p_tbwidth ?>" cellpadding="4" cellspacing="0" class="GridStyle" align="center">
					...
					<tr valign="top" class="AlternateBG2">
						...
						?>					
						<td<?= $t_align ?>><?= $rowcc['input'] ?>
							<?= ($a_kolom[$j]['kolom']== 'rangebawah' or $a_kolom[$j]['kolom']== 'rangeatas') ? '<i> &nbsp;jam</i>' : ''?>
						</td>
						<?		} ?>
						<td align="center">
