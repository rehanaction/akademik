<?php
	...
	$p_tbwidth = 1000;
	$p_col = 11;
	$p_file = 'riwayatorganisasi_'.$r_kodeunit;
	$p_model = 'mPengembangan';
	$p_window = 'Daftar Riwayat Organisasi';
    ...
    $a_data = $p_model::repRiwayatOrganisasi($conn,$r_kodeunit,$r_tglmulai,$r_tglselesai);
	
	$rs = $a_data['list'];
	
	$p_title = 'Daftar Riwayat Organisasi <br />
...
<div align="center">
		...
		<table width="<?= $p_tbwidth ?>" border="1" cellpadding="4" cellspacing="0">
			<tr bgcolor = "gray">
				...
				<th><b style = "color:#FFFFFF">Nama Organisasi</b></th>
				<th><b style = "color:#FFFFFF">Lokasi Organisasi</b></th>
