<?php
	...
	// properti halaman
	$p_title = 'Daftar Pengabdian Masyarakat Homebase';
	$p_tbwidth = 750;
	$p_aktivitas = 'LAPORAN';
	...
	$a_input[] = array('label' => 'Jenis PKM', 'input' => UI::createSelect('jenis',$p_model::jenisPKM($conn),'','ControlStyle',true,'',true,'-- Semua Jenis --'));
