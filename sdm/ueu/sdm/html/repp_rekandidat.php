<?php
	...
	// properti halaman
	$p_title = 'Rekapitulasi Pelamar Universitas Esa Unggul';
	$p_tbwidth = 600;
	$p_aktivitas = 'LAPORAN';
	
	$p_model = 'mRekrutmen';
	$p_reportpage = 'rep_rekandidat';
		
	$a_input = array();
	$a_input[] = array('kolom' => 'unit', 'label' => 'Unit', 'input' => uCombo::unit($conn,$r_kodeunit,'unit','',false));
	
	$a_inputman = array();
	$a_inputman[] = array('kolom' => 'tglmulai', 'label' => 'Tgl. Rekrutmen', 'type' => 'D', 'notnull' => true);
		...
		<div class="SideItem" id="SideItem">
			<form name="pageform" id="pageform" method="post">
				...
				<center>
					...
					<?	} ?>
						<tr>
							<td class="LeftColumnBG">Tgl. Rekrutmen</td>
