<?php
	...
	$p_tbwidth = 1100;
	$p_col = 11;
	$p_file = 'riwayatpenelitian_'.$r_kodeunit;
	$p_model = 'mPengembangan';
	$p_window = 'Daftar Riwayat Penelitian';
    ...
    $a_data = $p_model::repRiwayatPenelitian($conn,$r_kodeunit,$r_tglmulai,$r_tglselesai,$r_output);
