<?php
	...
	$a_kolom[] = array('kolom' => 'isliburbersama', 'label' => 'Libur Bersama', 'type' => 'C', 'option' => array('Y' => ''), 'align' => 'center', 'add' => 'title="Centang untuk menetapkan hari libur bersama"');
	...
	$l_tahun = UI::createSelect('tahun',$a_tahunlibur,$r_tahun,'ControlStyle',true,'onchange="goSubmit()"');
