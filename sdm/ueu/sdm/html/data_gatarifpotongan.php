<? 
	...
	$a_input[] = array('kolom' => 'kodepotongan', 'label' => 'Jenis Potongan', 'type' => 'S', 'option' => $p_model::getCPotParam($conn));
	$a_input[] = array('kolom' => 'variabel1', 'label' => 'Hubungan Kerja', 'type' => 'S', 'option' => $p_model::getCHubKerja($conn));
	$a_input[] = array('kolom' => 'nominal', 'label' => 'Tarif Potongan', 'maxlength' => 12, 'size' => 15, 'notnull' => true, 'type' => 'N');
	...
	$sql = $p_model::getDataTarifPotongan($r_key);
						...
						<form name="pageform" id="pageform" method="post">
							...
							<table width="100%" cellspacing="0" cellpadding="4" class="bottomline">
								<tbody>
									...
									<tr>
										<td class="LeftColumnBG" width="150" style="white-space:nowrap"><?= Page::getDataLabel($row,'kodepotongan') ?></td>
										<td class="RightColumnBG"><?= Page::getDataInput($row,'kodepotongan') ?></td>
									</tr>
									<tr>
										<td class="LeftColumnBG"><?= Page::getDataLabel($row,'variabel1') ?></td>
										<td class="RightColumnBG"><?= Page::getDataInput($row,'variabel1') ?></td>
									</tr>
									<tr>
