			...
			<form name="pageform" id="pageform" method="post">
				...
				<center>
					...
					<table width="<?= $p_tbwidth-22 ?>" cellpadding="4" cellspacing="2" align="center">
						<tr>
							<td class="LeftColumnBG" style="white-space:nowrap" width="150px">Periode Semester</td>
							<td class="RightColumnBG"><?= $row['tahun'].' '.$a_semester[$row['semester']] ?></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="RightColumnBG"><?= $row['waktumulai'].' - '.$row['waktuselesai'] ?></td>
						</tr>
					</table>
					</div>
				</center>
