<?php
	...
	$r_output = CStr::removeSpecial($_REQUEST['output']);
	...
	$p_tbwidth = 1100;
	$p_col = 11;
	$p_file = 'riwayatpenelitianhomebase_'.$r_kodeunit;
	$p_model = 'mPengembangan';
	$p_window = 'Daftar Riwayat Penelitian Homebase';
    ...
    $a_data = $p_model::repRiwayatPenelitianHB($conn,$r_kodeunit,$r_tglmulai,$r_tglselesai,$r_output);
	$lingkup = $p_model::lingkup();
	$a_tim = $p_model::listTimPenelitianAll($conn);
	$kont = $p_model::kontributor();
	
	$rs = $a_data['list'];
	
	$p_title = 'Daftar Riwayat Penelitian <br />
...
<div align="center">
		...
		<table width="<?= $p_tbwidth ?>" border="1" cellpadding="4" cellspacing="0">
			<tr bgcolor = "gray">
				...
				<th><b style = "color:#FFFFFF">Judul Penelitian</b></th>
				<th><b style = "color:#FFFFFF">Output Penelitian</b></th>
				<th><b style = "color:#FFFFFF">Tim Penelitian</b></th>
			...
			<tr>
				...
				<td><?= $lingkup[$row['lingkuppenelitian']]; ?></td>
