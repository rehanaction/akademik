<?php
	...
	// struktur view
	$a_kolom = array();
	$a_kolom[] = array('kolom' => 'idstatusaktif', 'label' => 'Kode Status Aktif', 'size' => 2, 'maxlength' => 2, 'align' => 'center', 'notnull' => true);
	$a_kolom[] = array('kolom' => 'namastatusaktif', 'label' => 'Nama Status Aktif','size' => 30, 'maxlength' => 255, 'notnull' => true);
	$a_kolom[] = array('kolom' => 'iskeluar', 'label' => 'Status Keluar', 'type' => 'S', 'option' => $p_model::statusKeluar());
	$a_kolom[] = array('kolom' => 'isdigaji', 'label' => 'Digaji?', 'type' => 'S', 'option' => mCombo::iyaTidak());
	
	// properti halaman
	$p_title = 'Daftar Status Aktif';
	$p_tbwidth = 600;
	$p_aktivitas = 'BIODATA';
	$p_dbtable = 'lv_statusaktif';
	$p_key = 'idstatusaktif';
	...
	if(empty($r_sort)) $r_sort = 'namastatusaktif';
