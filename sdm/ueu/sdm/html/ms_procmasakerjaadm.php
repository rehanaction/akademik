<?php
	...
	// struktur view
	$a_kolom = array();
	$a_kolom[] = array('kolom' => 'masakerja', 'label' => 'Masa Kerja (Thn)', 'size' => 3, 'maxlength' => 3, 'align' => 'center', 'type' => 'N');
	$a_kolom[] = array('kolom' => 'prosentase', 'label' => 'Prosentase (%)','size' => 5, 'maxlength' => 5, 'align' => 'center', 'notnull' => true);
	
	// properti halaman
	$p_title = 'Daftar Prosentase Masa Kerja Admin';
	$p_tbwidth = 400;
	$p_aktivitas = 'ANGGARAN';
	$p_dbtable = 'ms_procmasakerjaadm';
	$p_key = 'masakerja,periodetarif';
	...
	$sql = $p_model::listQueryProcMasaKerjaAdm();
