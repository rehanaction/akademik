<?php
	...
	$a_kolom[] = array('kolom' => 'tmtmulai', 'label' => 'Tgl. Berlaku', 'type' => 'D','width'=>'100px');
	...
	$a_kolom[] = array('kolom' => 'nominal', 'label' => 'Tarif Tunjangan');
	
	// properti halaman
	$p_title = 'Daftar Tunjangan Lain';
	$p_tbwidth = 850;
