<?php
	...
	$p_tbwidth = 1100;
	$p_col = 11;
	$p_file = 'riwayatpkm_'.$r_kodeunit;
	$p_model = 'mPengembangan';
	$p_window = 'Daftar Riwayat Pengabdian Masyarakat';
    ...
    $a_data = $p_model::repRiwayatPKM($conn,$r_kodeunit,$r_tglmulai,$r_tglselesai,$r_jenis);
