<?php
	...
	$p_tbwidth = 1000;
	$p_col = 8;
	$p_file = 'rekapstshomebase_'.$r_unit;
	$p_model = 'mStatistik';
    ...
    $a_laporan = $p_model::getSLapHomebase($conn,$r_unit,$sqljenis,$sqlaktif,$sqlaktifhb);
	...
	$p_title = 'Rekapitulasi Statistik Homebase<br />Unit '.$namaunit;
?>
<html>
<head>
