<?php
	...
	// struktur view
	$a_kolom = array();
	$a_kolom[] = array('kolom' => 'nik', 'label' => 'N P P');
	...
	$a_kolom[] = array('kolom' => 'tglkontrak', 'label' => 'Tgl. Kontrak');
	$a_kolom[] = array('kolom' => 'tglberakhir', 'label' => 'Tgl. Berakhir');
	
	// properti halaman
	$p_title = 'Notifikasi Pegawai Kontrak';
	$p_tbwidth = 900;
	$p_aktivitas = 'BIODATA';
	...
	<div id="wrapper">
		<div class="SideItem" id="SideItem">
			<form name="pageform" id="pageform" method="post">
				...
				<input type="hidden" name="link" id="link" value="<?= $tipepeg == 'K' ? 4 : 6?>">
			</form>
		</div>
	</div>
</div>
