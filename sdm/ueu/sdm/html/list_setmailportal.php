<?php
	...
	// properti halaman
	$p_title = 'Setting Email Portal Rekrutmen';
	$p_tbwidth = 900;
	$p_aktivitas = 'NEWS';
	$p_detailpage = Route::getDetailPage();
	$p_dbtable = "re_settingemail";
	$p_key = "jenisemail";
	...
	$a_kolom[] = array('kolom' => 'jenisemail', 'label' => 'Jenis Email', 'align' => 'center', 'width' => '250px');
	$a_kolom[] = array('kolom' => 'judulemail', 'label' => 'Subyek/ Judul');
	$a_kolom[] = array('kolom' => 'isiemail', 'label' => 'Isi Email');
	...
	if (empty($r_sort)) $r_sort = 'jenisemail';
	$a_filter = Page::setFilter($_POST['filter']);
	$a_datafilter = Page::getFilter($a_kolom);
	
	$sql = $p_model::listSettingEmail();
	...
	$a_jenisemail = $p_model::getJenisEmail();
?>
<html>
<head>
	<title><?= $p_title ?></title>
