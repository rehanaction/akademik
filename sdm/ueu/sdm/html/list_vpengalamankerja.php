<?php
	...
	// properti halaman
	$p_title = 'Daftar Riwayat Pengalaman Kerja';
	$p_tbwidth = 950;
	$p_aktivitas = 'DAFTAR';
	$p_key = 'nourutpk';
	...
	$a_kolom[] = array('kolom' => 'namainstansi', 'label' => 'Nama Instansi');
	...
	$sql = $p_model::listQueryValidasiPengKerja();
				...
				<table width="<?= $p_tbwidth ?>" cellpadding="4" cellspacing="0" class="GridStyle" align="center">
					...
					<tr valign="top" class="<?= $rowstyle ?>">
						...
						<?	}
							if($c_edit) { ?>
						<td align="center">
							<img id="<?= $row['idpegawai'].'::'.$isdosen[$row['idpegawai']] ?>" title="Tampilkan Detail" src="images/edit.png" onclick="goDetailData(this)" style="cursor:pointer">
...
function goDetailData(elem) {
	...
	document.getElementById("key").value = id[0];
	
	if(id[1])
		document.getElementById("link").value = '2';
	else
