<?php
	...
	// properti halaman
	$p_title = 'Daftar Bidang III (Pengabdian Masyarakat)';
	$p_tbwidth = 800;
	$p_aktivitas = 'HISTORY';
	...
	if($r_act == 'delete' and $c_delete) {
		...
		$where = 'idpegawai,nobidangiii';
		
		list($p_posterr,$p_postmsg) = $p_model::delete($conn,$a_key,$p_dbtable,$where,'','filebidangtiga');
	}
	...
	$sql = $p_model::listQueryBidang3($r_key);
