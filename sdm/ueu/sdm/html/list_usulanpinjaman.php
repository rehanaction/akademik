<?php
	...
	$a_kolom[] = array('kolom' => 'namalengkap', 'label' => 'Nama Pegawai','filter'=>"sdm.f_namalengkap(m.gelardepan,m.namadepan,m.namatengah,m.namabelakang,m.gelarbelakang)+' - '+u.namaunit");
	$a_kolom[] = array('kolom' => 'jmldisetujui', 'label' => 'Pinjaman Pokok', 'type' => 'N');
	$a_kolom[] = array('kolom' => 'biayaadministrasi', 'label' => 'Biaya Administrasi', 'type' => 'N');
	$a_kolom[] = array('kolom' => 'totalpinjaman', 'label' => 'Jumlah Pinjaman', 'type' => 'N');
	
	// properti halaman
	$p_title = 'Daftar Perjanjian Pinjaman';
	$p_tbwidth = 1000;
