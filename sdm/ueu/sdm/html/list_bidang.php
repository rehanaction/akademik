<?php
	...
	// properti halaman
	$p_title = 'Daftar Rumpun Bidang Dosen';
	$p_tbwidth = 900;
	...
	// struktur view
	$a_kolom = array();
	$a_kolom[] = array('kolom' => 'kodebidang', 'label' => 'Kode', 'align' => 'center', 'filter' => 'm.kodebidang');
	$a_kolom[] = array('kolom' => 'namabidang', 'label' => 'Nama Bidang', 'filter' => 'm.namabidang');
	$a_kolom[] = array('kolom' => 'parent', 'label' => 'Parent Bidang', 'filter' => 'mp.namabidang');
	...
	if(empty($r_sort)) $r_sort = 'kodeurutan';
	$a_filter = Page::setFilter($_POST['filter']);
	$a_datafilter = Page::getFilter($a_kolom);
		
	$sql = $p_model::listBidang();
				...
				<table width="<?= $p_tbwidth ?>" cellpadding="4" cellspacing="0" class="GridStyle" align="center">
					...
					<tr valign="top" class="<?= $rowstyle ?>">
						...
						<?		if($c_insert and $row['level'] < 5) { ?>
							<img id="<?= $t_key ?>" title="Tambah Sub Bidang" src="images/child.png" onclick="goChild(this)" style="cursor:pointer">
						<?		}
								if($c_edit) { ?>
