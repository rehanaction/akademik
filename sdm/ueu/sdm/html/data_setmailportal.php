<?php
	...
	// properti halaman
	$p_title = 'Data Setting Email Portal Rekrutmen';
	$p_tbwidth = 600;
	$p_aktivitas = 'NEWS';
	...
	//struktur view
	$a_input = array();
	$a_input[] = array('kolom' => 'jenisemail', 'label' => 'Jenis Email', 'type' => 'S', 'option' => $p_model::getJenisEmail(), 'notnull' => true);
	$a_input[] = array('kolom' => 'judulemail', 'label' => 'Subyek/ Judul', 'maxlength' => 100, 'size' => 50, 'notnull' => true);
	$a_input[] = array('kolom' => 'isiemail', 'label' => 'Isi Email', 'type' => 'M');
