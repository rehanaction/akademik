<?php
	...
	$p_tbwidth = 1000;
	$p_col = 11;
	$p_file = 'riwayatpengalamankerja_'.$r_kodeunit;
	$p_model = 'mPekerjaan';
	$p_window = 'Daftar Riwayat Pengalaman Kerja';
    ...
    $a_data = $p_model::repRiwayatPengalamanKerja($conn,$r_kodeunit,$r_tglmulai,$r_tglselesai);
	
	$rs = $a_data['list'];
	
	$p_title = 'Daftar Riwayat Pengalaman Kerja <br />
...
<div align="center">
		...
		<table width="<?= $p_tbwidth ?>" border="1" cellpadding="4" cellspacing="0">
			<tr bgcolor = "gray">
				...
				<th><b style = "color:#FFFFFF">Nama Instansi</b></th>
				<th><b style = "color:#FFFFFF">Lokasi Instansi</b></th>
				<th><b style = "color:#FFFFFF">Jabatan</b></th>
