<?php
	...
	$a_kolom[] = array('kolom' => 'kategorinilai', 'label' => 'Nilai Huruf');
	...
	$a_filtercombo[] = array('label' => 'Periode', 'combo' => (($c_edit) ? UI::createSelect('periode',mPa::getCPeriode($conn), $r_periode, 'ControlStyle',$c_edit,'onChange="goSubmit()"') : '<input type="hidden" name="periode" value="'.$r_periode.'" />'));
?>
<html>
<head>
	<title><?= $p_title ?></title>
