<?php
	...
	$p_tbwidth = 1000;
	$p_col = 10;
	$p_file = 'riwayatpendidikan_'.$r_kodeunit;
	$p_model = 'mRiwayat';
	$p_window = 'Daftar Riwayat Pendidikan Pegawai';
    ...
    $a_data = $p_model::repRiwayatPendidikan($conn,$r_kodeunit,$r_tglmulai,$r_tglselesai);
	
	$rs = $a_data['list'];
	
	$p_title = 'Daftar Riwayat Pendidikan <br />
...
<div align="center">
		...
		<table width="<?= $p_tbwidth ?>" border="1" cellpadding="4" cellspacing="0">
			<tr bgcolor = "gray">
				...
				<th><b style = "color:#FFFFFF">No Ijazah</b></th>
				<th><b style = "color:#FFFFFF">Tgl Ijazah</b></th>
			</tr>
