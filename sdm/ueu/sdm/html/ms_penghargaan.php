<?php
	...
	$p_dbtable = 'lv_penghargaan';
	$p_key = 'idpenghargaan';
	
	// struktur view
	$a_kolom = array();
	
	$a_kolom[] = array('kolom' => 'idpenghargaan', 'label' => 'Kode Penghargaan', 'size' => 3, 'maxlength' => 3, 'align' => 'center', 'notnull' => true);
	$a_kolom[] = array('kolom' => 'namapenghargaan', 'label' => 'Nama Penghargaan', 'size' => 40, 'maxlength' => 255, 'notnull' => true);
	
	// properti halaman
	$p_title = 'Daftar Jenis Peghargaan';
	$p_tbwidth = 500;
	$p_aktivitas = 'BIODATA';
	...
	if(empty($r_sort)) $r_sort = 'idpenghargaan';
