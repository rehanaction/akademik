<?php
	...
	$p_tbwidth = 1000;
	$p_col = 11;
	$p_file = 'riwayathubungankerja_'.$r_kodeunit;
	$p_model = 'mRiwayat';
	$p_window = 'Daftar Riwayat Hubungan Kerja';
    ...
    $a_data = $p_model::repRiwayatHubunganKerja($conn,$r_kodeunit,$r_tglmulai,$r_tglselesai);
	
	$rs = $a_data['list'];
	
	$p_title = 'Daftar Riwayat Hubungan Kerja <br />
...
<div align="center">
		...
		<table width="<?= $p_tbwidth ?>" border="1" cellpadding="4" cellspacing="0">
			<tr bgcolor = "gray">
				...
				<th><b style = "color:#FFFFFF">No Kontrak</b></th>
				<th><b style = "color:#FFFFFF">Tgl Kontrak</b></th>
				<th><b style = "color:#FFFFFF">Tgl Efektif</b></th>			
				<th><b style = "color:#FFFFFF">Tgl Berakhir</b></th>
			...
			<tr>
				...
				<td><?= $row['masakerja']; ?></td>
				<td><?= $row['nokontrak']; ?></td>
				<td align="center"><?= CStr::formatDateInd($row['tglkontrak']); ?></td>
				<td align="center"><?= CStr::formatDateInd($row['tglefektif']); ?></td>				
				<td align="center"><?= CStr::formatDateInd($row['tglberakhir']); ?></td>
