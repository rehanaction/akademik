<?php
	...
	$p_tbwidth = 1200;
	$p_col = 13;
	$p_file = 'laporankehadiranperkaryawantemp'.(!empty($r_kodeunit) ? '_'.$r_kodeunit : '');
	$p_model = 'mPresensi';
	$p_window = 'Laporan Kehadiran Per Karyawan Finger Print';
    ...
    $a_data = $p_model::getLapPresensiTemp($conn,$r_kodeunit,$r_tahun,$r_bulan,$r_idpegawai);
	...
	$p_title = 'Laporan Kehadiran Karyawan Finger Print<br />';
