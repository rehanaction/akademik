<?php
	...
	$a_kolom[] = array('kolom' => 'r.kodeunit', 'label' => 'Unit'); 
	$a_kolom[] = array('kolom' => 'kodepangkat', 'label' => 'Pangkat'); 
	$a_kolom[] = array('kolom' => 'jabatanfungsional', 'label' => 'Fungsional');
	$a_kolom[] = array('kolom' => 'jabatanstruktural', 'label' => 'Struktural');
	$a_kolom[] = array('kolom' => 'isdosen', 'label' => 'Status Dosen'); 
	// $a_kolom[] = array('label' =>'Contact');
	$a_kolom[] = array('kolom' => 'statuspeg', 'label' => 'Status');
