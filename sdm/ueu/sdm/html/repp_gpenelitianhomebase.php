<?php
	...
	// properti halaman
	$p_title = 'Daftar Penelitian Homebase Pegawai';
	$p_tbwidth = 850;
	$p_aktivitas = 'LAPORAN';
	...
	$a_input = array();
	$a_input[] = array('label' => 'Unit Homebase', 'input' => uCombo::unit($conn,$r_kodeunit,'unit','',false,true));
	$a_input[] = array('label' => 'Output Penelitian', 'input' => UI::createSelect('output',$p_model::OutputPenelitian($conn),'','ControlStyle',true,'',true,'-- Semua Jenis --'));
	
	$a_inputman = array();
	$a_inputman[] = array('kolom' => 'tglmulai', 'label' => 'Tgl. Proses', 'type' => 'D');
	$a_inputman[] = array('kolom' => 'tglselesai', 'label' => 'Tgl. Selesai', 'type' => 'D');
