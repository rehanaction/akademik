<?php
	...
	$p_dbtable = 'lv_jenispkm';
	$p_key = 'kodepkm';
	
	// struktur view
	$a_kolom = array();
	$a_kolom[] = array('kolom' => 'kodepkm', 'label' => 'Kode PKM', 'size' => 5, 'maxlength' => 15, 'align' => 'center', 'notnull' => true);
	$a_kolom[] = array('kolom' => 'namapkm', 'label' => 'Nama PKM', 'size' => 40, 'maxlength' => 100, 'notnull' => true);
	...
	// properti halaman
	$p_title = 'Daftar Jenis Pengabdian Kepada Masyarakat';
	$p_tbwidth = 800;
	$p_aktivitas = 'BIODATA';
	...
	if(empty($r_sort)) $r_sort = 'namapkm';
	
	$sql = $p_model::listQueryJenisPKM();
			...
			<form name="pageform" id="pageform" method="post">
				...
				<table width="<?= $p_tbwidth ?>" cellpadding="4" cellspacing="0" class="GridStyle" align="center">
					...
					<tr valign="top" class="AlternateBG2">
						...
						?>
						<td align="center"><?= Page::getDataInputInc($rowc,'u_kodepkm') ?></td>
						<td><?= Page::getDataInputInc($rowc,'u_namapkm') ?></td>
						<td>
					...
					<tr valign="top" class="LeftColumnBG NoHover">
						...
						?>
						<td align="center"><?= Page::getDataInputInc($rowc,'i_kodepkm') ?></td>
						<td><?= Page::getDataInputInc($rowc,'i_namapkm') ?></td>
						<td>
...
function showIndeks(id,nama){
	win = window.open("<?= Route::navAddress('pop_penilaian').'&m=2&b=III&id='?>"+id+"&nama="+nama,"popup_penilaian","width=650,height=500,scrollbars=1");
	win.focus();
}
</script>
</body>
