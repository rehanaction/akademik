<?php
	...
	$a_kolom[] = array('kolom' => 'jeniskul', 'label' => 'Jenis Pertemuan');
	$a_kolom[] = array('kolom' => 'waktumengajar', 'label' => 'Waktu Mengajar', 'align' => 'center','width'=>'90px');
	$a_kolom[] = array('kolom' => 'jmljam', 'label' => 'Jumlah Jam', 'align' => 'center');
			...
			<form name="pageform" id="pageform" method="post">
				...
				<table width="<?= $p_tbwidth ?>" cellpadding="4" cellspacing="0" class="GridStyle" align="center">
					...
					<tr valign="top" class="<?= $rowstyle ?>">
						...
						if($a_kolom[$j]['kolom']=='waktumengajar'){
						?>
						<td<?= $t_align ?>><?= CStr::formatJam($row['waktumulai']).' - '. CStr::formatJam($row['waktuselesai'])?></td>
						<?}else{?>
						<td<?= $t_align ?>><?= $rowcc ?></td>
						<?}	} ?>
						<td align="center">
