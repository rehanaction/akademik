<?php
	...
	// properti halaman
	$p_title = 'Daftar Riwayat Pangkat Pegawai';
	$p_tbwidth = 600;
	$p_aktivitas = 'LAPORAN';
	...
	$a_input[] = array('label' => 'Jenis SK', 'input' => UI::createSelect('jenissk',$p_model::jenisSK($conn),$r_jenissk,'ControlStyle',true,'',true,'-- Semua Jenis --'));
