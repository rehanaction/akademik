<?php
	...
	// struktur view
	$a_kolom = array();
	$a_kolom[] = array('kolom' => 'periodegaji', 'label' => 'Periode', 'align' => 'center');
	$a_kolom[] = array('kolom' => 'namaperiode', 'label' => 'Nama Periode');
	
	// properti halaman
	$p_title = 'Daftar Periode Penggajian';
	$p_tbwidth = 1100;
	...
	$sql = $p_model::listQueryPeriodeGA();					
			...
			<form name="pageform" id="pageform" method="post">
				...
				<table width="<?= $p_tbwidth ?>" cellpadding="4" cellspacing="0" class="GridStyle" align="center">
					...
					<tr>
						...
						<?	} ?>
						<th colspan="2">Periode Hitung Gaji</th>
						<th colspan="2">Periode Hitung Lembur</th>
						<th colspan="2">Periode Hitung Potongan</th>
						<th colspan="2">Periode Hitung Honorer</th>
					...
					<tr valign="top" class="<?= $rowstyle ?>">
						...
						<td align="center"><?= CStr::formatDateInd($row['tglakhirpotongan'],false); ?></td>
						<td align="center"><?= CStr::formatDateInd($row['tglawalhonorer'],false); ?></td>
						<td align="center"><?= CStr::formatDateInd($row['tglakhirhonorer'],false); ?></td>
						<td align="center">
