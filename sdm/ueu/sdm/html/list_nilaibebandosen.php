<?php
	...
	$a_kolom[] = array('kolom' => 'namapegawai', 'label' => 'Nama', 'filter' => 'p.nik||' - '||sdm.f_namalengkap(p.gelardepan,p.namatengah,p.namadepan,p.namabelakang,p.gelarbelakang)');
	...
	// properti halaman
	$p_title = 'Daftar Penilaian Beban Dosen';
	$p_tbwidth = 900;
	$p_aktivitas = 'NILAI';
	...
	$sql = $p_model::listNilaiBebanDosen();	
			...
			<form name="pageform" id="pageform" method="post">
				...
				<table width="<?= $p_tbwidth ?>" cellpadding="4" cellspacing="0" class="GridStyle" align="center">
					...
					<tr valign="top" class="<?= $rowstyle ?>">
						...
						<td<?= $t_align ?>><?= $rowcc ?></td>
						<?	} ?>
						<td align="center"><?= $row['isfinalreal']?></td>
						<td align="center">
						<?	if($c_edit) { ?>
