<?php
	...
	$a_filtercombo[] = array('label' => 'Periode', 'combo' => UI::createSelect('periode',mPa::getCPeriode($conn), $r_periode, 'ControlStyle',$c_edit,'onChange="goSubmit()"').'&nbsp;&nbsp;'.(($c_edit) ? '<input type="button" value="Generate Tim Penilai" class="ControlStyle" onClick="goSetTim()">' : ''));
?>
<html>
<head>
	<title><?= $p_title ?></title>
			...
			<form name="pageform" id="pageform" method="post">
				...
				<table width="<?= $p_tbwidth ?>" cellpadding="4" cellspacing="0" class="GridStyle" align="center">
					...
					<tr valign="top" class="<?= $rowstyle ?>">
						...
						<?		
								if($c_delete) { ?>
							<img id="<?= $row['kodeperiode'].'|'.$row['idpegawai']  ?>" title="Hapus Data" src="images/delete.png" onclick="goDelete(this)" style="cursor:pointer">
						<?		} ?>
						</td>
					</tr>
					<?	}}
