<?php
	...
	$r_potongan = CStr::removeSpecial($_REQUEST['potongan']);
	...
	$p_tbwidth = 1000;
	$p_file = 'tarifpotongan_'.$r_periode;
	$p_model = 'mGaji';
	$p_window = 'Daftar Tarif Potongan';
	$p_col = 8;
	...
	$a_laporan = $p_model::repLapTarifPotongan($conn,$r_periode,$r_potongan);
		...
		<table width="<?= $p_tbwidth ?>" border="1" cellpadding="4" cellspacing="0">
			<thead>
				<tr bgcolor = "gray">
					...
					<th style = "color:#FFFFFF">Hubungan Kerja</th>
