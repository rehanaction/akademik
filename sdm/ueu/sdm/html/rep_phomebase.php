<?php
	...
	$p_tbwidth = 900;
	$p_col = 7;
	$p_file = 'riwayathomebase_'.$r_kodeunit;
	$p_model = 'mPekerjaan';
	$p_window = 'Daftar Riwayat Homebase';
    ...
    $a_data = $p_model::repRiwayatHomebase($conn,$r_kodeunit,$r_tglmulai,$r_tglselesai);
	
	$rs = $a_data['list'];
	
	$p_title = 'Daftar Riwayat Homebase <br />
...
<div align="center">
		...
		<table width="<?= $p_tbwidth ?>" border="1" cellpadding="4" cellspacing="0">
			<tr bgcolor = "gray">
				...
				<th><b style = "color:#FFFFFF">Tipe Pegawai</b></th>
				<th><b style = "color:#FFFFFF">Unit Homebase</b></th>
				<th><b style = "color:#FFFFFF">TMT Homebase</b></th>
			</tr>
