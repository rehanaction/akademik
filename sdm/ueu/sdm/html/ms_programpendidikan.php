<?php
	...
	// struktur view
	$a_kolom = array();
	$a_kolom[] = array('kolom' => 'kodeprogram', 'label' => 'Kode', 'size' => 3, 'maxlength' => 3, 'align' => 'center', 'notnull' => true);
	$a_kolom[] = array('kolom' => 'namaprogram', 'label' => 'Nama Program Pendidikan', 'size' => 50, 'maxlength' => 100, 'notnull' => true);
	
	// properti halaman
	$p_title = 'Daftar Program Pendidikan';
	$p_tbwidth = 500;
	$p_aktivitas = 'DAFTAR';
	$p_dbtable = 'ms_programpend';
	$p_key = 'kodeprogram';
	...
	if(empty($r_sort)) $r_sort = 'kodeprogram';
