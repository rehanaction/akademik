<?php
	...
	// struktur view
	$a_kolom = array();
	$a_kolom[] = array('kolom' => 'kodepotongan', 'label' => 'Kode');
	$a_kolom[] = array('kolom' => 'namapotongan', 'label' => 'Potongan');
	
	// properti halaman
	$p_title = 'Daftar Jenis Potongan';
	$p_tbwidth = 500;
	...
	if (empty($r_sort)) $r_sort = 'kodepotongan';
	$a_filter = Page::setFilter($_POST['filter']);
	$a_datafilter = Page::getFilter($a_kolom);
	
	$sql = $p_model::listQueryPotongan();
			...
			<form name="pageform" id="pageform" method="post">
				...
				<table width="<?= $p_tbwidth ?>" cellpadding="4" cellspacing="0" class="GridStyle" align="center">
					...
					<tr valign="top" class="<?= $rowstyle ?>">
						...
						<td<?= $t_align ?>><?= $rowcc ?></td>
						<?	} ?>
						<td align="center"><?= $a_cara[$row['ismanual']]; ?></td>
