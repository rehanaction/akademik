<?php
	...
	$a_kolom[] = array('kolom' => 'prosentase', 'label' => 'Prosentase (%)','size' => 3, 'maxlength' => 3, 'align' => 'center', 'notnull' => true);
	
	// properti halaman
	$p_title = 'Daftar Prosentase Masa Kerja Non Admin';
	$p_tbwidth = 400;
	$p_aktivitas = 'ANGGARAN';
	$p_dbtable = 'ms_procmasakerja';
	...
	$sql = $p_model::listQueryProcMasaKerja();
