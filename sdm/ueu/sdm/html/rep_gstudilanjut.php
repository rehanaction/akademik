<?php
	...
	$r_jenisbiaya = CStr::removeSpecial($_REQUEST['jenisbiaya']);
	...
	$p_tbwidth = 1000;
	$p_col = 11;
	$p_file = 'riwayatstudilanjut_'.$r_kodeunit;
	$p_model = 'mPengembangan';
	$p_window = 'Daftar Riwayat Studi Lanjut';
    ...
    $a_data = $p_model::repRiwayatStudiLanjut($conn,$r_kodeunit,$r_tglmulai,$r_tglselesai,$r_jenisbiaya);
	
	$rs = $a_data['list'];
	
	$p_title = 'Daftar Riwayat Studi Lanjut <br />
...
<div align="center">
		...
		<table width="<?= $p_tbwidth ?>" border="1" cellpadding="4" cellspacing="0">
			<tr bgcolor = "gray">
				...
				<th><b style = "color:#FFFFFF">Jenjang Pendidikan</b></th>
				<th><b style = "color:#FFFFFF">Gelar</b></th>
				<th><b style = "color:#FFFFFF">Nama Institusi</b></th>
				<th><b style = "color:#FFFFFF">Tgl Mulai</b></th>			
				<th><b style = "color:#FFFFFF">Tgl Selesai</b></th>
				<th><b style = "color:#FFFFFF">Jenis Pembiayaan</b></th>
			</tr>
