<?php
	...
	// struktur view
	$a_kolom = array();
	$a_kolom[] = array('kolom' => 'tglberlaku', 'label' => 'Tgl. Berlaku', 'type' => 'D');
	$a_kolom[] = array('kolom' => 'minterlambat', 'label' => 'Toleransi Datang', 'type' => 'N');
	$a_kolom[] = array('kolom' => 'maxpulang', 'label' => 'Toleransi Pulang', 'type' => 'N');
	$a_kolom[] = array('kolom' => 'jmlharikerja', 'label' => 'Jml. Hari Kerja', 'type' => 'N');
	
	// properti halaman
	$p_title = 'Daftar Aturan Pemberlakuan Kehadiran';
	$p_tbwidth = 600;
	$p_aktivitas = 'TIME';
	...
	$sql = $p_model::listQuerySetKehadiran();
				...
				<table width="<?= $p_tbwidth ?>" cellpadding="4" cellspacing="0" class="GridStyle" align="center">
					...
					<?	/********/
						...
						foreach($a_data as $row) {
							...
							$t_key = $p_model::getKeyRow($row,'noketerlambatan');
					...
					<tr valign="top" class="<?= $rowstyle ?>">
						...
						<td align="center"><?= $rowc[$j++] ?> <em>Menit</em></td>
						<td align="center"><?= $rowc[$j++] ?> <em>Menit</em></td>
						<td align="center"><?= $rowc[$j++] ?> <em>Hari</em></td>
						<td align="center">
