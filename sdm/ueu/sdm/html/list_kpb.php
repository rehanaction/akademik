<?php
	...
	// variabel request
	$r_unit = Modul::setRequest($_POST['unit'],'UNITKPB');
	$r_month = Modul::setRequest($_POST['bulan'],'BULANKPB');
	$r_month = empty($r_month) ? (int)date('m') : $r_month;
	$r_tahun = Modul::setRequest($_POST['tahun'],'TAHUNKPB');
	...
	// properti halaman
	$p_title = 'Daftar Kenaikan Pangkat Berkala';
	$p_tbwidth = 1250;
	$p_aktivitas = 'DAFTAR';
	$p_key = 'nokpb';
	$p_dbtable = 'pe_kpb';
	...
	$a_kolom[] = array('kolom' => 'pangkatlama', 'label' => 'Pangkat Lama', 'align' => 'center', 'filter' => 'pl.golongan');
	$a_kolom[] = array('kolom' => 'tmtpangkatlama', 'label' => 'TMT Lama', 'type' => 'D', 'align' => 'center');
	...
	$a_kolom[] = array('kolom' => 'pangkatbaru', 'label' => 'Pangkat Baru', 'align' => 'center', 'filter' => 'pb.golongan');
	$a_kolom[] = array('kolom' => 'tmtpangkat', 'label' => 'TMT Baru', 'type' => 'D', 'align' => 'center');
