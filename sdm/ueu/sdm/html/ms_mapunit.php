<?php
	...
	// struktur view
	$a_kolom = array();
	$a_kolom[] = array('kolom' => 'idunit', 'label' => 'Unit SDM', 'type' => 'S', 'option' => mCombo::unitSave($conn,false), 'notnull' => true, 'add' => 'style="width:250px"');
	$a_kolom[] = array('kolom' => 'kodeunitsia', 'label' => 'Unit SIM Akademik', 'type' => 'S', 'option' => $p_model::getMapSIA($connsia), 'empty' => true, 'add' => 'style="width:250px"');
	$a_kolom[] = array('kolom' => 'kodeunitkeu', 'label' => 'Unit SIM Keuangan', 'type' => 'S', 'option' => $p_model::getMapKEU($connkeu), 'empty' => true, 'add' => 'style="width:250px"');
	
	// properti halaman
	$p_title = 'Daftar Mapping Unit Kerja';
	$p_tbwidth = 900;
	$p_aktivitas = 'UNIT';
				...
				<table width="<?= $p_tbwidth ?>" cellpadding="4" cellspacing="0" class="GridStyle" align="center">
					...
					<tr valign="top" class="<?= $rowstyle ?>">
						<?	foreach($rowc as $j => $rowcc) {
								...
								$pad = '';
								if($j==0)//utk padding
									$pad = 'style="padding-left:'.(($row['level']*5)+2).'px"';
						?>					
