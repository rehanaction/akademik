<?php
	...
	$p_tbwidth = 1000;
	$p_col = 10;
	$p_file = 'piagampegawai_'.$r_kodeunit;
	$p_model = 'mPenghargaan';
	$p_window = 'Daftar Piagam Pegawai';
    ...
    $a_data = $p_model::repPiagam($conn,$r_kodeunit,$r_tglmulai,$r_tglselesai);
	
	$rs = $a_data['list'];
	
	$p_title = 'Daftar Piagam Pegawai <br />
...
<div align="center">
		...
		<table width="<?= $p_tbwidth ?>" border="1" cellpadding="4" cellspacing="0">
			<tr bgcolor = "gray">
				...
				<th><b style = "color:#FFFFFF">Tgl. Piagam</b></th>
				<th><b style = "color:#FFFFFF">Nama Piagam</b></th>
				<th><b style = "color:#FFFFFF">Penyelenggara</b></th>
				<th><b style = "color:#FFFFFF">No. Piagam</b></th>
			...
			<tr>
				...
				<td><?= $row['namaunit']; ?></td>
				<td><?= $row['tipepeg']; ?></td>
				<td align="center"><?= CStr::formatDateInd($row['tglpiagam']); ?></td>	
				<td><?= $row['namapiagam']; ?></td>	
