<?php
	...
	// properti halaman
	$p_title = 'Rekapitulasi Hasil Penilaian Kinerja';
	$p_tbwidth = 600;
	$p_aktivitas = 'LAPORAN';
	...
	//$l_kategori = UI::createSelect('kategori',$p_model::getCKategori($conn),'','ControlStyle',true);
		
	$a_input = array();
	$a_input[] = array('label' => 'Unit', 'input' => uCombo::unitSave($conn,$r_kodeunit,'unit','',false));
	$a_input[] = array('label' => 'Periode', 'input' => $l_periode);
	//$a_input[] = array('label' => 'Kategori', 'input' => $l_kategori);
