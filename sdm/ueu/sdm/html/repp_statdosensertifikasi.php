<?php
	...
	// properti halaman
	$p_title = 'Laporan Statistik Dosen Sertifikasi';
	$p_tbwidth = 600;
	$p_aktivitas = 'LAPORAN';
	...
	$l_serdos = UI::createCheckBox('serdos[]',array('Y' => 'Serdos', 'T' => 'Non Serdos'),'',true,true,'checked');
		
	$a_input = array();
	$a_input[] = array('label' => 'Unit', 'input' => uCombo::unitSave($conn,$r_kodeunit,'unit','',false,true));
	$a_input[] = array('label' => 'Sertifikasi Dosen', 'input' => $l_serdos);
