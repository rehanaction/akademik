<?php
	...
	$r_jenis = Modul::setRequest($_POST['jenis'],'JENISRATE');
	if (empty($r_jenis))
		$r_jenis = 'DK';
		
	// struktur view
	$a_kolom = array();
	$a_kolom[] = array('kolom' => 'rateperjalanan', 'label' => 'Tipe Rate');
	$a_kolom[] = array('kolom' => 'namajabatan', 'label' => 'Jabatan Struktural');
	$a_kolom[] = array('kolom' => 'jnsrate', 'label' => 'Jenis');
	$a_kolom[] = array('kolom' => 'tarifrate', 'label' => 'Tarif', 'type' => 'N');
	
	// properti halaman
	$p_title = 'Daftar Tarif Rate Perjalanan Dinas';
	$p_tbwidth = 900;
	$p_aktivitas = 'UNIT';
	...
	$sql = $p_model::listQueryRate($r_key);
	...
	// membuat filter
	$a_filtercombo = array();
	$a_filtercombo[] = array('label' => 'Jenis Rate', 'combo' => UI::createSelect('jenis',$a_jenisrate,$r_jenis,'ControlStyle',true,'onchange="goSubmit()"'));
		...
		<div class="SideItem" id="SideItem">
				...
				<table width="<?= $p_tbwidth ?>" cellpadding="4" cellspacing="0" class="GridStyle" align="center">
					...
					<?	/********/
						...
						foreach($a_data as $row) {
							...
							$t_key = $p_model::getKeyRow($row,'idtarifrate');
			...
			<div class="filterTable" style="width:<?= $p_tbwidth-12 ?>px;">
				<table cellspacing="0" cellpadding="0" align="center" width="890">
					<tr>
						<td colspan="2"><strong>Keterangan Jenis Rate Perjalanan :</strong></td>
					</tr>
					<? foreach ($a_jenisrate as $kode => $label){?>
					<tr>
						<td width="20"><?= $kode; ?></td>
						<td>: <?= $label; ?></td>
					</tr>
