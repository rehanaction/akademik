<?php
	...
	// struktur view
	$a_kolom = array();
	$a_kolom[] = array('kolom' => 'idmilikpeg', 'label' => 'Kode', 'size' => 3, 'maxlength' => 3, 'align' => 'center', 'notnull' => true);
	$a_kolom[] = array('kolom' => 'milikpeg', 'label' => 'Nama','size' => 30, 'maxlength' => 100, 'notnull' => true);
	
	// properti halaman
	$p_title = 'Daftar Kepemilikan Pegawai';
	$p_tbwidth = 500;
	$p_aktivitas = 'BIODATA';
	$p_dbtable = 'ms_kepemilikanpegawai';
	$p_key = 'idmilikpeg';
	...
	if(empty($r_sort)) $r_sort = 'idmilikpeg';
