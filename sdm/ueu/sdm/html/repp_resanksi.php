<?php
	...
	$l_jenis = UI::createSelect('jenis[]',$p_model::jenisPelanggaran($conn),'','ControlStyle',true,'multiple size="8"');
		
	$a_input = array();
	$a_input[] = array('label' => 'Unit', 'input' => uCombo::unit($conn,$r_kodeunit,'unit','',false));
	$a_input[] = array('label' => 'Jenis Pelanggaran', 'input' => $l_jenis);
