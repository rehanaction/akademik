<?php
	...
	// properti halaman
	$p_title = 'Daftar Usul Penetapan Angka Kredit';
	$p_tbwidth = 900;
	$p_aktivitas = 'LAPORAN';
	...
	$a_kolom[] = array('kolom' => 'jenispegawai', 'label' => 'Jenis Pegawai','filter' => "t.tipepeg+' - '+j.jenispegawai");
