<?php
	...
	// struktur view
	$a_kolom = array();
	$a_kolom[] = array('kolom' => 'thnanggaran', 'label' => 'Tahun');
	$a_kolom[] = array('kolom' => 'namaunit', 'label' => 'Unit');
	$a_kolom[] = array('kolom' => 'anggaran', 'label' => 'Jumlah Anggaran', 'type' => 'N');
	$a_kolom[] = array('kolom' => 'anggaranterpakai', 'label' => 'Sisa Anggaran', 'type' => 'N');
	
	// properti halaman
	$p_title = 'Daftar Anggaran Tugas Kedinasan Unit';
	$p_tbwidth = 900;
	$p_aktivitas = 'UNIT';
				...
				<table width="<?= $p_tbwidth ?>" cellpadding="4" cellspacing="0" class="GridStyle" align="center">
					...
					<?	/********/
						...
						foreach($a_data as $row) {
							...
							$t_key = $p_model::getKeyRow($row,'thnanggaran');
					...
					<tr valign="top" class="<?= $rowstyle ?>">
						...
						<td align="right"><?= $rowc[$j++] ?></td>
						<td align="center">
							<img id="<?= $row['thnanggaran'].'|'.$row['idunit'] ?>" title="Tampilkan Detail" src="images/edit.png" onclick="goDetail(this)" style="cursor:pointer">
						<?		
								if($c_delete) { ?>
							<img id="<?= $row['thnanggaran'].'|'.$row['idunit'] ?>" title="Hapus Data" src="images/delete.png" onclick="goDelete(this)" style="cursor:pointer">
						<?		} ?>
						</td>
					</tr>
					<?	}}
