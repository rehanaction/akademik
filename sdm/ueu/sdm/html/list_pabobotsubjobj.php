<?php
	...
	// properti halaman
	$p_title = 'Daftar Bobot Penilaian Subjektif dan Objektif';
	$p_tbwidth = 800;
	$p_aktivitas = 'NILAI';
	...
	$a_kolom[] = array('kolom' => 'bobotsubjektif', 'label' => '% Subjektif', 'type' => 'N');
	$a_kolom[] = array('kolom' => 'bobotobjektif', 'label' => '% Objektif', 'type' => 'N');
	...
	$sql = $p_model::listQueryBobot($r_key);
