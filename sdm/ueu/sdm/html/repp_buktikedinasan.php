<?php
	...
	// properti halaman
	$p_title = 'Laporan Bukti Kedinasan';
	$p_tbwidth = 600;
	$p_aktivitas = 'LAPORAN';
	$r_month = (int)date('m');
	$r_tahun = date('Y');
	...
	$l_jenis = UI::createCheckBox('jenis[]',$p_model::jenisDinas($conn),'',true,true,'checked');
	...
	$a_input[] = array('label' => 'Jenis Dinas', 'input' => $l_jenis);
		...
		<div class="SideItem" id="SideItem">
			<form name="pageform" id="pageform" method="post">
				...
				<center>
					...
					<?	} ?>
						<tr>
							<td class="LeftColumnBG">Tgl. Dinas</td>
