<?php
	...
	// properti halaman
	$p_title = 'Daftar Riwayat Studi Lanjut';
	$p_tbwidth = 600;
	$p_aktivitas = 'LAPORAN';
	...
	$a_input[] = array('label' => 'Jenis Pembiayaan', 'input' => UI::createSelect('jenisbiaya',$p_model::jenisPembiayaan($conn),'','ControlStyle',true,'',true,'-- Semua Jenis --'));
