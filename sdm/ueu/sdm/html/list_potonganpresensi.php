<?php
	...
	$a_kolom[] = array('kolom' => 'jumlahjam', 'label' => 'Jumlah jam', 'type' => 'N', 'align' => 'center');
	$a_kolom[] = array('kolom' => 'potonganpresensi', 'label' => 'Tarif Potongan Presensi', 'type' => 'N', 'align' => 'right');
	
	// properti halaman
	$p_title = 'Daftar Tarif Potongan Presensi';
	$p_tbwidth = 600;
	...
	$sql = $p_model::listQueryPotonganPresensi();
			...
			<form name="pageform" id="pageform" method="post">
				...
				<table width="<?= $p_tbwidth ?>" cellpadding="4" cellspacing="0" class="GridStyle" align="center">
					...
					<tr valign="top" class="<?= $rowstyle ?>">
						...
						<?	} ?>
						<td align="center">
							<img id="<?= $row['real_tglmulai'] ?>" title="Tampilkan Detail" src="images/edit.png" onclick="goDetail(this)" style="cursor:pointer">
						<?		if($c_delete) { ?>
							<img id="<?= $row['real_tglmulai'] ?>" title="Hapus Data" src="images/delete.png" onclick="goDelete(this)" style="cursor:pointer">
						<?		} ?>
						</td>
					</tr>
					<?	}
