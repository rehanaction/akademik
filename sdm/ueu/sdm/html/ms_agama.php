<?php
	...
	// struktur view
	$a_kolom = array();
	$a_kolom[] = array('kolom' => 'idagama', 'label' => 'Kode Agama', 'size' => 2, 'maxlength' => 4, 'align' => 'center', 'notnull' => true);
	$a_kolom[] = array('kolom' => 'namaagama', 'label' => 'Nama Agama', 'size' => 30, 'maxlength' => 255, 'notnull' => true);
	$a_kolom[] = array('kolom' => 'urutan', 'label' => 'Urutan', 'size' => 2, 'maxlength' => 3, 'notnull' => true, 'align' => 'right');
	
	// properti halaman
	$p_title = 'Daftar Agama';
	$p_tbwidth = 500;
	$p_aktivitas = 'BIODATA';
	$p_dbtable = 'lv_agama';
	$p_key = 'idagama';
