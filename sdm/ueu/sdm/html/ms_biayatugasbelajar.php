<?php
	...
	// struktur view
	$a_kolom = array();
	$a_kolom[] = array('kolom' => 'idbiaya', 'label' => 'Kode', 'size' => 3, 'maxlength' => 3, 'align' => 'center', 'notnull' => true);
	$a_kolom[] = array('kolom' => 'namabiaya', 'label' => 'Nama Biaya','size' => 30, 'maxlength' => 100, 'notnull' => true);
	$a_kolom[] = array('kolom' => 'lamastudidalam', 'label' => 'Rumus Studi Di Dalam','size' => 15, 'maxlength' => 25);
	$a_kolom[] = array('kolom' => 'lamastudiluar', 'label' => 'Rumus Studi Di Luar','size' => 15, 'maxlength' => 25);
	
	// properti halaman
	$p_title = 'Daftar Biaya Tugas Belajar';
	$p_tbwidth = 600;
	$p_aktivitas = 'BIODATA';
	$p_dbtable = 'ms_biayatugasbelajar';
	$p_key = 'idbiaya';
	...
	if(empty($r_sort)) $r_sort = 'idbiaya';
			...
			<div class="filterTable" style="width:<?= $p_tbwidth-12 ?>px;">
				<table cellspacing="0" cellpadding="0" align="center" width="890">
					<tr>
						...
						<td>: Masa Ikatan Studi Belajar (Bulan)</td>
					</tr>
				</table>
			</div>
			</center>
