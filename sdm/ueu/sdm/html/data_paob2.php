<? 
	...
	$p_tbwidth = "500";
	$p_title = "Data Penilaian OB-2 (Kehadiran)";
	$p_aktivitas = 'NILAI';
	...
	$a_input = array();	
	$a_input[] = array('kolom' => 'namaperiode', 'label' => 'Nama Periode', 'maxlength' => 100, 'size' => 30, 'class' => 'ControlRead');
	$a_input[] = array('kolom' => 'namalengkap', 'label' => 'Pegawai', 'maxlength' => 100, 'size' => 30, 'class' => 'ControlRead');
	$a_input[] = array('kolom' => 'nilaiob2', 'label' => 'Nilai', 'maxlength' => 5, 'size' => 5, 'type' => 'N,2');
	$a_input[] = array('kolom' => 'kodeperiode', 'type' => 'H');
	...
	$sql = $p_model::getDataEditOB2($r_key);
					...
					<?	$a_required = array();
						foreach($row as $t_row) {
							if($t_row['notnull'])
								$a_required[] = $t_row['id'];
					?>
						<tr <?= $t_row['hidden'] == '1' ? 'style="display:none"' : '';?>>
