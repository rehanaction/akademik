<?php
	...
	// properti halaman
	$p_title = 'Data Bobot Penilaian Objektif';
	$p_tbwidth = 800;
	$p_aktivitas = 'NILAI';
	...
	$a_input[] = array('kolom' => 'ob1', 'label' => 'Kinerja Objektif (OB-1)', 'type' => 'N,2', 'maxlength' => 5, 'size' => 5, 'notnull' => true);
	$a_input[] = array('kolom' => 'ob2', 'label' => 'Kehadiran (OB-2)', 'type' => 'N,2', 'maxlength' => 5, 'size' => 5, 'notnull' => true);
