<?php
	...
	$a_kolom[] = array('kolom' => 'prosentase', 'label' => 'Prosentase (%)', 'align' => 'center');
	
	// properti halaman
	$p_title = 'Daftar Prosentase Jamsostek';
	$p_tbwidth = 500;
	$p_aktivitas = 'ANGGARAN';
	$p_detailpage = Route::getDetailPage();
	$p_dbtable = "ms_procjamsostek";
	$p_key = "noprocjamsostek";
	...
	if (empty($r_sort)) $r_sort = 'tglberlaku desc';
