<? 
	...
	$p_tbwidth = "680";
	$p_title = "Data Potongan Parameter";
	$p_aktivitas = 'ANGGARAN';
	$p_listpage = Route::getListPage();
	$p_dbtable = "ga_potonganparam";
	$p_key = "nopotongan";
	...
	$a_input = array();	
	$a_input[] = array('kolom' => 'kodepotongan', 'label' => 'Jenis Potongan', 'type' => 'S', 'option' => $p_model::getCPotParam($conn), 'notnull' => true);
	...
	if($r_act == 'save' and $c_edit) {
		...
		$isoverlap = $p_model::isOverlapPotParam($conn,$record,$r_key);
		if(!$isoverlap){		
			if(empty($r_key))
			...
			$p_posterr = 1;
			$p_postmsg = 'Penentuan pegawai yang mendapatkan potongan sudah diinputkan pada tanggal tersebut';
		}
	}
	...
	$sql = $p_model::getDataEditPotParam($r_key);
