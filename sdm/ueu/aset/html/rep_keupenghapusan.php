<?php
	...
	$sql ="select se.noseri, se.idbarang1+' - '+b.namabarang as barang, se.merk, se.spesifikasi, 
		...
		left join aset.ms_barang1 b on b.idbarang1=se.idbarang1
