<?php
	...
	$a_input[] = array('kolom' => 'idbarang', 'label' => 'ID. Barang (2015)', 'size' => 50);
	$a_input[] = array('kolom' => 'namabarang', 'label' => 'Nama Barang (2015)', 'size' => 50);
					    ...
					    <div id="items">
    					    <table width="<?= $p_tbwidth-22 ?>" cellpadding="4" cellspacing="2" align="center">
	                            ...
	                            */?>
								...
								<tr>
		                            <td class="LeftColumnBG"><?= Page::getDataLabel($row,'idbarang') ?></td>
		                            <td class="RightColumnBG"><?= Page::getDataInput($row,'idbarang') ?></td>
	                            </tr>
								<tr>
		                            <td class="LeftColumnBG"><?= Page::getDataLabel($row,'namabarang') ?></td>
		                            <td class="RightColumnBG"><?= Page::getDataInput($row,'namabarang') ?></td>
	                            </tr>
	                            <tr>
