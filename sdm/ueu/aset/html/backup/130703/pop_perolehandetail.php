...
<?/*
		    ...
		    <input type="hidden" id="idbarang1" name="idbarang1">
*/?>
		</td>
	</tr>
	<tr>
...
$(document).ready(function() {
	...
	// autocomplete
	//$("#namabarang").xautox({strpost: "f=acbaranginv", targetid: "idbarang1"});
    ...
    $('#labelbarang').autocomplete(
	    ...
	    .result(
		    function(event,data,formated){
                ...
                //	+'('+data.idbarang1+') - '+data.namabarang
            	//);
		    }
	    ).focus();
