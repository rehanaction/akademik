<?php
    ...
    //echo '<br>user: '.Modul::getUserDesc();
	//echo '<br>role: '.Modul::getRole();
	//print_r($_SESSION);
    ...
    $a_input[] = array('kolom' => 'idbarang1', 'type' => 'H', 'notnull' => true, 'readonly' => $isro);
	...
	if($r_act == 'save' and $c_edit) {
	    ...
	    if(!$p_posterr){
	        list($p_posterr,$p_postmsg) = $p_model::setTotal($conn, $r_key);
	        unset($post);
        }
	}
