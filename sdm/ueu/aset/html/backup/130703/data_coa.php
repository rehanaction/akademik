<?php	
	...
	$a_input[] = array('kolom' => 'idparent', 'label' => 'Parent', 'readonly' => true, 'default' => $pkey, 'hiddenval' => $pkey);
	$a_input[] = array('kolom' => 'level', 'label' => 'Level', 'readonly' => true, 'default' => $a_level[$pcat['level']] , 'hiddenval' => $pcat['level']);	
