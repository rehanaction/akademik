<?php
	...
	// hak akses
	$a_auth = Modul::getFileAuth('list_cabang');
	...
	//struktur view
	$a_input = array();
	$a_input[] = array('kolom' => 'idcabang', 'label' => 'ID Cabang', 'maxlength' => 10, 'size' => 3, 'notnull' => true);
	$a_input[] = array('kolom' => 'namacabang', 'label' => 'Nama Cabang', 'maxlength' => 45, 'size' => 30, 'notnull' => true);
	$a_input[] = array('kolom' => 'alamat', 'label' => 'Alamat', 'type' => 'A', 'rows' => 3, 'cols' => 30, 'maxlength' => 100);
	$a_input[] = array('kolom' => 'kota', 'label' => 'Kota', 'maxlength' => 45, 'size' => 20);
	$a_input[] = array('kolom' => 'provinsi', 'label' => 'Provinsi', 'maxlength' => 45, 'size' => 20);
