<?php
	...
	$l_lokasi = uCombo::lokasi($conn,$r_lokasi,'lokasi','onchange="goSubmit()" style="width:250px;"',true);
	...
	// struktur view
	$a_kolom = array();
	//$a_kolom[] = array('kolom' => 'idseri', 'label' => 'ID Seri', 'width' => 100);
	$a_kolom[] = array('kolom' => 'idbarang1', 'label' => 'ID Barang', 'width' => 70, 'align' => 'center', 'nosearch' => true);
	...
	$a_kolom[] = array('kolom' => 'merk', 'label' => 'Merk', 'width' => 110, 'align' => 'left');
	$a_kolom[] = array('kolom' => 'spesifikasi', 'label' => 'Spesifikasi', 'width' => 110, 'align' => 'left');
	$a_kolom[] = array('kolom' => 'kodeunit', 'label' => 'Kode Unit', 'width' => 40, 'align' => 'center');
	$a_kolom[] = array('kolom' => 'idlokasi', 'label' => 'Kode Lokasi', 'width' => 60, 'align' => 'center');
	$a_kolom[] = array('kolom' => 'tglperolehan', 'label' => 'Tgl. Perolehan', 'type' => 'D', 'width' => 100, 'align' => 'center');
	$a_kolom[] = array('kolom' => 'idkondisi', 'label' => 'Kondisi', 'width' => 40, 'align' => 'center');
	$a_kolom[] = array('kolom' => 'idstatus', 'label' => 'Status', 'width' => 40, 'align' => 'center');
