<?php
	...
	//$a_input[] = array('kolom' => 'idunit', 'label' => 'Unit', 'type' => 'S', 'option' => $a_unit, 'add' => 'style="width:250px"', 'empty' => true);
	$a_input[] = array('kolom' => 'unit', 'label' => 'Unit', 'size' => 35);
	...
	$a_input[] = array('kolom' => 'namalengkap', 'label' => 'Penanggung Jawab Ruang / Unit', 'size' => 35);
	$a_input[] = array('kolom' => 'idpetugas', 'type' => 'H');
	$a_input[] = array('kolom' => 'luas', 'label' => 'Luas (M2)', 'maxlength' => 6, 'size' => 6, 'type' => 'N');
	$a_input[] = array('kolom' => 'kapasitas', 'label' => 'Kapasitas (Orang)', 'maxlength' => 6, 'size' => 6, 'type' => 'N');
	$a_input[] = array('kolom' => 'idgedung', 'label' => 'Gedung', 'type' => 'S', 'option' => mCombo::gedung($conn), 'empty' => true, 'add' => 'style="width:100px;"');
	$a_input[] = array('kolom' => 'lantai', 'label' => 'Lantai', 'type' => 'S', 'option' => mCombo::lantai($conn), 'empty' => true, 'add' => 'style="width:100px;"');
...
$(document).ready(function() {
	...
	// autocomplete
	$("#namalengkap").xautox({strpost: "f=acxpegawai&idunit="+$('#idunit').val(), targetid: "idpetugas"});
