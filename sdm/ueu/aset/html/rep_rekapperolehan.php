<?php
	...
	$sql ="select p.nopo, p.idunit, u.namaunit, 
			...
			sp.namasupplier, p.tglperolehan, count(se.idseri) as qty, sum(p.harga) as jumlah
	...
	$sql .= " group by p.nopo, b.namabarang,bb.namabarang, p.tglperolehan, sp.namasupplier, p.idunit, u.namaunit
