<?php
	...
	$sql ="select p.idcoa, p.nobukti, p.tglpembukuan, 
			case when p.tglperolehan < '2016-06-01' then b.namabarang else bb.namabarang END AS namabarang,
			case when p.tglperolehan < '2016-06-01' then p.idbarang else p.idbarang1 END AS idbarang1,
			--b.namabarang, p.idbarang1, 
			p.merk, p.idcoa,
	...
	$sql .= " group by p.idcoa, p.nobukti,p.tglperolehan,bb.namabarang,p.idbarang, p.tglpembukuan, b.namabarang, p.idbarang1, p.merk, p.idsumberdana, pd.qty,
...
<table class="tb_data" width="<?= $p_tbwidth ?>">
	...
	while ($row = $rs->FetchRow ()){
        if(!is_null($kdbarang) and $kdbarang <> $row['idbarang1']){
            echo "<tr>
                    <td colspan=\"3\"></td>
        ...
        if(is_null($kdbarang) or $kdbarang <> $row['idbarang1']){
	        echo "<tr>
                    <th width=\"30\">No.</th>
                    <th width=\"100\">No. Bukti</th>
                    <th width=\"80\">Tgl. Pembukuan</th>
