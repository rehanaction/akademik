<?php
	...
	$sql ="select se.noseri, p.idbarang1+' - '+b.namabarang as barang, 
		p.tglperolehan, p.nobukti, p.tglbukti, p.idcoa, u.namaunit, p.total, p.harga, jp.jenispenyusutan, b.idsatuan,
		u2.kodeunit, u2.namaunit
