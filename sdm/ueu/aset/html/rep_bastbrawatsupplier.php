...
?>
<div class="div_head">
    Berita Acara Serah Terima (BAST) Supplier<br/>
    Perawatan Barang
</div>
<table class="tb_head" width="<?= $p_tbwidth ?>">
    ...
    <tr>
	    <td colspan="3">
	        ...
	        telah diserahkan barang kepada supplier yang ditunjuk yaitu:
	    </td>
    </tr>
	<tr>
	    <td colspan="3">&nbsp;</td>
	...
	<tr>
		<td colspan="3">
		untuk melakukan perbaikan atau pergantian barang dengan perincian sebagai berikut:
		</td>
	</tr>
	<tr>
	    <td colspan="3">&nbsp;</td>
