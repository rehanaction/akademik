<?php
	...
	$sql ="select s.idbarang1,b.namabarang,count(s.idseri) as total,sum(s.nilaiaset) as nilai,pr.idcoa
	   from aset.as_seri s 
    ...
    $sql .= "group by s.idbarang1,b.namabarang,pr.idcoa order by s.idbarang1";
