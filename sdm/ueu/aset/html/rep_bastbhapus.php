<?php
	...
	$sql = "select right('000000' + cast(s.noseri as varchar(6)), 6) noseri, s.idbarang1, b.namabarang, 
		s.merk, s.spesifikasi, p.nilaipenghapusan, s.tglperolehan
...
<table class="tb_head" width="<?= $p_tbwidth ?>">
    ...
    <tr>
	    <td colspan="3">
	        ...
	        telah dilakukan penghapusan barang di lingkungan Universitas Esa Unggul:
	    </td>
    </tr>
	<tr>
	    <td colspan="3">&nbsp;</td>
