<?php
	...
	// combo
	$l_level = uCombo::levelcoa($conn,$r_level,'level','onchange="goSubmit()" style="width:130px;"');
	...
	// struktur view
	$a_kolom = array();
	$a_kolom[] = array('kolom' => 'idcoa', 'label' => 'ID.', 'size' => 3, 'nosearch' => true);
	$a_kolom[] = array('kolom' => 'namacoa', 'label' => 'Nama COA', 'size' => 20);
	$a_kolom[] = array('kolom' => 'idparent', 'label' => 'Parent', 'size' => 40, 'nosearch' => true);
	$a_kolom[] = array('kolom' => 'level', 'label' => 'Level', 'size' => 40, 'align' => 'center', 'nosearch' => true);
	...
	// mendapatkan data
	if(!empty($r_level)) $a_filter[] = $p_model::getListFilter('level',$r_level);
	...
	// membuat filter
	$a_filtercombo = array();
	$a_filtercombo[] = array('label' => 'Level', 'combo' => $l_level);
			...
			<form name="pageform" id="pageform" method="post">
				...
				<table width="<?= $p_tbwidth ?>" cellpadding="4" cellspacing="0" class="GridStyle" align="center">
					...
					<tr valign="top" class="<?= $rowstyle ?>">
						...
						<?		if($c_insert and $row['level'] < 5) { ?>
							<img id="<?= $t_key ?>" title="Tambah Sub COA" src="images/child.png" onclick="goChild(this)" style="cursor:pointer">
						<?		}
								if($c_edit) { ?>
