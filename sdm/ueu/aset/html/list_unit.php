<?php
	...
	// struktur view
	$a_kolom = array();
	$a_kolom[] = array('kolom' => 'a.kodeunit', 'label' => 'Kode','align' => 'center', 'width' => 50, 'nosearch' => true);
	$a_kolom[] = array('kolom' => 'a.namaunit', 'label' => 'Unit Kerja');
	$a_kolom[] = array('kolom' => 'a.namasingkat', 'label' => 'Nama Singkat','align' => 'left','width' => 100,);
	$a_kolom[] = array('kolom' => 'unit', 'label' => 'Kode Parent', 'align' => 'left', 'width' => 75,);
	$a_kolom[] = array('kolom' => 'a.level', 'label' => 'Level', 'align' => 'center', 'width' => 40,);
	
	$p_colnum = count($a_kolom)+1;
	
/*	Fungsi Aksi dimatikan
	// ada aksi
	$r_act = $_POST['act'];
