<?php
	...
	if($r_act == 'save' and $c_edit) {
		...
		if(empty($r_key)){
		    ...
		    if(!$p_posterr){
		        $sqla = "insert into aset.as_opnamehpdetail (idopnamehp,idbarang1,qtyawal,qtyakhir,idsatuan) 
		            select $r_key,idbarang1,jmlstock as qtyawal,jmlstock,idsatuan as qtyakhir from aset.as_stockhp 
