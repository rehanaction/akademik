<?php
	...
	$sql="select s.idseri,
		/*case when s.tglperolehan < '2016-06-01' then s.idbarang else s.idbarang1 END AS idbarang1,
		case when s.tglperolehan < '2016-06-01' then b.namabarang else bb.namabarang END AS namabarang,*/
		case when s.tglperolehan < '2016-06-01' then s.idbarang+' - '+b.namabarang else s.idbarang1+' - '+bb.namabarang END AS barang,
		l.namalokasi, u.namaunit, 
