	...
	class Label {
	    function cetak($p=""){
            ...
            if($obj) {
                ...
                ImageTTFText ($pImage, 14, 0, 75, 55, $penblack, $fontPath, $p['idbarang']." (". Aset::setFormatNoSeri($p['noseri']) .")");
                ...
                ImageString ($pImage, 2, 20, 85,  $p['sumberdana'], $penblack);
                ImageString ($pImage, 2, 20, 97,  $p['tglperolehan'], $penblack);
