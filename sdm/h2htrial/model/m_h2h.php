<?php
	class mH2H {
		...
		function getStrTrans($conn,$kodebank,$ymd) {
			$sql = "select * from
					((select to_char(b.transmissiontime,'YYYYMMDDHH24MISS') as tglbayar, b.companycode, b.nim, b.jenistagihan, b.periodebayar, b.refno, '0' as notoken, b.jumlahbayar, b.idpembayaran
					from h2h.ke_pembayaran b
					where to_char(b.tglbayar,'YYYYMMDD') = ? and b.companycode = ? and b.ish2h = '1' and b.flagbatal = '0')
					union all
					(select to_char(b.transmissiontime,'YYYYMMDDHH24MISS'), b.companycode, b.kodeformulir, '".H2H_KODEFORMULIR."', b.periodebayar, b.refno, b.notoken, b.jumlahbayar, b.idpembayaranfrm
			...
			$str[] = $ymd.'000000|'.count($str).'|0|0|0|0|0|0|'.$total;
