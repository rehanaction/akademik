<?php
	...
	$a_input[] = array('kolom' => 'flaglunas', 'label' => 'Status Lunas', 'type' => 'R','option' => array('BB'=>'Belum Bayar','BL'=>'Belum Lunas','L'=>'Lunas'),'default'=>'BB');
	...
	if($r_act == 'save' and $c_edit) {
		...
		if(empty($r_key))
		{
			...
			list($p_posterr,$p_postmsg) = $p_model::insertRecord($conn,$record,$r_key);
			}
			else{
				$p_posterr = true;
			...
			{
				list($p_posterr,$p_postmsg) = $p_model::updateRecord($conn,$record,$r_key);
			}
