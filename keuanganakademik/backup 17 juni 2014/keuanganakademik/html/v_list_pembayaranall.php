			...
			<form name="pageform" id="pageform" method="post">
				...
				<table width="<?= $p_tbwidth ?>" cellpadding="4" cellspacing="0" class="GridStyle" align="center">
					...
					<tr valign="top" class="<?= $rowstyle ?>">
						...
						<?	} ?>
                           <td align="center"><img id="<?= $t_key ?>" title="Print Kwitansi" src="images/print.png" onClick="goPrintdetail('<?=$t_key?>','idpembayaran','<?= Route::navAddress($p_printpagedet) ?>')" style="cursor:pointer"></td>
					</tr>
					<?	}
						if($i == 0) {
					?>
