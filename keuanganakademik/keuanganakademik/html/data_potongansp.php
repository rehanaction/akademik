<?php
	...
	// properti halaman
	$p_title = 'Data Potongan Semester Pendek';
	$p_tbwidth = 600;
	...
	$a_input[] = array('kolom' => 'potongansp', 'label' => 'Nominal Potongan / smt', 'size' => 12, 'maxlength' => 12, 'type' => 'N');
	$a_input[] = array('kolom' => 'keteranganpotongansp', 'label' => 'Keterangan', 'type' => 'A');
