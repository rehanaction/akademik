<?php
	...
	// properti halaman
	$p_title = 'Laporan Pembayaran Rutin Detail';
	$p_tbwidth = 450;
	$p_aktivitas = 'LAPORAN';
	...
	$a_input['jenistagihan'] = array('kolom' => 'jenistagihan', 'label' => 'jenistagihan', 'type' => 'S', 'option' => array('' => 'Semua') + mCombo::jenistagihan($conn));
				...
				<center>
					...
					<table width="<?= $p_tbwidth-22 ?>" cellpadding="4" cellspacing="2" align="center">
						...
						<td class="LeftColumnBG" width="100" style="white-space:nowrap">
							...
							<td class="RightColumnBG">
								<?= uForm::getInput($a_input['jenistagihan']) ?>
							</td>
						</tr>
                        <tr>
							<td class="LeftColumnBG" width="100" style="white-space:nowrap">
