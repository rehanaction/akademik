		...
		<div class="SideItem" id="SideItem">
			<form name="pageform" id="pageform" method="post"<?= $isupload ? ' enctype="multipart/form-data"' : '' ?>>
				...
				<center>
                    ...
                    <tr>
                    	<td class="LeftColumnBG" width="35%" style="white-space:nowrap">Periode Daftar</td>
                    ...
                    <tr>
                        ...
                        <td class="RightColumnBG"><?=$l_gelombang?></td>
                    </tr>
                    <? 
					if($arr_sistemkuliah)
					...
					foreach($arr_jenistagihan as $t => $v){
						if(($val['sistemkuliah'] == 'P' and empty($v['isparalel'])) or ($val['sistemkuliah'] == 'R' and empty($v['isreguler'])))
							continue;
