<?php
	...
	// properti halaman
	$p_title = 'Potongan Semester Pendek Mahasiswa';
	$p_tbwidth = '100%';
	$p_aktivitas = 'BIODATA';
	...
	$a_kolom[] = array('kolom' => 'm.potongansp', 'label' => 'Potongan', 'align' => 'right', 'type' => 'N');
	...
	$a_data = $p_model::getPagerData($conn,$a_kolom,$r_row,$r_page,$r_sort,$a_filter,$p_model::listQuerySP(),$p_model::listConditionSP());
