<?php
	...
	// properti halaman
	$p_title = 'Rekap Pembayaran Rutin';
	$p_tbwidth = 450;
	$p_aktivitas = 'LAPORAN';
	       
	$a_input = array();
	$a_input['kodeunit'] = array('kolom' => 'kodeunit', 'label' => 'Jurusan', 'type' => 'S', 'option' => mAkademik::getArrayunit($conn));
				...
				<center>
					...
					<table width="<?= $p_tbwidth-22 ?>" cellpadding="4" cellspacing="2" align="center">
                        ...
                        <tr>
							...
							<td class="RightColumnBG">
								<input type="checkbox" name="jenish2h[]" id="jenish2h" checked="checked" value="0"/> Non H2H
								<input type="checkbox" name="jenish2h[]" id="jenish2h" checked="checked" value="1"/> H2H
							</td>
						</tr>
						<tr>
