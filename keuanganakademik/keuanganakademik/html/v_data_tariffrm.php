			...
			<form name="pageform" id="pageform" method="post"<?= $isupload ? ' enctype="multipart/form-data"' : '' ?>>
				...
				<center>
                    ...
                    <tr>
                        ...
                        <td class="RightColumnBG" colspan="3"><?=$r_periodedaftar?></td>
                    </tr>
                    <tr>
                    	<td class="LeftColumnBG" style="white-space:nowrap">Jalur Penerimaan</td>
                        <td class="RightColumnBG" colspan="3"><?=$l_jalur?></td>
                    </tr>
                    <tr>
                    	<td class="LeftColumnBG" style="white-space:nowrap">Gelombang</td>
                        <td class="RightColumnBG" colspan="3"><?=$l_gelombang?></td>
                    </tr>
                    <? if($arr_programpend)
					...
					foreach($arr_sistemkuliah as $i => $val){
						...
						$aktif1 = $data[$r_periodedaftar][$r_jalur][$r_gelombang][$val['sistemkuliah']][1][$programpend]['isaktif'];
						$aktif2 = $data[$r_periodedaftar][$r_jalur][$r_gelombang][$val['sistemkuliah']][2][$programpend]['isaktif'];
						$aktif3 = $data[$r_periodedaftar][$r_jalur][$r_gelombang][$val['sistemkuliah']][3][$programpend]['isaktif'];
						$t_id = '|'.$programpend.'|'.$val['sistemkuliah'].'|';
						?>
                    	<tr>
                        	<td class="LeftColumnBG" colspan="4" >
                         ...
                         <tr>
							...
							<td>
								<span id="show"><?php echo empty($aktif1) ? '' : '<img src="images/check.png"> Aktif' ?></span>
								<span id="edit" style="display:none">
									<input type="checkbox" name="<?php echo 'aktif'.$t_id.'1' ?>" id="<?php echo 'aktif'.$t_id.'1' ?>" value="1"<?php echo empty($aktif1) ? '' : ' checked' ?>>
									<label for="<?php echo 'aktif'.$t_id.'1' ?>">Aktif</label>
								</span>
							</td>
                        </tr> 
                        <tr>
							...
							<td>
								<span id="show"><?php echo empty($aktif2) ? '' : '<img src="images/check.png"> Aktif' ?></span>
								<span id="edit" style="display:none">
									<input type="checkbox" name="<?php echo 'aktif'.$t_id.'2' ?>" id="<?php echo 'aktif'.$t_id.'2' ?>" value="1"<?php echo empty($aktif2) ? '' : ' checked' ?>>
									<label for="<?php echo 'aktif'.$t_id.'2' ?>">Aktif</label>
								</span>
							</td>
                        </tr> 
                        <tr>
							...
							<td>
								<span id="show"><?php echo empty($aktif3) ? '' : '<img src="images/check.png"> Aktif' ?></span>
								<span id="edit" style="display:none">
									<input type="checkbox" name="<?php echo 'aktif'.$t_id.'3' ?>" id="<?php echo 'aktif'.$t_id.'3' ?>" value="1"<?php echo empty($aktif3) ? '' : ' checked' ?>>
									<label for="<?php echo 'aktif'.$t_id.'3' ?>">Aktif</label>
								</span>
							</td>
                        </tr> 
                    <? }?>
