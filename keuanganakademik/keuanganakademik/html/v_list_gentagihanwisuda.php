		...
		<div class="SideItem" id="SideItem">
			<form name="pageform" id="pageform" method="post">
				...
				<table width="<?= $p_tbwidth ?>" cellpadding="4" cellspacing="0" class="GridStyle" align="center">
					...
					?>
				<tr>
                	<th width="50" rowspan="2">Generate All <input type="checkbox" name="checkall" id="checkall"></th>
               ...
               <? } ?>
                ...
                <tr>
                	...
                	<td><input type="checkbox" name="check[]" value="<?= $v['nim'].'||'.$val['jenistagihan'].'||'.$v['idyudisium'].'||'.$v['kodeunit']?>"></td>
                	<? } ?>
                	<td><?=$v['nim']?></td>
                    <td><?=$v['nama']?></td>
                    <td><?=$v['namaunit']?></td>
               ...
               <tr>
                	<td colspan="10" align="left">
                    	<font color="#999999"><em>checkbox disamping kirim digunakan untuk melakukan generate tagihan wisuda seluruh peserta yudisium</em></font> &nbsp; 
                        <strong><input type="button" value="Generate ALL" onclick="goGenerateAll()"></strong>
                    </td>
                	<td></td>
                </tr>
				</table>
...
function goGenerateAll(){
	var txt = confirm("Apakah anda yakin akan melakukan generate tagihan secara Keseluruhan?");
	if(txt) {
		document.getElementById("act").value = "generateall";
