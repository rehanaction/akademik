	...
	<div id="wrapper">
		<div class="SideItem" id="SideItem">
			<form name="pageform" id="pageform" method="post">
				...
				?>
				<center>
					<div class="filterTable" style="width:50%; float:left; min-height:100px">
					...
					<div class="filterTable" style="width:40%; float:right; min-height:100px">
						<table cellpadding="3" cellspacing="0" align="center">
							<tr>
								<td align="center" style="font-weight:bold" colspan="3">Salin Tagihan</td>
							</tr>
							<tr>
								<td>Periode</td>
								<td>:</td>
							...
							<tr>
								<td align="center" style="font-weight:bold" colspan="3"><input type="button" value="Salin Tagihan" id="salin" name="salin" onclick="goSalin()"></td>
							</tr>
						...
						/********/
                         ...
                         <?  foreach($arr_sistemkuliah as $i => $val){
                             ...
                             <? }?>
                                ...
                                <img id="<?=$kodeunit.'|'.$r_periode.'|'.$r_jalur.'|'.$r_gelombang.'|'.$r_jenis?>" title="Tampilkan Detail" src="images/edit.png" onClick="goDetail(this)" style="cursor:pointer">
                                </td>
								<? }?>
                         <? }?>
						 <? 
