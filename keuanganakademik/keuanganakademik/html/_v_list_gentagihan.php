	...
	<div id="wrapper">
		<div class="SideItem" id="SideItem">
			<form name="pageform" id="pageform" method="post">
				...
				<center>
                	<div align="right">
                    <img src="images/posting.gif"> <?php echo $p_label ?> Telah di Generate
                    &nbsp;&nbsp;&nbsp;
                    <img src="images/nonposting.gif"> <?php echo $p_label ?> Belum di Generate
                    </div>
					...
					foreach($frekuensi as $i => $val){
						...
						foreach($val as $a => $v){
							...
							foreach($jt[$i] as $d => $vk){
								...
								$edited = floor($jmltagihan[$kodeunit][$vk][$r_periode][$a]['E']);
								$generated = floor($jmltagihan[$kodeunit][$vk][$r_periode][$a]['G']);
								?>
                            <td align="center">
...
function goVoid(kodeunit,thnbulan,jenistagihan,idloggen){
	var txt = confirm("Semua <?php echo strtolower($p_label) ?> yang telah di generate akan di hapus, Apakah anda yakin akan membatalkan generate <?php echo strtolower($p_label) ?> ini?");
	if(txt) {
...
function goGenerate(kodeunit,thnbulan,jenistagihan){
	var txt = confirm("Apakah anda yakin akan melakukan generate <?php echo strtolower($p_label) ?> ini?");
	if(txt) {
