	...
	<div id="wrapper">
		<div class="SideItem" id="SideItem">
			<form name="pageform" id="pageform" method="post">
				...
				<?	} ?>
				<center>
				<div class="filterTable" style="width:<?= $p_tbwidth-10 ?>px; margin-bottom:10px">
				<table>
					<tr>
						<td colspan="3" align="center"><b>Update Tarif Secara Keseluruhan (untuk semua Prodi)</b></td>						
					</tr>
					<tr>
						<td></td>
						<td>Masukkan Tarif: <?= UI::createTextBox('nominal',$r_nominal,'ControlStyle',10,10) ?></td>
						<td><input type="button" name="simpanmasal"id="simpanmasal" value="simpan secara Keseluruhan" onclick="goSetAll()"></td>
					</tr>
				</table>
				</div>
