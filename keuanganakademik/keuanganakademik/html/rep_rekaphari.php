<?
	...
	$p_tbwidth = 900;
	$p_namafile = 'rekappembayaranrutin';
	...
	$arr_data = mPembayaran::laporanbybulan($conn,$r_tahun,$r_bulan,$r_jenis,'0',$infounit);
	...
	<div align="center">
		...
		<table width="<?=$p_tbwidth?>" cellpadding="3" border="1" style="border-collapse:collapse;">
            ...
            <tr>
            	...
            	<td align="right"><a href="<?=Route::navAddress('rep_harian&tglmulai='.cStr::formatDate($i).'&kodeunit='.$r_kodeunit.'&jenis='.$r_jenis)?>" target="_blank"><?=cStr::FormatNumber(count($data[$i]))?></a></td>
