			...
			<form name="pageform" id="pageform" method="post">
				...
				<table width="<?= $p_tbwidth ?>" cellpadding="4" cellspacing="0" class="GridStyle" align="center">
					...
					<tr valign="top" class="<?= $rowstyle ?>">
						...
						<?	} ?>
                           <td align="center"><img id="<?= $t_key ?>" title="Print Kwitansi" src="images/print.png" onClick="goPrintdetail('<?=$row['notoken']?>','notoken','<?= Route::navAddress('rep_paymentfrm') ?>')" style="cursor:pointer"></td>
					</tr>
					<?	}
						if($i == 0) {
					?>
				...
				<?	} ?>
				<input type="hidden" name="notoken" id="notoken">
			</form>
		</div>
	</div>
</div>
