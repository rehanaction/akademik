<?php
	...
	class UI {
		...
		// membuat textbox
		function createTextBox($nameid,$value='',$class='',$maxlength='',$size='',$edit=true,$add='',$placeholder='',$id='') {
			$value = strval($value);
			...
			if(!empty($edit)) {
				...
				$tb = '<input type="text" name="'.$nameid.'" id="'.$id.'"';
		...
		function createTextBoxSpan($nameid,$value='',$class='',$maxlength='',$size='',$edit=true,$add='',$placeholder='',$id='') {
			$show = self::createTextBox($nameid,$value,$class,$maxlength,$size,false,$add,$placeholder,$id);
			$edit = self::createTextBox($nameid,$value,$class,$maxlength,$size,$edit,$add,$placeholder,$id);
