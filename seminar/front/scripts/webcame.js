...
window.webcam = {
	...
	swf_url: 'scripts/webcam.swf', // URI to webcam.swf movie (defaults to cwd)
	shutter_url: 'shutter.mp3', // URI to shutter.mp3 sound
	// api_url: 'index.php?page=capture_cam', // URL to upload script
	api_url: 'capture_cam.php', // URL to upload script
