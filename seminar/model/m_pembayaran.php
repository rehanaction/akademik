<?php
	...
	function getDatapembayaran($conn,$id){
			...
			$sql = "select * from ".static::table()." b
					join ".static::table('sm_tagihan')." t using (idtagihan)
	...
	function laporanbytanggal($conn,$tglmulai,$tglakhir,$jenis,$void = '0',$infounit,$sistem,$angkatan,$bank){
			...
			if(!empty($bank)) {
				if($bank == '000')
					...
					$sql .= " and ish2h = '1' and companycode = ".Query::escape($bank);
			}
