<?php
	...
	function inputColumn($conn,$key='',$r_jalur='', $r_periode='', $r_gel='',$beasiswa='',$registrasi='',$semesterpendek=''){
		...
		$a_input[] = array('kolom' => 'sistemkuliah', 'label' => 'Sistem Kuliah', 'type' => 'S','option' => $arrSistemkuliah,'empty'=>false,'readonly'=>$readonly);
		...
		$a_input[] = array('kolom' => 'pilihan1', 'label' => 'Pilihan 1', 'type' => 'S', 'notnull' => true, 'option' => $arrJurusan, 'empty' => true,'add' => 'onchange="loadPilihan2()"','readonly'=>$readonly);
