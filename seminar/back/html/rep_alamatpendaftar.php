...
// cek akses halaman
   ...
   require_once(Route::getModelPath('unit'));
	...
	$r_sistemkuliah    = $_REQUEST['sistemkuliah'];
	$format    = CStr::removeSpecial($_REQUEST['format']);
	
	//model
	$p_model=mLaporan;
	$p_tbwidth = 950;
	$p_namafile = 'Laporan Alamat Pendaftar';
	$a_data = mLaporan::getGeneratenopendaftar($conn,'','',$r_periode,$r_kodeunit,$r_sistemkuliah);
