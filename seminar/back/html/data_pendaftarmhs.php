<?php
	...
	if(!empty($r_key)) {
		...
		$a_input[] = array('kolom' => 'nim', 'label' => 'NIM', 'readonly'=>true);
		/* $a_input[] = array('kolom' => 'semestermhs', 'label' => 'Semester','readonly'=>true);
		$a_input[] = array('kolom' => 'namaunit', 'label' => 'Jurusan','readonly'=>true);
		$a_input[] = array('kolom' => 'periodemasuk', 'label' => 'Periode Masuk','readonly'=>true); */
		...
		$a_input[] = array('kolom' => 'nim', 'label' => 'NIM');
	...
	if($r_act == 'save' and $c_edit) {
		...
		if(empty($r_key))
			$record = $p_model::getRecordMahasiswa($conn,$record);
