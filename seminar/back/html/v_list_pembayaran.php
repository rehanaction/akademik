		...
		<div class="SideItem" id="SideItem">
			<form name="pageform" id="pageform" method="post">
							...
							<tr>
								<td valign="top" width="50%">
									<table width="100%" cellspacing="0" cellpadding="4">
                                        ...
                                        * */ ?>
                                        <tr>
                                        	<td width="50" style="white-space:nowrap"><strong>No. Peserta</strong></td>
                                            <td valign="middle">
                                            	<strong>:</strong> 
				...
				<table width="<?= $p_tbwidth ?>" cellpadding="4" cellspacing="0" align="center">
					...
					<tr>
                    	<td  width="13%"><strong> No. Peserta</strong></td>
...
function goPayment(){
		...
		if(total > kas) 
			alert('Jumlah yang di bayarkan lebih kecil dari total tagihan');
		else if (isNaN(kas)) {
