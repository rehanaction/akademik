<?php
	...
	$a_kolom[] = array('kolom' => 'p.nopeserta', 'label' => 'Nomor Peserta');
	$a_kolom[] = array('kolom' => 'p.nopendaftar', 'label' => 'Nomor Pendaftaran');
	$a_kolom[] = array('kolom' => 'namaseminar', 'label' => 'Nama Seminar');
	$a_kolom[] = array('kolom' => 'namapeserta', 'label' => 'Nama Peserta');
	$a_kolom[] = array('kolom' => 'tarif', 'label' => 'Tarif Seminar','type'=>'N');
	...
	*/
	...
	if(!empty($r_idseminar)) 
		$a_filter[] = $p_model::getListFilter('idseminar',$r_idseminar);
	if(!empty($r_periode)) 
