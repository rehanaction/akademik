<?php
	...
	// struktur view
	$a_kolom = array();
	$a_kolom[] = array('kolom' => 'kodemapping', 'label' => 'Kode Mapping', 'width' => 130, 'size' => 10, 'maxlength' => 10, 'notnull' => true);
	$a_kolom[] = array('kolom' => 'keterangan', 'label' => 'Keterangan', 'size' => 30, 'maxlength' => 100, 'notnull' => true);
	
	// properti halaman
	$p_title = 'Daftar Mapping Data';
	$p_tbwidth = 400;
	$p_aktivitas = 'TABEL';
