<?php
	...
	// struktur view
	$a_kolom = array();
	$a_kolom[] = array('kolom' => 'idalasan', 'label' => 'ID Alasan', 'size' => 4, 'maxlength' => 4, 'notnull' => true);
	$a_kolom[] = array('kolom' => 'alasan', 'label' => 'Alasan Seminar', 'size' => 90, 'maxlength' => 90, 'notnull' => true);
	
	// properti halaman
	$p_title = 'Daftar Alasan Seminar';
	$p_tbwidth = 800;
	
	$p_model = mAlasanSeminar;
	$p_key = $p_model::key;
