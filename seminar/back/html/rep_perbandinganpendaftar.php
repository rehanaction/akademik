<?
	...
	//model
	$p_model=mLaporan;
	$p_title='Laporan Perbandingan Pendaftar';
	$p_tbwidth = 950;
	
	$data=$p_model::getDataPerbandinganPendaftar($conn,$r_periode,$r_tglawal,$r_tglakhir);
	...
	$arrData = array();
	foreach ($data as $val){
		$arrData[$val['periodedaftar']][$val['pilihanditerima']] = $val['jumlah'];
	}
