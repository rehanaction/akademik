<?php
	...
	*/
	...
	// properti halaman
	$p_title = 'Selamat Datang di SIM Seminar';
?>
<html>
<head>
	<title><?= $p_title ?></title>
...
<div id="main_content">
	...
	<div id="wrapper">
		<div class="SideItem" id="SideItem">
			<div class="ViewTitle"><?= $p_title  ?></div>
			<br>
			<table class="filterTable" width="100%">
				<tr>
					<td>
						Assalamualaikum Wr. Wb.<br><br>
						Selamat Datang di Sistem Informasi Manajemen Pendaftaran Mahasiswa Baru Universitas Esa Unggul (UEU). Di sini Anda dapat melihat dan mengelola semua data yang berhubungan dengan pendaftaran mahasiswa baru selama Anda menjadi mahasiswa Universitas Esa Unggul.<br><br>	
						Silakan memanfaatkan semua fasilitas yang disedikan oleh sistem ini dengan semestinya. Jika Anda menemui kesalahan entry data, masukan nama, nilai maupun error pada program, Anda dapat menyampaikan keluhan tersebut kepada pihak Tata Usaha.<br><br>
