<?php
	...
	// include
	require_once(Route::getModelPath('jawabankuesioner'));
	...
	// struktur view
	$a_kolom = array();
	$a_kolom[] = array('kolom' => 'idjawaban', 'label' => 'No', 'maxlength' => 4, 'notnull' => true);
	$a_kolom[] = array('kolom' => 'jawaban', 'label' => 'Jawaban', 'size' => 30, 'maxlength' => 20, 'notnull' => true);
	$a_kolom[] = array('kolom' => 'kategori', 'label' => 'Kategori', 'type' => 'S', 'option' => $a_pilihan, 'empty' => false);

	
	// properti halaman
	$p_title = 'Daftar Jawaban Kuisioner';
	$p_tbwidth = 600;
	
	$p_model = mJawabanKuesioner;
	$p_key = $p_model::key;
