<?php
	...
	// struktur view
	$a_kolom = array();
	$a_kolom[] = array('kolom' => 'idlevel', 'label' => 'ID Level', 'size' => 4, 'maxlength' => 4, 'notnull' => true);
	$a_kolom[] = array('kolom' => 'levelseminar', 'label' => 'Level Seminar', 'size' => 30, 'maxlength' => 50, 'notnull' => true);
	
	// properti halaman
	$p_title = 'Daftar Level Seminar';
	$p_tbwidth = 600;
	
	$p_model = mLevelSeminar;
	$p_key = $p_model::key;
