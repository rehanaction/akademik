	...
	<div id="wrapper">
		<div class="SideItem" id="SideItem">
			<form name="pageform" id="pageform" method="post">
				<center>
					<div style="width:<?= $p_tbwidth-10 ?>px; border-width:1px; background: #eceaea; border-radius:5px; border-style: solid; border-color:#a09e9e; padding: 10px;">
				...
				<center>
					<div class="filterTable" style="width:<?= $p_tbwidth-12 ?>px;">
						<table width="<?= $p_tbwidth-10 ?>" cellpadding="0" cellspacing="3" align="center" border="0">
						<tr>
				...
				<? } ?>
				<center>
					<div style="width:<?= $p_tbwidth-10 ?>px; border-width:1px; background: #eceaea; border-radius:5px; border-style: solid; border-color:#a09e9e; padding: 10px; margin-top:30px" align="left">
						...
						<div align="right">
							<input name="btnFilter" type="button" value="Export" onclick="goExport()">
						</div>
					</div>
					<div style="width:<?= $p_tbwidth-10 ?>px; border-width:1px; background: #eceaea; border-radius:5px; border-style: solid; border-color:#a09e9e; padding: 10px; margin-top:30px">
						Keterangan:<br>
