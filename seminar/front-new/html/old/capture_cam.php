...
$r_jalur=$_GET['jalur'];
$r_gel=$_GET['gel'];
$r_periode=$_GET['period'];
$_SESSION['FOTO']['NAMAFILE'] = $r_name;
?>
<html lang="en">
<head>
	<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
	<title>SIAKAD : TAKE PHOTO</title>
...
<body>
	...
	<script language="JavaScript">
		webcam.set_api_url('index.php?page=captured&key=<?= $r_name ?>&code=<?= $r_code ?>&jalur=<?= $r_jalur?>&gel=<?= $r_gel?>&period=<?= $r_periode?>');
