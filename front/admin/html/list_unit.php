<?php
	...
	// struktur view
	$a_kolom = array(); 
	$a_kolom[] = array('kolom' => 'kodeunitparent', 'label' => 'Induk');
	$a_kolom[] = array('kolom' => 'kodeunit', 'label' => 'Kode Unit');
	$a_kolom[] = array('kolom' => 'namaunit', 'label' => 'Nama Unit');  
	$a_kolom[] = array('kolom' => 'infoleft', 'label' => 'Kiri'); 
	$a_kolom[] = array('kolom' => 'inforight', 'label' => 'Kanan');
			...
			<form name="pageform" id="pageform" method="post">
				...
				<table width="<?= $p_tbwidth ?>" cellpadding="4" cellspacing="0" class="GridStyle" align="center">
					...
					<tr valign="top" class="<?= $rowstyle ?>">
						...
						<td align="center">
						<?		if($c_edit) { ?>
							<img id="<?= $t_key ?>" title="Menampilkan Detail" src="images/edit.png" onclick="goDetail(this)" style="cursor:pointer">
						<?		}
								if($c_delete) { ?>
					...
					<tr>
						...
						<div style="float:left">
							Julah Baris : <?= uCombo::listRowNum($r_row,'onchange="goSubmit()"') ?>
						</div>
